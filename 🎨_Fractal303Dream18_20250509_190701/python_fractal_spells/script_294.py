...
# Script ID 294: Op 'sine_power_mix', Modifiers: freq1=0.42, pow1=3, amp1=4.2, freq2=1.48, pow2=2, amp2=3.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 294, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":294, "input_value":input_value, "op_type":"sine_power_mix", 
