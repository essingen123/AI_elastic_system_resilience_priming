...
# Script ID 231: Op 'logistic_growth', Modifiers: r=2.823, k=70
...
if __name__ == "__main__":
    ...
    modifier_r = float(2.823)
    modifier_k = float(70)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 231, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":231, "input_value":input_value, "op_type":"logistic_growth", 
