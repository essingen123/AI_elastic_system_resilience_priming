...
# Script ID 241: Op 'sine_power_mix', Modifiers: freq1=0.81, pow1=1, amp1=0.9, freq2=1.11, pow2=1, amp2=0.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.81)
    modifier_pow1 = float(1)
    modifier_amp1 = float(0.9)
    modifier_freq2 = float(1.11)
    modifier_pow2 = float(1)
    modifier_amp2 = float(0.6)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 241, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":241, "input_value":input_value, "op_type":"sine_power_mix", 
