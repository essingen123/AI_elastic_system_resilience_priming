...
# Script ID 65: Op 'sine_power_mix', Modifiers: freq1=0.74, pow1=2, amp1=2.2, freq2=1.77, pow2=3, amp2=3.2
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.74)
    modifier_pow1 = float(2)
    modifier_amp1 = float(2.2)
    modifier_freq2 = float(1.77)
    modifier_pow2 = float(3)
    modifier_amp2 = float(3.2)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 65, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":65, "input_value":input_value, "op_type":"sine_power_mix", 
