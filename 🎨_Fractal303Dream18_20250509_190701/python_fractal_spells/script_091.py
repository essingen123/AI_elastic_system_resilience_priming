...
# Script ID 91: Op 'sine_power_mix', Modifiers: freq1=0.29, pow1=1, amp1=0.9, freq2=2.48, pow2=1, amp2=1.7
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.29)
    modifier_pow1 = float(1)
    modifier_amp1 = float(0.9)
    modifier_freq2 = float(2.48)
    modifier_pow2 = float(1)
    modifier_amp2 = float(1.7)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 91, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":91, "input_value":input_value, "op_type":"sine_power_mix", 
