...
# Script ID 140: Op 'de_jong_attractor_x', Modifiers: a=2.93, b=-2.81
...
if __name__ == "__main__":
    ...
    modifier_a = float(2.93)
    modifier_b = float(-2.81)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 140, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":140, "input_value":input_value, "op_type":"de_jong_attractor_x", 
