...
# Script ID 10: Op 'clifford_attractor_x', Modifiers: a=-1.11, c=1.74
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 10, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":10, "input_value":input_value, "op_type":"clifford_attractor_x", 
