...
# Script ID 236: Op 'sine_power_mix', Modifiers: freq1=2.84, pow1=3, amp1=3.7, freq2=1.05, pow2=2, amp2=2.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.84)
    modifier_pow1 = float(3)
    modifier_amp1 = float(3.7)
    modifier_freq2 = float(1.05)
    modifier_pow2 = float(2)
    modifier_amp2 = float(2.6)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 236, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":236, "input_value":input_value, "op_type":"sine_power_mix", 
