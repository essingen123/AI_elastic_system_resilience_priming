...
# Script ID 66: Op 'de_jong_attractor_y', Modifiers: c=-1.71, d=-1.66
...
if __name__ == "__main__":
    ...
    modifier_c = float(-1.71)
    modifier_d = float(-1.66)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 66, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":66, "input_value":input_value, "op_type":"de_jong_attractor_y", 
