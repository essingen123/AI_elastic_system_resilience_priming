...
# Script ID 138: Op 'sine_power_mix', Modifiers: freq1=2.65, pow1=3, amp1=1.5, freq2=2.5, pow2=2, amp2=1.8
...
if __name__ == "__main__":
    ...
    modifier_freq2 = float(2.5)
    modifier_pow2 = float(2)
    modifier_amp2 = float(1.8)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 138, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":138, "input_value":input_value, "op_type":"sine_power_mix", 
