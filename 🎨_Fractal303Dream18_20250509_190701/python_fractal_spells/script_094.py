...
# Script ID 94: Op 'coupled_logistic_x', Modifiers: rx=3.582, cxy=0.09
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.582)
    modifier_cxy = float(0.09)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 94, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":94, "input_value":input_value, "op_type":"coupled_logistic_x", 
