...
# Script ID 265: Op 'de_jong_attractor_y', Modifiers: c=2.37, d=-1.52
...
if __name__ == "__main__":
    ...
    modifier_c = float(2.37)
    modifier_d = float(-1.52)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 265, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":265, "input_value":input_value, "op_type":"de_jong_attractor_y", 
