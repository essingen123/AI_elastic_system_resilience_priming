...
# Script ID 89: Op 'de_jong_attractor_x', Modifiers: a=0.84, b=2.09
...
if __name__ == "__main__":
    ...
    modifier_a = float(0.84)
    modifier_b = float(2.09)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 89, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":89, "input_value":input_value, "op_type":"de_jong_attractor_x", 
