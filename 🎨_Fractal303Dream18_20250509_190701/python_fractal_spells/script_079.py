...
# Script ID 79: Op 'de_jong_attractor_y', Modifiers: c=-0.94, d=1.69
...
if __name__ == "__main__":
    ...
    modifier_c = float(-0.94)
    modifier_d = float(1.69)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 79, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":79, "input_value":input_value, "op_type":"de_jong_attractor_y", 
