...
# Script ID 52: Op 'logistic_growth', Modifiers: r=3.368, k=15
...
if __name__ == "__main__":
    ...
    modifier_r = float(3.368)
    modifier_k = float(15)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 52, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":52, "input_value":input_value, "op_type":"logistic_growth", 
