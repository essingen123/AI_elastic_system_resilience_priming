...
# Script ID 217: Op 'sine_power_mix', Modifiers: freq1=0.79, pow1=2, amp1=0.5, freq2=2.8, pow2=2, amp2=4.2
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.79)
    modifier_pow1 = float(2)
    modifier_amp1 = float(0.5)
    modifier_freq2 = float(2.8)
    modifier_pow2 = float(2)
    modifier_amp2 = float(4.2)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 217, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":217, "input_value":input_value, "op_type":"sine_power_mix", 
