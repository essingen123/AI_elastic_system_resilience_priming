...
# Script ID 58: Op 'de_jong_attractor_x', Modifiers: a=-0.71, b=0.24
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.71)
    modifier_b = float(0.24)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 58, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":58, "input_value":input_value, "op_type":"de_jong_attractor_x", 
