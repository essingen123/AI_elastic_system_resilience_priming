...
# Script ID 277: Op 'clifford_attractor_x', Modifiers: a=1.46, c=1.11
...
if __name__ == "__main__":
    ...
    modifier_c = float(1.11)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 277, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":277, "input_value":input_value, "op_type":"clifford_attractor_x", 
