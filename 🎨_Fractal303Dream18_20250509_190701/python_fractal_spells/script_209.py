...
# Script ID 209: Op 'clifford_attractor_y', Modifiers: b=-1.07, d=-1.96
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 209, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":209, "input_value":input_value, "op_type":"clifford_attractor_y", 
