...
# Script ID 266: Op 'clifford_attractor_x', Modifiers: a=0.59, c=-0.89
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 266, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":266, "input_value":input_value, "op_type":"clifford_attractor_x", 
