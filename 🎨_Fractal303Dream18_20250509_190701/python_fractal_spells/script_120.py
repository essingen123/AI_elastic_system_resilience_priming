...
# Script ID 120: Op 'de_jong_attractor_y', Modifiers: c=2.23, d=1.46
...
if __name__ == "__main__":
    ...
    modifier_d = float(1.46)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 120, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":120, "input_value":input_value, "op_type":"de_jong_attractor_y", 
