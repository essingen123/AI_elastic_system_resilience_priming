...
# Script ID 75: Op 'sine_power_mix', Modifiers: freq1=2.31, pow1=2, amp1=3.2, freq2=1.41, pow2=1, amp2=3.7
...
if __name__ == "__main__":
    ...
    modifier_freq2 = float(1.41)
    modifier_pow2 = float(1)
    modifier_amp2 = float(3.7)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 75, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":75, "input_value":input_value, "op_type":"sine_power_mix", 
