...
# Script ID 114: Op 'de_jong_attractor_x', Modifiers: a=-0.02, b=-2.88
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.02)
    modifier_b = float(-2.88)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 114, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":114, "input_value":input_value, "op_type":"de_jong_attractor_x", 
