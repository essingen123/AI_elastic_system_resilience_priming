...
# Script ID 233: Op 'sine_power_mix', Modifiers: freq1=0.26, pow1=2, amp1=1.3, freq2=1.56, pow2=1, amp2=3.3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.26)
    modifier_pow1 = float(2)
    modifier_amp1 = float(1.3)
    modifier_freq2 = float(1.56)
    modifier_pow2 = float(1)
    modifier_amp2 = float(3.3)
