...
# Script ID 175: Op 'sine_power_mix', Modifiers: freq1=2.67, pow1=3, amp1=1, freq2=0.33, pow2=3, amp2=2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 175, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":175, "input_value":input_value, "op_type":"sine_power_mix", 
