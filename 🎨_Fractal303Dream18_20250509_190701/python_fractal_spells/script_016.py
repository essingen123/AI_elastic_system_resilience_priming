...
# Script ID 16: Op 'logistic_growth', Modifiers: r=2.986, k=97
...
if __name__ == "__main__":
    ...
    modifier_r = float(2.986)
    modifier_k = float(97)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 16, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":16, "input_value":input_value, "op_type":"logistic_growth", 
