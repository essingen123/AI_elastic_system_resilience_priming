...
# Script ID 67: Op 'sine_power_mix', Modifiers: freq1=0.76, pow1=3, amp1=3.3, freq2=0.45, pow2=1, amp2=1.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 67, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":67, "input_value":input_value, "op_type":"sine_power_mix", 
