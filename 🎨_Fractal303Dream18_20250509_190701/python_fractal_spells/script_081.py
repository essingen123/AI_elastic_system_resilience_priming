...
# Script ID 81: Op 'de_jong_attractor_y', Modifiers: c=1.79, d=-1.09
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 81, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":81, "input_value":input_value, "op_type":"de_jong_attractor_y", 
