...
# Script ID 46: Op 'de_jong_attractor_x', Modifiers: a=-0.59, b=-1.79
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.59)
    modifier_b = float(-1.79)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 46, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":46, "input_value":input_value, "op_type":"de_jong_attractor_x", 
