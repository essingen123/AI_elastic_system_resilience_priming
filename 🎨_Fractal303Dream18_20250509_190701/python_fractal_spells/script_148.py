...
# Script ID 148: Op 'logistic_growth', Modifiers: r=3.81, k=51
...
if __name__ == "__main__":
    ...
    modifier_r = float(3.81)
    modifier_k = float(51)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 148, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":148, "input_value":input_value, "op_type":"logistic_growth", 
