...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, 1.8)
    ...
    next_call_id = 91 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({"script_id":81,"input_value":input_value,"op_type":"divide","modifier_used":1.8,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))