...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, 1.9)
    ...
    print(json.dumps({"script_id":186,"input_value":input_value,"op_type":"divide","modifier_used":1.9,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))