...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, 0.5)
    ...
    print(json.dumps({"script_id":129,"input_value":input_value,"op_type":"power","modifier_used":0.5,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))