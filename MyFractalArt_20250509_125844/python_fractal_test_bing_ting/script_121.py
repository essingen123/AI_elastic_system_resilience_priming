...
if __name__ == "__main__":
    ...
    print(json.dumps({"script_id":121,"input_value":input_value,"op_type":"modulo_shift","modifier_used":2,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))