...
if __name__ == "__main__":
    ...
    print(json.dumps({"script_id":120,"input_value":input_value,"op_type":"tangent_clip","modifier_used":3,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))