...
if __name__ == "__main__":
    ...
    print(json.dumps({"script_id":247,"input_value":input_value,"op_type":"divide","modifier_used":1,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))