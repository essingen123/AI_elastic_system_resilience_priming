...
if __name__ == "__main__":
    ...
    next_call_id = 24 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({"script_id":10,"input_value":input_value,"op_type":"multiply","modifier_used":0.7,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))