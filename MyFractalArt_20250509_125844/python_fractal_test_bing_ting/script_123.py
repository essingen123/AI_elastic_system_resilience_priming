...
if __name__ == "__main__":
    ...
    next_call_id = 125 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({"script_id":123,"input_value":input_value,"op_type":"modulo_shift","modifier_used":3,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))