...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, 1.5)
    ...
    print(json.dumps({"script_id":283,"input_value":input_value,"op_type":"power","modifier_used":1.5,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))