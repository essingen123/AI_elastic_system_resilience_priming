...
if __name__ == "__main__":
    ...
    next_call_id = 64 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({"script_id":62,"input_value":input_value,"op_type":"tangent_clip","modifier_used":4,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))