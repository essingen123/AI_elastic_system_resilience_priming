...
def perform_operation(val, modifier):
    try: return (val + modifier) % 10 if modifier != 0 else val % 10
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, 5)
    ...
    print(json.dumps({"script_id":196,"input_value":input_value,"op_type":"modulo_shift","modifier_used":5,"output_value":output_value,"depth":current_depth,"next_call_id":next_call_id,"num_total_scripts":num_total_scripts}))