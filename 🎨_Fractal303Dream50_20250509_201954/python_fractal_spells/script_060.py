...
# Script ID 60: Op 'de_jong_attractor_y', Modifiers: c=2.39, d=-0.96
...
if __name__ == "__main__":
    ...
    c = float(2.39) # PHP generated
    d = float(-0.96) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 60, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":60, "input_value":input_value, "op_type":op_name, # Use Python op_name
