...
# Script ID 269: Op 'swirl_step', Modifiers: strength=4.3
...
if __name__ == "__main__":
    ...
    strength = float(4.3) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 269, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":269, "input_value":input_value, "op_type":op_name, # Use Python op_name
