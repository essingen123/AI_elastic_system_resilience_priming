...
# Script ID 65: Op 'clifford_attractor_y', Modifiers: b=1.64, d=-0.85
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":65, "input_value":input_value, "op_type":op_name, # Use Python op_name
