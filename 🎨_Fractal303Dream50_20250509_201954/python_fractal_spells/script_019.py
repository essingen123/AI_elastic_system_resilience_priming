...
# Script ID 19: Op 'logistic_growth', Modifiers: r=3.386, k=51
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":19, "input_value":input_value, "op_type":op_name, # Use Python op_name
