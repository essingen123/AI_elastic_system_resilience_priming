...
# Script ID 294: Op 'de_jong_attractor_x', Modifiers: a=-1.3, b=1.76
...
if __name__ == "__main__":
    ...
    a = float(-1.3) # PHP generated
    b = float(1.76) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 294, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":294, "input_value":input_value, "op_type":op_name, # Use Python op_name
