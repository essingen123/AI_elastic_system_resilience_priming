...
# Script ID 293: Op 'clifford_attractor_x', Modifiers: a=0.45, c=-0.29
...
if __name__ == "__main__":
    ...
    a = float(0.45) # PHP generated
    c = float(-0.29) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 293, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":293, "input_value":input_value, "op_type":op_name, # Use Python op_name
