...
# Script ID 78: Op 'clifford_attractor_x', Modifiers: a=0.97, c=-1.21
...
if __name__ == "__main__":
    ...
    a = float(0.97) # PHP generated
    c = float(-1.21) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 78, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":78, "input_value":input_value, "op_type":op_name, # Use Python op_name
