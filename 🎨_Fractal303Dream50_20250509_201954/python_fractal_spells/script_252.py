...
# Script ID 252: Op 'lyapunov_exponent_approx', Modifiers: r=3.726
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":252, "input_value":input_value, "op_type":op_name, # Use Python op_name
