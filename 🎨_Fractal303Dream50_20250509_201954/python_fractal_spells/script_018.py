...
# Script ID 18: Op 'de_jong_attractor_x', Modifiers: a=-1.17, b=-0.05
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 18, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":18, "input_value":input_value, "op_type":op_name, # Use Python op_name
