...
# Script ID 219: Op 'clifford_attractor_x', Modifiers: a=1.1, c=0.95
...
if __name__ == "__main__":
    ...
    a = float(1.1) # PHP generated
    c = float(0.95) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 219, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":219, "input_value":input_value, "op_type":op_name, # Use Python op_name
