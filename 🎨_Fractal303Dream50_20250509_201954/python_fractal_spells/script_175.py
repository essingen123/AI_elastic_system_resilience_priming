...
# Script ID 175: Op 'sine_power_mix', Modifiers: freq1=1.14, pow1=1, amp1=4.5, freq2=1.01, pow2=1, amp2=2.3
...
if __name__ == "__main__":
    ...
    freq2 = float(1.01) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 175, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":175, "input_value":input_value, "op_type":op_name, # Use Python op_name
