...
# Script ID 250: Op 'clifford_attractor_x', Modifiers: a=-0.48, c=1.1
...
if __name__ == "__main__":
    ...
    a = float(-0.48) # PHP generated
    c = float(1.1) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 250, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":250, "input_value":input_value, "op_type":op_name, # Use Python op_name
