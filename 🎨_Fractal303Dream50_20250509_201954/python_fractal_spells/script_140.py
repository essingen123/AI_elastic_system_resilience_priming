...
# Script ID 140: Op 'sine_power_mix', Modifiers: freq1=1.86, pow1=2, amp1=3.8, freq2=0.74, pow2=1, amp2=1.2
...
if __name__ == "__main__":
    ...
    freq1 = float(1.86) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(3.8) # PHP generated
    freq2 = float(0.74) # PHP generated
    ...
    print(json.dumps({
        "script_id":140, "input_value":input_value, "op_type":op_name, # Use Python op_name
