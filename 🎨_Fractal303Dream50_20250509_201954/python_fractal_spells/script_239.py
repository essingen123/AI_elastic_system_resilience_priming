...
# Script ID 239: Op 'coupled_logistic_x', Modifiers: rx=3.709, cxy=0.159
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":239, "input_value":input_value, "op_type":op_name, # Use Python op_name
