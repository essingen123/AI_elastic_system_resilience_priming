...
# Script ID 31: Op 'clifford_attractor_x', Modifiers: a=0.88, c=-1.9
...
if __name__ == "__main__":
    ...
    a = float(0.88) # PHP generated
    c = float(-1.9) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 31, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":31, "input_value":input_value, "op_type":op_name, # Use Python op_name
