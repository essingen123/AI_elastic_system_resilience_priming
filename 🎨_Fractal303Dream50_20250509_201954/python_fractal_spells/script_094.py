...
# Script ID 94: Op 'coupled_logistic_x', Modifiers: rx=3.975, cxy=0.094
...
if __name__ == "__main__":
    ...
    rx = float(3.975) # PHP generated
    cxy = float(0.094) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 94, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":94, "input_value":input_value, "op_type":op_name, # Use Python op_name
