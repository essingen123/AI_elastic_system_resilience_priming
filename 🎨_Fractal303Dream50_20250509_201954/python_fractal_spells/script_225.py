...
# Script ID 225: Op 'sine_power_mix', Modifiers: freq1=1.14, pow1=1, amp1=4.6, freq2=2.56, pow2=2, amp2=3.6
...
if __name__ == "__main__":
    ...
    freq1 = float(1.14) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(4.6) # PHP generated
    freq2 = float(2.56) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(3.6) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 225, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":225, "input_value":input_value, "op_type":op_name, # Use Python op_name
