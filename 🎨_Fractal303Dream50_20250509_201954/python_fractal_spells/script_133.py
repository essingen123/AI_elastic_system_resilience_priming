...
# Script ID 133: Op 'clifford_attractor_y', Modifiers: b=-0.4, d=0.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 133, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":133, "input_value":input_value, "op_type":op_name, # Use Python op_name
