...
# Script ID 14: Op 'sine_power_mix', Modifiers: freq1=1.63, pow1=3, amp1=3.1, freq2=2.33, pow2=1, amp2=2.8
...
if __name__ == "__main__":
    ...
    freq1 = float(1.63) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(3.1) # PHP generated
    freq2 = float(2.33) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(2.8) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 14, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":14, "input_value":input_value, "op_type":op_name, # Use Python op_name
