...
# Script ID 90: Op 'de_jong_attractor_y', Modifiers: c=1.55, d=-2.32
...
if __name__ == "__main__":
    ...
    c = float(1.55) # PHP generated
    d = float(-2.32) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 90, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":90, "input_value":input_value, "op_type":op_name, # Use Python op_name
