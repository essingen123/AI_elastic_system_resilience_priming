...
# Script ID 34: Op 'de_jong_attractor_y', Modifiers: c=-2.93, d=0.19
...
if __name__ == "__main__":
    ...
    c = float(-2.93) # PHP generated
    d = float(0.19) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 34, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":34, "input_value":input_value, "op_type":op_name, # Use Python op_name
