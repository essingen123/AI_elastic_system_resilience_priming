...
# Script ID 216: Op 'clifford_attractor_x', Modifiers: a=1.32, c=-1.49
...
if __name__ == "__main__":
    ...
    a = float(1.32) # PHP generated
    c = float(-1.49) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 216, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":216, "input_value":input_value, "op_type":op_name, # Use Python op_name
