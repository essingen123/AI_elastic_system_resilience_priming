...
# Script ID 200: Op 'de_jong_attractor_x', Modifiers: a=-1.85, b=1.11
...
if __name__ == "__main__":
    ...
    a = float(-1.85) # PHP generated
    b = float(1.11) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 200, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":200, "input_value":input_value, "op_type":op_name, # Use Python op_name
