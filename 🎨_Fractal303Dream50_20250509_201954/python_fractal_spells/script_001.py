...
# Script ID 1: Op 'de_jong_attractor_y', Modifiers: c=-1.95, d=-0.05
...
if __name__ == "__main__":
    ...
    c = float(-1.95) # PHP generated
    d = float(-0.05) # PHP generated
    ...
    print(json.dumps({
        "script_id":1, "input_value":input_value, "op_type":op_name, # Use Python op_name
