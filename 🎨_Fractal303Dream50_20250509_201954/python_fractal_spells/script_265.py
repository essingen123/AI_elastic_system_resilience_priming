...
# Script ID 265: Op 'de_jong_attractor_x', Modifiers: a=2.26, b=2.72
...
if __name__ == "__main__":
    ...
    a = float(2.26) # PHP generated
    b = float(2.72) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 265, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":265, "input_value":input_value, "op_type":op_name, # Use Python op_name
