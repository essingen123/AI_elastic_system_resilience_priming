...
# Script ID 230: Op 'de_jong_attractor_y', Modifiers: c=-0.35, d=-1.23
...
if __name__ == "__main__":
    ...
    c = float(-0.35) # PHP generated
    d = float(-1.23) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 230, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":230, "input_value":input_value, "op_type":op_name, # Use Python op_name
