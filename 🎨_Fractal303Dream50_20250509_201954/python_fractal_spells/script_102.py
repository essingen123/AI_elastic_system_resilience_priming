...
# Script ID 102: Op 'clifford_attractor_x', Modifiers: a=0.04, c=0.51
...
if __name__ == "__main__":
    ...
    a = float(0.04) # PHP generated
    c = float(0.51) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 102, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":102, "input_value":input_value, "op_type":op_name, # Use Python op_name
