...
# Script ID 185: Op 'de_jong_attractor_x', Modifiers: a=2.69, b=-0.66
op_name = "de_jong_attractor_x" # Make op_name global in this Python script's context
...
if __name__ == "__main__":
    ...
    a = float(2.69) # PHP generated
    b = float(-0.66) # PHP generated
    ...
    python_modifiers_dict = {"a": a, "b": b}
    
    output_value = perform_operation(input_value, current_depth, 185, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":185, "input_value":input_value, "op_type":op_name, # Use Python op_name
