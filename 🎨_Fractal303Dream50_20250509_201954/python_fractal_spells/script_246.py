...
# Script ID 246: Op 'clifford_attractor_x', Modifiers: a=-1.42, c=-1.78
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 246})); sys.exit(1)
    ...
    a = float(-1.42) # PHP generated
    c = float(-1.78) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 246, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":246, "input_value":input_value, "op_type":op_name, # Use Python op_name
