...
# Script ID 2: Op 'clifford_attractor_x', Modifiers: a=-1.02, c=-0.8
...
if __name__ == "__main__":
    ...
    a = float(-1.02) # PHP generated
    c = float(-0.8) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 2, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":2, "input_value":input_value, "op_type":op_name, # Use Python op_name
