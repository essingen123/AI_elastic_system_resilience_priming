...
# Script ID 233: Op 'lyapunov_exponent_approx', Modifiers: r=3.956
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 233})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 233, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":233, "input_value":input_value, "op_type":op_name, # Use Python op_name
