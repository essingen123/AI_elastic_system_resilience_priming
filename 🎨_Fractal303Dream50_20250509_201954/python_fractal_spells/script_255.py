...
# Script ID 255: Op 'sine_power_mix', Modifiers: freq1=2.57, pow1=2, amp1=0.8, freq2=1.5, pow2=3, amp2=1.7
...
if __name__ == "__main__":
    ...
    freq1 = float(2.57) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(0.8) # PHP generated
    freq2 = float(1.5) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(1.7) # PHP generated
