...
# Script ID 12: Op 'de_jong_attractor_x', Modifiers: a=-2.54, b=0.33
...
if __name__ == "__main__":
    ...
    a = float(-2.54) # PHP generated
    b = float(0.33) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 12, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":12, "input_value":input_value, "op_type":op_name, # Use Python op_name
