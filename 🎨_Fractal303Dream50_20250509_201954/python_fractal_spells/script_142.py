...
# Script ID 142: Op 'sine_power_mix', Modifiers: freq1=2.05, pow1=1, amp1=2.5, freq2=1.06, pow2=3, amp2=4.7
...
if __name__ == "__main__":
    ...
    freq1 = float(2.05) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(2.5) # PHP generated
    freq2 = float(1.06) # PHP generated
    ...
    print(json.dumps({
        "script_id":142, "input_value":input_value, "op_type":op_name, # Use Python op_name
