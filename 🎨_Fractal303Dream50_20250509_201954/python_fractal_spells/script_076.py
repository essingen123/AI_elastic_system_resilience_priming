...
# Script ID 76: Op 'sine_power_mix', Modifiers: freq1=0.29, pow1=1, amp1=4.9, freq2=1.87, pow2=3, amp2=3.2
...
if __name__ == "__main__":
    ...
    freq2 = float(1.87) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 76, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":76, "input_value":input_value, "op_type":op_name, # Use Python op_name
