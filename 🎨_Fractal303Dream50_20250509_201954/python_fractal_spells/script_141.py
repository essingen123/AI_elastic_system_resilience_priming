...
# Script ID 141: Op 'de_jong_attractor_y', Modifiers: c=-1.71, d=1.58
...
if __name__ == "__main__":
    ...
    c = float(-1.71) # PHP generated
    d = float(1.58) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 141, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":141, "input_value":input_value, "op_type":op_name, # Use Python op_name
