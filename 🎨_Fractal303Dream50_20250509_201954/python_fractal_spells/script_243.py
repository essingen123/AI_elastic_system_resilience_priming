...
# Script ID 243: Op 'clifford_attractor_x', Modifiers: a=-1.15, c=-1.14
...
if __name__ == "__main__":
    ...
    a = float(-1.15) # PHP generated
    c = float(-1.14) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 243, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":243, "input_value":input_value, "op_type":op_name, # Use Python op_name
