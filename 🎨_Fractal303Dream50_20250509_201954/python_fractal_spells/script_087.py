...
# Script ID 87: Op 'coupled_logistic_x', Modifiers: rx=3.953, cxy=0.172
...
if __name__ == "__main__":
    ...
    rx = float(3.953) # PHP generated
    cxy = float(0.172) # PHP generated
    ...
    print(json.dumps({
        "script_id":87, "input_value":input_value, "op_type":op_name, # Use Python op_name
