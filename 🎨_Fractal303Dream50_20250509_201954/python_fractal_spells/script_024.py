...
# Script ID 24: Op 'de_jong_attractor_x', Modifiers: a=1.21, b=-0.88
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 24, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":24, "input_value":input_value, "op_type":op_name, # Use Python op_name
