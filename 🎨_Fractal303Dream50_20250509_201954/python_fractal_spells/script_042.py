...
# Script ID 42: Op 'clifford_attractor_x', Modifiers: a=-1.38, c=-0.44
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 42, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":42, "input_value":input_value, "op_type":op_name, # Use Python op_name
