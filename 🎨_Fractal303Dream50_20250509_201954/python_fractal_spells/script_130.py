...
# Script ID 130: Op 'de_jong_attractor_x', Modifiers: a=-1.16, b=-1.39
...
if __name__ == "__main__":
    ...
    a = float(-1.16) # PHP generated
    b = float(-1.39) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 130, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":130, "input_value":input_value, "op_type":op_name, # Use Python op_name
