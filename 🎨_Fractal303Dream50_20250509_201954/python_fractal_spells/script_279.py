...
# Script ID 279: Op 'de_jong_attractor_y', Modifiers: c=-0.04, d=1.37
...
if __name__ == "__main__":
    ...
    c = float(-0.04) # PHP generated
    d = float(1.37) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 279, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":279, "input_value":input_value, "op_type":op_name, # Use Python op_name
