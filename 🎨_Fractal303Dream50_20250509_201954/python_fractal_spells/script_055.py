...
# Script ID 55: Op 'logistic_growth', Modifiers: r=2.91, k=56
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":55, "input_value":input_value, "op_type":op_name, # Use Python op_name
