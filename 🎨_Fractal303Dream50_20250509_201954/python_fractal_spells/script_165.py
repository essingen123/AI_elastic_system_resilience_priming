...
# Script ID 165: Op 'de_jong_attractor_x', Modifiers: a=0, b=2.15
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 165, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":165, "input_value":input_value, "op_type":op_name, # Use Python op_name
