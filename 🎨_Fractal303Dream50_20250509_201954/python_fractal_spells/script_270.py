...
# Script ID 270: Op 'sine_power_mix', Modifiers: freq1=0.97, pow1=2, amp1=4.2, freq2=0.12, pow2=3, amp2=1.9
...
if __name__ == "__main__":
    ...
    freq1 = float(0.97) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(4.2) # PHP generated
    freq2 = float(0.12) # PHP generated
