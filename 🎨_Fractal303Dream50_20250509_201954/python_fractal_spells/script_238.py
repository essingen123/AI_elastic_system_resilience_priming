...
# Script ID 238: Op 'clifford_attractor_x', Modifiers: a=0.8, c=0.36
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 238})); sys.exit(1)
    ...
    a = float(0.8) # PHP generated
    c = float(0.36) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 238, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":238, "input_value":input_value, "op_type":op_name, # Use Python op_name
