...
# Script ID 51: Op 'coupled_logistic_x', Modifiers: rx=3.869, cxy=0.146
...
if __name__ == "__main__":
    ...
    rx = float(3.869) # PHP generated
    cxy = float(0.146) # PHP generated
    ...
    print(json.dumps({
        "script_id":51, "input_value":input_value, "op_type":op_name, # Use Python op_name
