...
# Script ID 123: Op 'de_jong_attractor_y', Modifiers: c=1.41, d=-0.64
...
if __name__ == "__main__":
    ...
    c = float(1.41) # PHP generated
    d = float(-0.64) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 123, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":123, "input_value":input_value, "op_type":op_name, # Use Python op_name
