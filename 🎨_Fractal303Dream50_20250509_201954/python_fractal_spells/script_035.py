...
# Script ID 35: Op 'clifford_attractor_x', Modifiers: a=1.07, c=-0.54
...
if __name__ == "__main__":
    ...
    a = float(1.07) # PHP generated
    c = float(-0.54) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 35, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":35, "input_value":input_value, "op_type":op_name, # Use Python op_name
