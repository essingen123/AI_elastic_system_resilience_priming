...
# Script ID 77: Op 'clifford_attractor_x', Modifiers: a=-1.49, c=1.91
...
if __name__ == "__main__":
    ...
    a = float(-1.49) # PHP generated
    c = float(1.91) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 77, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":77, "input_value":input_value, "op_type":op_name, # Use Python op_name
