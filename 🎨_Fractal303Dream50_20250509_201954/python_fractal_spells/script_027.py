...
# Script ID 27: Op 'clifford_attractor_x', Modifiers: a=-1.05, c=0.27
...
if __name__ == "__main__":
    ...
    a = float(-1.05) # PHP generated
    c = float(0.27) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 27, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":27, "input_value":input_value, "op_type":op_name, # Use Python op_name
