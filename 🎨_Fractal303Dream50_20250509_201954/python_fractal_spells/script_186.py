...
# Script ID 186: Op 'de_jong_attractor_x', Modifiers: a=-1.93, b=1.84
...
if __name__ == "__main__":
    ...
    a = float(-1.93) # PHP generated
    b = float(1.84) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 186, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":186, "input_value":input_value, "op_type":op_name, # Use Python op_name
