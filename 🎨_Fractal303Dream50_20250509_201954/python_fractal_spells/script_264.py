...
# Script ID 264: Op 'de_jong_attractor_y', Modifiers: c=0.67, d=-2.03
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":264, "input_value":input_value, "op_type":op_name, # Use Python op_name
