...
# Script ID 25: Op 'clifford_attractor_x', Modifiers: a=0, c=1.68
...
if __name__ == "__main__":
    ...
    a = float(0) # PHP generated
    c = float(1.68) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 25, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":25, "input_value":input_value, "op_type":op_name, # Use Python op_name
