...
# Script ID 155: Op 'clifford_attractor_x', Modifiers: a=-1.09, c=-0.56
...
if __name__ == "__main__":
    ...
    a = float(-1.09) # PHP generated
    c = float(-0.56) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 155, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":155, "input_value":input_value, "op_type":op_name, # Use Python op_name
