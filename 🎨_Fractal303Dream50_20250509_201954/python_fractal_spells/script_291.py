...
# Script ID 291: Op 'sine_power_mix', Modifiers: freq1=2.03, pow1=2, amp1=5, freq2=2.72, pow2=2, amp2=1.7
...
if __name__ == "__main__":
    ...
    freq1 = float(2.03) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(5) # PHP generated
    freq2 = float(2.72) # PHP generated
    ...
    print(json.dumps({
        "script_id":291, "input_value":input_value, "op_type":op_name, # Use Python op_name
