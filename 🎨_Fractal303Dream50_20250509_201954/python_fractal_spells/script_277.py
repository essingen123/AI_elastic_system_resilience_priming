...
# Script ID 277: Op 'sine_power_mix', Modifiers: freq1=1.43, pow1=1, amp1=3.4, freq2=1.54, pow2=2, amp2=4.3
...
if __name__ == "__main__":
    ...
    freq1 = float(1.43) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(3.4) # PHP generated
    freq2 = float(1.54) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(4.3) # PHP generated
