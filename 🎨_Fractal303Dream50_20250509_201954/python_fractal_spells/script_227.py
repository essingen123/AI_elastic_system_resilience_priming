...
# Script ID 227: Op 'de_jong_attractor_y', Modifiers: c=2.07, d=0.37
...
if __name__ == "__main__":
    ...
    c = float(2.07) # PHP generated
    d = float(0.37) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 227, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":227, "input_value":input_value, "op_type":op_name, # Use Python op_name
