...
# Script ID 231: Op 'clifford_attractor_x', Modifiers: a=0.46, c=-0.96
...
if __name__ == "__main__":
    ...
    a = float(0.46) # PHP generated
    c = float(-0.96) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 231, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":231, "input_value":input_value, "op_type":op_name, # Use Python op_name
