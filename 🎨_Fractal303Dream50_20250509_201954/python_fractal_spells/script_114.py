...
# Script ID 114: Op 'sine_power_mix', Modifiers: freq1=2.97, pow1=2, amp1=2.1, freq2=1.19, pow2=3, amp2=5
...
if __name__ == "__main__":
    ...
    freq1 = float(2.97) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.1) # PHP generated
    freq2 = float(1.19) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(5) # PHP generated
