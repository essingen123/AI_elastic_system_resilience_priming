...
# Script ID 61: Op 'de_jong_attractor_y', Modifiers: c=1.99, d=1.56
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 61, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":61, "input_value":input_value, "op_type":op_name, # Use Python op_name
