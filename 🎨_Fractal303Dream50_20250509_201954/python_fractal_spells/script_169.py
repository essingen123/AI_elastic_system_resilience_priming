...
# Script ID 169: Op 'clifford_attractor_x', Modifiers: a=1.6, c=0.39
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 169, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":169, "input_value":input_value, "op_type":op_name, # Use Python op_name
