...
# Script ID 131: Op 'sine_power_mix', Modifiers: freq1=1.37, pow1=2, amp1=4.9, freq2=1.93, pow2=1, amp2=2.3
...
if __name__ == "__main__":
    ...
    freq1 = float(1.37) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(4.9) # PHP generated
    freq2 = float(1.93) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(2.3) # PHP generated
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":op_name, # Use Python op_name
