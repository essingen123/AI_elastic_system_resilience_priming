...
# Script ID 217: Op 'coupled_logistic_x', Modifiers: rx=3.679, cxy=0.19
...
if __name__ == "__main__":
    ...
    rx = float(3.679) # PHP generated
    cxy = float(0.19) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 217, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":217, "input_value":input_value, "op_type":op_name, # Use Python op_name
