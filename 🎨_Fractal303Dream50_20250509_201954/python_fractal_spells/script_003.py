...
# Script ID 3: Op 'clifford_attractor_x', Modifiers: a=-0.63, c=-1.19
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 3, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":3, "input_value":input_value, "op_type":op_name, # Use Python op_name
