...
# Script ID 147: Op 'sine_power_mix', Modifiers: freq1=0.3, pow1=3, amp1=2.2, freq2=0.11, pow2=1, amp2=3.7
...
if __name__ == "__main__":
    ...
    freq2 = float(0.11) # PHP generated
    ...
    print(json.dumps({
        "script_id":147, "input_value":input_value, "op_type":op_name, # Use Python op_name
