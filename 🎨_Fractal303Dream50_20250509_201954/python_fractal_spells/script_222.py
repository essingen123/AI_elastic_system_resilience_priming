...
# Script ID 222: Op 'de_jong_attractor_y', Modifiers: c=1.99, d=1.74
...
if __name__ == "__main__":
    ...
    c = float(1.99) # PHP generated
    d = float(1.74) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 222, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":222, "input_value":input_value, "op_type":op_name, # Use Python op_name
