...
# Script ID 241: Op 'de_jong_attractor_x', Modifiers: a=0.05, b=2.6
...
if __name__ == "__main__":
    ...
    a = float(0.05) # PHP generated
    b = float(2.6) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 241, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":241, "input_value":input_value, "op_type":op_name, # Use Python op_name
