...
# Script ID 145: Op 'clifford_attractor_x', Modifiers: a=-0.59, c=0.79
...
if __name__ == "__main__":
    ...
    a = float(-0.59) # PHP generated
    c = float(0.79) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 145, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":145, "input_value":input_value, "op_type":op_name, # Use Python op_name
