...
# Script ID 242: Op 'de_jong_attractor_x', Modifiers: a=0.58, b=-1.17
...
if __name__ == "__main__":
    ...
    a = float(0.58) # PHP generated
    b = float(-1.17) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 242, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":242, "input_value":input_value, "op_type":op_name, # Use Python op_name
