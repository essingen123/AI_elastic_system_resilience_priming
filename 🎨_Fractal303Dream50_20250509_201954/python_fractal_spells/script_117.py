...
# Script ID 117: Op 'sine_power_mix', Modifiers: freq1=0.25, pow1=3, amp1=3.6, freq2=1.37, pow2=3, amp2=2.1
...
if __name__ == "__main__":
    ...
    freq1 = float(0.25) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(3.6) # PHP generated
    freq2 = float(1.37) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 117, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":117, "input_value":input_value, "op_type":op_name, # Use Python op_name
