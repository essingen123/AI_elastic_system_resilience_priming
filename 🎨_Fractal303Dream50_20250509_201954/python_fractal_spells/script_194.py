...
# Script ID 194: Op 'lyapunov_exponent_approx', Modifiers: r=3.662
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 194, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":194, "input_value":input_value, "op_type":op_name, # Use Python op_name
