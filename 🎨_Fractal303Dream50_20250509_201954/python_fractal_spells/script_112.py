...
# Script ID 112: Op 'coupled_logistic_x', Modifiers: rx=3.977, cxy=0.117
op_name = "coupled_logistic_x" # Make op_name global in this Python script's context
...
if __name__ == "__main__":
    ...
    rx = float(3.977) # PHP generated
    cxy = float(0.117) # PHP generated
    ...
    python_modifiers_dict = {"rx": rx, "cxy": cxy}
    ...
    print(json.dumps({
        "script_id":112, "input_value":input_value, "op_type":op_name, # Use Python op_name
