...
# Script ID 21: Op 'sine_power_mix', Modifiers: freq1=2.04, pow1=3, amp1=1.2, freq2=0.45, pow2=3, amp2=3.9
...
if __name__ == "__main__":
    ...
    freq1 = float(2.04) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(1.2) # PHP generated
    freq2 = float(0.45) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(3.9) # PHP generated
