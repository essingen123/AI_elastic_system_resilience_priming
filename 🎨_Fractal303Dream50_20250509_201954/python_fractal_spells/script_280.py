...
# Script ID 280: Op 'sine_power_mix', Modifiers: freq1=0.84, pow1=1, amp1=2.9, freq2=1.97, pow2=3, amp2=3.3
...
if __name__ == "__main__":
    ...
    freq1 = float(0.84) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(2.9) # PHP generated
    freq2 = float(1.97) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(3.3) # PHP generated
