...
# Script ID 20: Op 'sine_power_mix', Modifiers: freq1=0.35, pow1=3, amp1=2.6, freq2=0.45, pow2=2, amp2=1.2
...
if __name__ == "__main__":
    ...
    freq1 = float(0.35) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.6) # PHP generated
    freq2 = float(0.45) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(1.2) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 20, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":20, "input_value":input_value, "op_type":op_name, # Use Python op_name
