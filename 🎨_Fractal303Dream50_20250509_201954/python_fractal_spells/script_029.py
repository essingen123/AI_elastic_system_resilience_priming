...
# Script ID 29: Op 'coupled_logistic_x', Modifiers: rx=3.825, cxy=0.167
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":29, "input_value":input_value, "op_type":op_name, # Use Python op_name
