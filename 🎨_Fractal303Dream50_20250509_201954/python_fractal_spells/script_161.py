...
# Script ID 161: Op 'de_jong_attractor_x', Modifiers: a=2.25, b=1.59
...
if __name__ == "__main__":
    ...
    a = float(2.25) # PHP generated
    b = float(1.59) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 161, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":161, "input_value":input_value, "op_type":op_name, # Use Python op_name
