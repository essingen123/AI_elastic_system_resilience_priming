...
# Script ID 163: Op 'clifford_attractor_x', Modifiers: a=-1.61, c=-0.4
...
if __name__ == "__main__":
    ...
    a = float(-1.61) # PHP generated
    c = float(-0.4) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 163, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":163, "input_value":input_value, "op_type":op_name, # Use Python op_name
