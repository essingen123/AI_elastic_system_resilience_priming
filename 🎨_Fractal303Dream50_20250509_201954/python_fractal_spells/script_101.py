...
# Script ID 101: Op 'de_jong_attractor_x', Modifiers: a=-2.1, b=-1.94
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 101, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":op_name, # Use Python op_name
