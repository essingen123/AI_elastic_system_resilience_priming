...
# Script ID 283: Op 'sine_power_mix', Modifiers: freq1=0.53, pow1=3, amp1=2.9, freq2=2.26, pow2=3, amp2=0.9
...
if __name__ == "__main__":
    ...
    freq1 = float(0.53) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.9) # PHP generated
    freq2 = float(2.26) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(0.9) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 283, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":283, "input_value":input_value, "op_type":op_name, # Use Python op_name
