...
# Script ID 99: Op 'de_jong_attractor_y', Modifiers: c=1.7, d=-1.99
...
if __name__ == "__main__":
    ...
    c = float(1.7) # PHP generated
    d = float(-1.99) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 99, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":99, "input_value":input_value, "op_type":op_name, # Use Python op_name
