...
# Script ID 177: Op 'clifford_attractor_x', Modifiers: a=-1.26, c=0.84
...
if __name__ == "__main__":
    ...
    a = float(-1.26) # PHP generated
    c = float(0.84) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 177, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":177, "input_value":input_value, "op_type":op_name, # Use Python op_name
