...
# Script ID 206: Op 'clifford_attractor_x', Modifiers: a=-1.2, c=1.67
...
if __name__ == "__main__":
    ...
    a = float(-1.2) # PHP generated
    c = float(1.67) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 206, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":206, "input_value":input_value, "op_type":op_name, # Use Python op_name
