...
# Script ID 168: Op 'coupled_logistic_x', Modifiers: rx=3.646, cxy=0.071
...
if __name__ == "__main__":
    ...
    rx = float(3.646) # PHP generated
    cxy = float(0.071) # PHP generated
    ...
    print(json.dumps({
        "script_id":168, "input_value":input_value, "op_type":op_name, # Use Python op_name
