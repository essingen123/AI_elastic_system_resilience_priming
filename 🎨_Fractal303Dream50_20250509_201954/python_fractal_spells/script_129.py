...
# Script ID 129: Op 'swirl_step', Modifiers: strength=0.9
...
if __name__ == "__main__":
    ...
    strength = float(0.9) # PHP generated
    ...
    print(json.dumps({
        "script_id":129, "input_value":input_value, "op_type":op_name, # Use Python op_name
