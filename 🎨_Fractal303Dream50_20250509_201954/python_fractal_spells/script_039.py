...
# Script ID 39: Op 'sine_power_mix', Modifiers: freq1=2.76, pow1=1, amp1=0.7, freq2=2.56, pow2=3, amp2=1.3
...
if __name__ == "__main__":
    ...
    freq1 = float(2.76) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(0.7) # PHP generated
    ...
    print(json.dumps({
        "script_id":39, "input_value":input_value, "op_type":op_name, # Use Python op_name
