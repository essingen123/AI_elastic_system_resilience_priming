...
# Script ID 297: Op 'swirl_step', Modifiers: strength=7.7
...
if __name__ == "__main__":
    ...
    strength = float(7.7) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 297, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":297, "input_value":input_value, "op_type":op_name, # Use Python op_name
