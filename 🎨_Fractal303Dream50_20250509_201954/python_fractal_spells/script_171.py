...
# Script ID 171: Op 'sine_power_mix', Modifiers: freq1=0.18, pow1=3, amp1=2, freq2=0.95, pow2=2, amp2=1.9
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":171, "input_value":input_value, "op_type":op_name, # Use Python op_name
