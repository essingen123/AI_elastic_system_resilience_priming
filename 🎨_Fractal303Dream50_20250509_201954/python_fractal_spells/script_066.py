...
# Script ID 66: Op 'de_jong_attractor_y', Modifiers: c=-2.44, d=1.97
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 66, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":66, "input_value":input_value, "op_type":op_name, # Use Python op_name
