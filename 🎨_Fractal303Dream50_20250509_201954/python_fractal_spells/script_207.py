...
# Script ID 207: Op 'sine_power_mix', Modifiers: freq1=1.16, pow1=3, amp1=1.6, freq2=2.69, pow2=1, amp2=2.3
...
if __name__ == "__main__":
    ...
    freq1 = float(1.16) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(1.6) # PHP generated
    freq2 = float(2.69) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 207, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":207, "input_value":input_value, "op_type":op_name, # Use Python op_name
