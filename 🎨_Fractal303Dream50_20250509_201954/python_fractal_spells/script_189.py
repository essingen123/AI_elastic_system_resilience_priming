...
# Script ID 189: Op 'sine_power_mix', Modifiers: freq1=0.56, pow1=2, amp1=2.3, freq2=0.95, pow2=1, amp2=2.9
...
if __name__ == "__main__":
    ...
    freq1 = float(0.56) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.3) # PHP generated
    freq2 = float(0.95) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(2.9) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 189, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":189, "input_value":input_value, "op_type":op_name, # Use Python op_name
