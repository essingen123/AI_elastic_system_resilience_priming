...
# Script ID 119: Op 'logistic_growth', Modifiers: r=3.923, k=78
...
if __name__ == "__main__":
    ...
    r = float(3.923) # PHP generated
    k = float(78) # PHP generated
    ...
    print(json.dumps({
        "script_id":119, "input_value":input_value, "op_type":op_name, # Use Python op_name
