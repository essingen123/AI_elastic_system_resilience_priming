...
# Script ID 232: Op 'sine_power_mix', Modifiers: freq1=0.71, pow1=1, amp1=4.4, freq2=0.21, pow2=3, amp2=0.6
...
if __name__ == "__main__":
    ...
    freq2 = float(0.21) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(0.6) # PHP generated
    ...
    print(json.dumps({
        "script_id":232, "input_value":input_value, "op_type":op_name, # Use Python op_name
