...
# Script ID 75: Op 'clifford_attractor_x', Modifiers: a=-0.69, c=-1.89
...
if __name__ == "__main__":
    ...
    a = float(-0.69) # PHP generated
    c = float(-1.89) # PHP generated
    ...
    print(json.dumps({
        "script_id":75, "input_value":input_value, "op_type":op_name, # Use Python op_name
