...
# Script ID 54: Op 'coupled_logistic_x', Modifiers: rx=3.72, cxy=0.103
...
if __name__ == "__main__":
    ...
    rx = float(3.72) # PHP generated
    cxy = float(0.103) # PHP generated
    ...
    print(json.dumps({
        "script_id":54, "input_value":input_value, "op_type":op_name, # Use Python op_name
