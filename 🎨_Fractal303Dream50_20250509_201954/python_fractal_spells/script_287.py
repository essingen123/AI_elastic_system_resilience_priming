...
# Script ID 287: Op 'lyapunov_exponent_approx', Modifiers: r=3.712
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 287})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 287, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":287, "input_value":input_value, "op_type":op_name, # Use Python op_name
