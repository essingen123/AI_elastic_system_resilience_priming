...
# Script ID 302: Op 'de_jong_attractor_y', Modifiers: c=2.59, d=1.45
...
if __name__ == "__main__":
    ...
    c = float(2.59) # PHP generated
    d = float(1.45) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 302, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":302, "input_value":input_value, "op_type":op_name, # Use Python op_name
