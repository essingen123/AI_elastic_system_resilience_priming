...
# Script ID 6: Op 'coupled_logistic_x', Modifiers: rx=3.761, cxy=0.087
...
if __name__ == "__main__":
    ...
    rx = float(3.761) # PHP generated
    cxy = float(0.087) # PHP generated
    ...
    print(json.dumps({
        "script_id":6, "input_value":input_value, "op_type":op_name, # Use Python op_name
