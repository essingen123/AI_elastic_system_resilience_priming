...
# Script ID 52: Op 'de_jong_attractor_x', Modifiers: a=-1.06, b=-0.77
...
if __name__ == "__main__":
    ...
    a = float(-1.06) # PHP generated
    b = float(-0.77) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 52, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":52, "input_value":input_value, "op_type":op_name, # Use Python op_name
