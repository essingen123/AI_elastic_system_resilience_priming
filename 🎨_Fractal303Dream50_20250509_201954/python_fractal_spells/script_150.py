...
# Script ID 150: Op 'sine_power_mix', Modifiers: freq1=2.75, pow1=1, amp1=2, freq2=1.21, pow2=2, amp2=2.6
...
if __name__ == "__main__":
    ...
    freq1 = float(2.75) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(2) # PHP generated
    freq2 = float(1.21) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(2.6) # PHP generated
