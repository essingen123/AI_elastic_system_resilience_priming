...
# Script ID 78: Op 'modulo_chaos', Modifiers: factor=1.2, add=2, mod=7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 78, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":78, "input_value":input_value, "op_type":"modulo_chaos", 
