...
# Script ID 135: Op 'divide', Modifiers: modifier=1.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 135, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":135, "input_value":input_value, "op_type":"divide", 
