...
# Script ID 215: Op 'divide', Modifiers: modifier=1.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 215, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":215, "input_value":input_value, "op_type":"divide", 
