...
# Script ID 16: Op 'henon_map_x', Modifiers: a=1.03
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 16, **({"modifier_a": modifier_a}))
    ...
    next_call_id = 293 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":16, "input_value":input_value, "op_type":"henon_map_x", 
