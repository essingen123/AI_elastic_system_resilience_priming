...
# Script ID 270: Op 'sine_transform', Modifiers: angle=0.2, amp=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 270, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":270, "input_value":input_value, "op_type":"sine_transform", 
