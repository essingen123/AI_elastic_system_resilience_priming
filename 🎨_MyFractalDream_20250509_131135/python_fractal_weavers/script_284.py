...
# Script ID 284: Op 'multiply', Modifiers: modifier=0.55
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 284, **({"modifier": modifier}))
    ...
    next_call_id = 290 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":284, "input_value":input_value, "op_type":"multiply", 
