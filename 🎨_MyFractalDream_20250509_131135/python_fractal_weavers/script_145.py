...
# Script ID 145: Op 'sine_transform', Modifiers: angle=1.8, amp=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 145, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":145, "input_value":input_value, "op_type":"sine_transform", 
