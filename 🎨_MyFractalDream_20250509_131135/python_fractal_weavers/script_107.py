...
# Script ID 107: Op 'logistic_map', Modifiers: r=3.585, limit=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 107, **({"modifier_r": modifier_r, "modifier_limit": modifier_limit}))
    ...
    print(json.dumps({
        "script_id":107, "input_value":input_value, "op_type":"logistic_map", 
