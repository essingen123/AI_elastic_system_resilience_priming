...
# Script ID 243: Op 'cosine_transform', Modifiers: angle=0.8, amp=1
...
if __name__ == "__main__":
    ...
    next_call_id = 253 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":243, "input_value":input_value, "op_type":"cosine_transform", 
