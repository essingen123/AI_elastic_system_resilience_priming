...
# Script ID 109: Op 'spiral_step_x', Modifiers: angle_rate=0.49, step_size=2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 109, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":109, "input_value":input_value, "op_type":"spiral_step_x", 
