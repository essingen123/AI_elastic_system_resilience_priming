...
# Script ID 150: Op 'henon_map_x', Modifiers: a=1.05
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 150, **({"modifier_a": modifier_a}))
    ...
    print(json.dumps({
        "script_id":150, "input_value":input_value, "op_type":"henon_map_x", 
