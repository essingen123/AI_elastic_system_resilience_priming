...
# Script ID 302: Op 'spiral_step_y', Modifiers: angle_rate=0.27, step_size=5
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 302})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 302, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":302, "input_value":input_value, "op_type":"spiral_step_y", 
