...
# Script ID 294: Op 'multiply', Modifiers: modifier=0.75
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 294, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":294, "input_value":input_value, "op_type":"multiply", 
