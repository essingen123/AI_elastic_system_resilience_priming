...
# Script ID 205: Op 'multiply', Modifiers: modifier=1.75
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 205, **({"modifier": modifier}))
    ...
    next_call_id = 184 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":205, "input_value":input_value, "op_type":"multiply", 
