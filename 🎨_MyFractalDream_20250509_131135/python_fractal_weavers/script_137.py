...
# Script ID 137: Op 'add', Modifiers: modifier=-7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 137, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":137, "input_value":input_value, "op_type":"add", 
