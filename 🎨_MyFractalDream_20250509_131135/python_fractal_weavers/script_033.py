...
# Script ID 33: Op 'spiral_step_y', Modifiers: angle_rate=0.08, step_size=2
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 33})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 33, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id = 3 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":33, "input_value":input_value, "op_type":"spiral_step_y", 
