...
# Script ID 256: Op 'cosine_transform', Modifiers: angle=1.7, amp=6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 256, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id = 243 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":256, "input_value":input_value, "op_type":"cosine_transform", 
