...
# Script ID 269: Op 'sine_transform', Modifiers: angle=1.1, amp=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 269, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id = 283 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":269, "input_value":input_value, "op_type":"sine_transform", 
