...
# Script ID 131: Op 'sine_transform', Modifiers: angle=1.2, amp=3
...
if __name__ == "__main__":
    ...
    next_call_id = 116 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":"sine_transform", 
