...
# Script ID 52: Op 'cosine_transform', Modifiers: angle=1.7, amp=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 52, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":52, "input_value":input_value, "op_type":"cosine_transform", 
