...
# Script ID 259: Op 'divide', Modifiers: modifier=0.85
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 259, **({"modifier": modifier}))
    ...
    next_call_id = 237 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":259, "input_value":input_value, "op_type":"divide", 
