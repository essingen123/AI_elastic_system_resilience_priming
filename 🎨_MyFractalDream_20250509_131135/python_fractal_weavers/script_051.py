...
# Script ID 51: Op 'multiply', Modifiers: modifier=0.65
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 51, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":51, "input_value":input_value, "op_type":"multiply", 
