...
# Script ID 86: Op 'spiral_step_x', Modifiers: angle_rate=0.13, step_size=4
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 86})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 86, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id = 76 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":86, "input_value":input_value, "op_type":"spiral_step_x", 
