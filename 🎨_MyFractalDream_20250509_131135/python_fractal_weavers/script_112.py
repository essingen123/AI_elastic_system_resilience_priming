...
# Script ID 112: Op 'add', Modifiers: modifier=6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 112, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":112, "input_value":input_value, "op_type":"add", 
