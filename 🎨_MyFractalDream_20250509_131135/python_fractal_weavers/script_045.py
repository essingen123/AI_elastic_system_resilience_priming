...
# Script ID 45: Op 'spiral_step_x', Modifiers: angle_rate=0.46, step_size=0
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 45})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 45, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":45, "input_value":input_value, "op_type":"spiral_step_x", 
