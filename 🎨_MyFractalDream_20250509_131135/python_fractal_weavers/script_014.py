...
# Script ID 14: Op 'power_clip', Modifiers: modifier=1.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 14, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":14, "input_value":input_value, "op_type":"power_clip", 
