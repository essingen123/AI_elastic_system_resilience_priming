...
# Script ID 237: Op 'divide', Modifiers: modifier=0.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 237, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":237, "input_value":input_value, "op_type":"divide", 
