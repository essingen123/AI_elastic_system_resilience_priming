...
# Script ID 111: Op 'power_clip', Modifiers: modifier=0.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 111, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":111, "input_value":input_value, "op_type":"power_clip", 
