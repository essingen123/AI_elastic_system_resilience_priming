...
# Script ID 170: Op 'multiply', Modifiers: modifier=1.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 170, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":170, "input_value":input_value, "op_type":"multiply", 
