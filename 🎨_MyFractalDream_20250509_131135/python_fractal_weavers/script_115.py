...
# Script ID 115: Op 'power_clip', Modifiers: modifier=1.65
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 115, **({"modifier": modifier}))
    ...
    next_call_id = 136 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":115, "input_value":input_value, "op_type":"power_clip", 
