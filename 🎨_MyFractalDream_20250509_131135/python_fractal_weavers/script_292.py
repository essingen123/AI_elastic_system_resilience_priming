...
# Script ID 292: Op 'power_clip', Modifiers: modifier=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 292, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":292, "input_value":input_value, "op_type":"power_clip", 
