...
# Script ID 278: Op 'add', Modifiers: modifier=-1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 278, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":278, "input_value":input_value, "op_type":"add", 
