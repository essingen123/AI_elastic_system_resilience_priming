...
# Script ID 159: Op 'henon_map_x', Modifiers: a=1.37
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 159, **({"modifier_a": modifier_a}))
    ...
    next_call_id = 129 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":159, "input_value":input_value, "op_type":"henon_map_x", 
