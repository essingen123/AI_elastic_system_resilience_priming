...
# Script ID 296: Op 'modulo_chaos', Modifiers: factor=1.3, add=1, mod=12
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 296, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":296, "input_value":input_value, "op_type":"modulo_chaos", 
