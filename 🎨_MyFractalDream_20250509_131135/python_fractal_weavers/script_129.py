...
# Script ID 129: Op 'modulo_chaos', Modifiers: factor=2.4, add=4, mod=18
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 129})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 129, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":129, "input_value":input_value, "op_type":"modulo_chaos", 
