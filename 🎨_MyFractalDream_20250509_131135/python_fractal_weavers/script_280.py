...
# Script ID 280: Op 'power_clip', Modifiers: modifier=1.05
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 280, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":280, "input_value":input_value, "op_type":"power_clip", 
