...
# Script ID 101: Op 'subtract', Modifiers: modifier=-2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 101, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":"subtract", 
