...
# Script ID 287: Op 'multiply', Modifiers: modifier=1.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 287, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":287, "input_value":input_value, "op_type":"multiply", 
