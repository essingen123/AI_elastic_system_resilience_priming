...
# Script ID 168: Op 'power_clip', Modifiers: modifier=1.05
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 168, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":168, "input_value":input_value, "op_type":"power_clip", 
