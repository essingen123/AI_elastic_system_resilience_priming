...
# Script ID 53: Op 'multiply', Modifiers: modifier=2.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 53, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":53, "input_value":input_value, "op_type":"multiply", 
