...
# Script ID 0: Op 'divide', Modifiers: modifier=1.15
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 0, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":0, "input_value":input_value, "op_type":"divide", 
