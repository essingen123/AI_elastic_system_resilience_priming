...
# Script ID 64: Op 'modulo_chaos', Modifiers: factor=1.2, add=4, mod=17
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 64, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":64, "input_value":input_value, "op_type":"modulo_chaos", 
