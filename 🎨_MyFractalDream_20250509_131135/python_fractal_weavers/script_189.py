...
# Script ID 189: Op 'divide', Modifiers: modifier=0.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 189, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":189, "input_value":input_value, "op_type":"divide", 
