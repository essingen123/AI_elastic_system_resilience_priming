...
# Script ID 148: Op 'divide', Modifiers: modifier=1.85
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 148, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":148, "input_value":input_value, "op_type":"divide", 
