...
# Script ID 281: Op 'power_clip', Modifiers: modifier=0.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 281, **({"modifier": modifier}))
    ...
    next_call_id = 277 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":281, "input_value":input_value, "op_type":"power_clip", 
