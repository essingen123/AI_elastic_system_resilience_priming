...
# Script ID 126: Op 'multiply', Modifiers: modifier=0.35
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":126, "input_value":input_value, "op_type":"multiply", 
