...
# Script ID 244: Op 'sine_transform', Modifiers: angle=1.6, amp=2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 244, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":244, "input_value":input_value, "op_type":"sine_transform", 
