...
# Script ID 190: Op 'sine_transform', Modifiers: angle=1.8, amp=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 190, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id = 172 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":190, "input_value":input_value, "op_type":"sine_transform", 
