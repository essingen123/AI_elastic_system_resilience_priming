...
# Script ID 70: Op 'add', Modifiers: modifier=-5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 70, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":70, "input_value":input_value, "op_type":"add", 
