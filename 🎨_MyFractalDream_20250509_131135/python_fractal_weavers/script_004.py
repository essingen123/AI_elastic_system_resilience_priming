...
# Script ID 4: Op 'multiply', Modifiers: modifier=2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 4, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":4, "input_value":input_value, "op_type":"multiply", 
