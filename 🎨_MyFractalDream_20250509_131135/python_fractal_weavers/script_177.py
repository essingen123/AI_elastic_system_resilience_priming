...
# Script ID 177: Op 'power_clip', Modifiers: modifier=0.55
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 177, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":177, "input_value":input_value, "op_type":"power_clip", 
