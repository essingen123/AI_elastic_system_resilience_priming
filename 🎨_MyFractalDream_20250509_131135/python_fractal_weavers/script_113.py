...
# Script ID 113: Op 'power_clip', Modifiers: modifier=0.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 113, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":113, "input_value":input_value, "op_type":"power_clip", 
