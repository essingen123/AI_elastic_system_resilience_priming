...
# Script ID 255: Op 'power_clip', Modifiers: modifier=0.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 255, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":255, "input_value":input_value, "op_type":"power_clip", 
