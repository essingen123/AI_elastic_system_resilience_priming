...
# Script ID 142: Op 'divide', Modifiers: modifier=2.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 142, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":142, "input_value":input_value, "op_type":"divide", 
