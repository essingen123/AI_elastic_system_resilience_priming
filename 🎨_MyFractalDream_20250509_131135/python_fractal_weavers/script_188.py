...
# Script ID 188: Op 'sine_transform', Modifiers: angle=1.2, amp=7
...
if __name__ == "__main__":
    ...
    next_call_id = 177 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":188, "input_value":input_value, "op_type":"sine_transform", 
