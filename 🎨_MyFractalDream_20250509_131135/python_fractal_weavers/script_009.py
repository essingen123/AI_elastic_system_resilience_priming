...
# Script ID 9: Op 'multiply', Modifiers: modifier=1.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 9, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":9, "input_value":input_value, "op_type":"multiply", 
