...
# Script ID 171: Op 'modulo_chaos', Modifiers: factor=2, add=-1, mod=16
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 171, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":171, "input_value":input_value, "op_type":"modulo_chaos", 
