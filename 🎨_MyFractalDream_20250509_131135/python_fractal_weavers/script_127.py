...
# Script ID 127: Op 'subtract', Modifiers: modifier=-2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 127, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":127, "input_value":input_value, "op_type":"subtract", 
