...
# Script ID 71: Op 'sine_transform', Modifiers: angle=1.4, amp=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 71, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":71, "input_value":input_value, "op_type":"sine_transform", 
