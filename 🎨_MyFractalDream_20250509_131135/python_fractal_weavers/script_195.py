...
# Script ID 195: Op 'sine_transform', Modifiers: angle=0.1, amp=3
...
if __name__ == "__main__":
    ...
    next_call_id = 189 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":195, "input_value":input_value, "op_type":"sine_transform", 
