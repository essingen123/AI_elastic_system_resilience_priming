...
# Script ID 153: Op 'divide', Modifiers: modifier=1.55
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 153, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":153, "input_value":input_value, "op_type":"divide", 
