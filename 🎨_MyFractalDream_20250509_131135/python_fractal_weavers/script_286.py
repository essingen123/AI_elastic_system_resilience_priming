...
# Script ID 286: Op 'multiply', Modifiers: modifier=2.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 286, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":286, "input_value":input_value, "op_type":"multiply", 
