...
# Script ID 155: Op 'divide', Modifiers: modifier=0.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 155, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":155, "input_value":input_value, "op_type":"divide", 
