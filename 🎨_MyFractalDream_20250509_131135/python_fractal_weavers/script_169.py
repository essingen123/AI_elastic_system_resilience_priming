...
# Script ID 169: Op 'power_clip', Modifiers: modifier=1.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 169, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":169, "input_value":input_value, "op_type":"power_clip", 
