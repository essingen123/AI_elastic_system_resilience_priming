...
# Script ID 138: Op 'cosine_transform', Modifiers: angle=0.1, amp=10
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 138, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":138, "input_value":input_value, "op_type":"cosine_transform", 
