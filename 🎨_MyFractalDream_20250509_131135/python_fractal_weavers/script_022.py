...
# Script ID 22: Op 'sine_transform', Modifiers: angle=1.9, amp=4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 22, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":22, "input_value":input_value, "op_type":"sine_transform", 
