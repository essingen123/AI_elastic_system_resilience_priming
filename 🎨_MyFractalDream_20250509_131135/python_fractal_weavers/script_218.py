...
# Script ID 218: Op 'divide', Modifiers: modifier=0.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 218, **({"modifier": modifier}))
    ...
    next_call_id = 192 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":218, "input_value":input_value, "op_type":"divide", 
