...
# Script ID 184: Op 'sine_transform', Modifiers: angle=1.1, amp=10
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 184, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":184, "input_value":input_value, "op_type":"sine_transform", 
