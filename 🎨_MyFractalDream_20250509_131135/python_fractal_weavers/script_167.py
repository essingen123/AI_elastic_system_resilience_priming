...
# Script ID 167: Op 'divide', Modifiers: modifier=0.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 167, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":167, "input_value":input_value, "op_type":"divide", 
