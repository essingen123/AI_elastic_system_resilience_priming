...
# Script ID 88: Op 'spiral_step_x', Modifiers: angle_rate=0.15, step_size=3
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 88})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 88, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":88, "input_value":input_value, "op_type":"spiral_step_x", 
