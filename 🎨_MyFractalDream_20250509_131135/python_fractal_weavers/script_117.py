...
# Script ID 117: Op 'multiply', Modifiers: modifier=0.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 117, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":117, "input_value":input_value, "op_type":"multiply", 
