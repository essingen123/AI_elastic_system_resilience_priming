...
# Script ID 250: Op 'power_clip', Modifiers: modifier=1.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 250, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":250, "input_value":input_value, "op_type":"power_clip", 
