...
# Script ID 103: Op 'spiral_step_y', Modifiers: angle_rate=0.5, step_size=4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 103, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":103, "input_value":input_value, "op_type":"spiral_step_y", 
