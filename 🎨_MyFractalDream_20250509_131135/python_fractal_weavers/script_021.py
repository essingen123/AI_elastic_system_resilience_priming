...
# Script ID 21: Op 'cosine_transform', Modifiers: angle=0.1, amp=6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 21, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":21, "input_value":input_value, "op_type":"cosine_transform", 
