...
# Script ID 160: Op 'divide', Modifiers: modifier=2.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 160, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":160, "input_value":input_value, "op_type":"divide", 
