...
# Script ID 265: Op 'power_clip', Modifiers: modifier=1.65
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 265, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":265, "input_value":input_value, "op_type":"power_clip", 
