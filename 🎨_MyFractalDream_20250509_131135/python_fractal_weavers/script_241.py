...
# Script ID 241: Op 'spiral_step_x', Modifiers: angle_rate=0.32, step_size=3
...
if __name__ == "__main__":
    ...
    next_call_id = 261 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":241, "input_value":input_value, "op_type":"spiral_step_x", 
