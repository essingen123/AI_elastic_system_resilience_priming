...
# Script ID 63: Op 'add', Modifiers: modifier=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 63, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":63, "input_value":input_value, "op_type":"add", 
