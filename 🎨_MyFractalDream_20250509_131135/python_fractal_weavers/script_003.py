...
# Script ID 3: Op 'subtract', Modifiers: modifier=-7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 3, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":3, "input_value":input_value, "op_type":"subtract", 
