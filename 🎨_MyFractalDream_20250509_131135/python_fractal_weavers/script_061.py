...
# Script ID 61: Op 'sine_transform', Modifiers: angle=0.3, amp=10
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 61, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":61, "input_value":input_value, "op_type":"sine_transform", 
