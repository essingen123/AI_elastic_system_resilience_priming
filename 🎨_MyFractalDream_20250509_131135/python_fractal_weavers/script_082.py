...
# Script ID 82: Op 'multiply', Modifiers: modifier=2.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 82, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":82, "input_value":input_value, "op_type":"multiply", 
