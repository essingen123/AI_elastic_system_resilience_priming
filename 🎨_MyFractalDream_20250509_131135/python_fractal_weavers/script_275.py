...
# Script ID 275: Op 'add', Modifiers: modifier=2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 275, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":275, "input_value":input_value, "op_type":"add", 
