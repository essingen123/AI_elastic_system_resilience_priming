...
# Script ID 94: Op 'add', Modifiers: modifier=3
...
if __name__ == "__main__":
    ...
    next_call_id = 109 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":94, "input_value":input_value, "op_type":"add", 
