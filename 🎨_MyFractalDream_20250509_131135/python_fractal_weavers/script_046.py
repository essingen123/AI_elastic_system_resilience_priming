...
# Script ID 46: Op 'henon_map_x', Modifiers: a=1.36
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 46, **({"modifier_a": modifier_a}))
    ...
    next_call_id = 34 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":46, "input_value":input_value, "op_type":"henon_map_x", 
