...
# Script ID 43: Op 'divide', Modifiers: modifier=1.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 43, **({"modifier": modifier}))
    ...
    next_call_id = 36 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":43, "input_value":input_value, "op_type":"divide", 
