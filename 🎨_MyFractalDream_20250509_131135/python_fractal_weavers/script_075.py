...
# Script ID 75: Op 'cosine_transform', Modifiers: angle=1.7, amp=3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 75, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id = 85 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":75, "input_value":input_value, "op_type":"cosine_transform", 
