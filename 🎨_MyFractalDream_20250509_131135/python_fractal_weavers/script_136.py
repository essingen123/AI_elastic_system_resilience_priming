...
# Script ID 136: Op 'sine_transform', Modifiers: angle=0.1, amp=7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 136, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":"sine_transform", 
