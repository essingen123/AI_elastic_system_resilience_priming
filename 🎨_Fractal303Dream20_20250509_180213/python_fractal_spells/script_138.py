...
# Script ID 138: Op 'de_jong_attractor_x', Modifiers: a=-2.7, b=-0.1
...
if __name__ == "__main__":
    ...
    modifier_a = float(-2.7)
    modifier_b = float(-0.1)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 138, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":138, "input_value":input_value, "op_type":"de_jong_attractor_x", 
