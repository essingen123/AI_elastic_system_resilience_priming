...
# Script ID 207: Op 'sine_power_mix', Modifiers: freq1=2.25, pow1=3, amp1=1.8, freq2=2.98, pow2=2, amp2=0.9
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.25)
    modifier_pow1 = float(3)
    modifier_amp1 = float(1.8)
    modifier_freq2 = float(2.98)
    ...
    output_value = perform_operation(input_value, current_depth, 207, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":207, "input_value":input_value, "op_type":"sine_power_mix", 
