...
# Script ID 263: Op 'clifford_attractor_x', Modifiers: a=0.51, c=-0.43
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 263, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":263, "input_value":input_value, "op_type":"clifford_attractor_x", 
