...
# Script ID 81: Op 'sine_power_mix', Modifiers: freq1=0.48, pow1=3, amp1=4.1, freq2=1.66, pow2=2, amp2=1.4
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.48)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.1)
    modifier_freq2 = float(1.66)
    ...
    output_value = perform_operation(input_value, current_depth, 81, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":81, "input_value":input_value, "op_type":"sine_power_mix", 
