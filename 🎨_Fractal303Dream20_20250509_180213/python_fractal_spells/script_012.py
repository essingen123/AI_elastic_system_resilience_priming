...
# Script ID 12: Op 'clifford_attractor_x', Modifiers: a=-0.33, c=-0.39
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 12, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":12, "input_value":input_value, "op_type":"clifford_attractor_x", 
