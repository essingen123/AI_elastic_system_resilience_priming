...
# Script ID 110: Op 'sine_power_mix', Modifiers: freq1=0.59, pow1=1, amp1=1.9, freq2=2.49, pow2=2, amp2=4.3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.59)
    modifier_pow1 = float(1)
    modifier_amp1 = float(1.9)
    modifier_freq2 = float(2.49)
    ...
    output_value = perform_operation(input_value, current_depth, 110, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":110, "input_value":input_value, "op_type":"sine_power_mix", 
