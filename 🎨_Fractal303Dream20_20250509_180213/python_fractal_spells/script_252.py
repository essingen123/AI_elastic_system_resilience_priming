...
# Script ID 252: Op 'lyapunov_exponent_approx', Modifiers: r=3.799
...
if __name__ == "__main__":
    ...
    modifier_r = float(3.799)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 252, prev_val_placeholder_py, **({"modifier_r": modifier_r}))
    ...
    print(json.dumps({
        "script_id":252, "input_value":input_value, "op_type":"lyapunov_exponent_approx", 
