...
# Script ID 165: Op 'de_jong_attractor_x', Modifiers: a=-1.83, b=0.92
...
if __name__ == "__main__":
    ...
    modifier_b = float(0.92)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 165, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":165, "input_value":input_value, "op_type":"de_jong_attractor_x", 
