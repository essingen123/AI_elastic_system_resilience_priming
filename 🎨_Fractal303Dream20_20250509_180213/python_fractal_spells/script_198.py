...
# Script ID 198: Op 'sine_power_mix', Modifiers: freq1=1.25, pow1=2, amp1=3.4, freq2=0.14, pow2=3, amp2=2.4
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.25)
    modifier_pow1 = float(2)
    modifier_amp1 = float(3.4)
    modifier_freq2 = float(0.14)
    modifier_pow2 = float(3)
    modifier_amp2 = float(2.4)
