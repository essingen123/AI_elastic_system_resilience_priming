...
# Script ID 144: Op 'logistic_growth', Modifiers: r=3.589, k=77
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 144, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":144, "input_value":input_value, "op_type":"logistic_growth", 
