...
# Script ID 85: Op 'sine_power_mix', Modifiers: freq1=2.37, pow1=1, amp1=3.6, freq2=2.61, pow2=2, amp2=4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 85, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":85, "input_value":input_value, "op_type":"sine_power_mix", 
