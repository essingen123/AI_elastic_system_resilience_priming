...
# Script ID 272: Op 'de_jong_attractor_x', Modifiers: a=-0.39, b=1.68
...
if __name__ == "__main__":
    ...
    modifier_b = float(1.68)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 272, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":272, "input_value":input_value, "op_type":"de_jong_attractor_x", 
