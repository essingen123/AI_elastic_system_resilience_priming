...
# Script ID 191: Op 'sine_power_mix', Modifiers: freq1=1.55, pow1=2, amp1=1.1, freq2=2.22, pow2=2, amp2=2.9
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.55)
    modifier_pow1 = float(2)
    modifier_amp1 = float(1.1)
    modifier_freq2 = float(2.22)
    ...
    output_value = perform_operation(input_value, current_depth, 191, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":191, "input_value":input_value, "op_type":"sine_power_mix", 
