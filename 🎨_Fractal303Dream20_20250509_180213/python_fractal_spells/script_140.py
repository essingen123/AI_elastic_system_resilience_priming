...
# Script ID 140: Op 'sine_power_mix', Modifiers: freq1=2.35, pow1=2, amp1=4.9, freq2=0.2, pow2=2, amp2=1.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.35)
    modifier_pow1 = float(2)
    modifier_amp1 = float(4.9)
    modifier_freq2 = float(0.2)
    ...
    output_value = perform_operation(input_value, current_depth, 140, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":140, "input_value":input_value, "op_type":"sine_power_mix", 
