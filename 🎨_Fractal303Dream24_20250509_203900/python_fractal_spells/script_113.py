...
# Script ID 113: Op 'de_jong_attractor_y', Modifiers: c=2.44, d=-1.55
...
if __name__ == "__main__":
    ...
    c = float(2.44) # PHP generated
    d = float(-1.55) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 113, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":113, "input_value":input_value, "op_type":op_name, # Use Python op_name
