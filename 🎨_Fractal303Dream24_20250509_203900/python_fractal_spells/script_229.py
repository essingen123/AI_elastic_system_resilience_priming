...
# Script ID 229: Op 'de_jong_attractor_y', Modifiers: c=-0.52, d=0.46
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 229, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":229, "input_value":input_value, "op_type":op_name, # Use Python op_name
