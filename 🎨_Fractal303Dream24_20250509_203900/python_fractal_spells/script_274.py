...
# Script ID 274: Op 'clifford_attractor_y', Modifiers: b=1.53, d=-0.14
...
if __name__ == "__main__":
    ...
    b = float(1.53) # PHP generated
    d = float(-0.14) # PHP generated
    ...
    print(json.dumps({
        "script_id":274, "input_value":input_value, "op_type":op_name, # Use Python op_name
