...
# Script ID 108: Op 'clifford_attractor_x', Modifiers: a=0.22, c=-0.67
...
if __name__ == "__main__":
    ...
    a = float(0.22) # PHP generated
    c = float(-0.67) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 108, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":108, "input_value":input_value, "op_type":op_name, # Use Python op_name
