...
# Script ID 160: Op 'coupled_logistic_x', Modifiers: rx=3.728, cxy=0.01
...
if __name__ == "__main__":
    ...
    rx = float(3.728) # PHP generated
    cxy = float(0.01) # PHP generated
    ...
    print(json.dumps({
        "script_id":160, "input_value":input_value, "op_type":op_name, # Use Python op_name
