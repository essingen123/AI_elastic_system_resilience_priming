...
# Script ID 59: Op 'coupled_logistic_x', Modifiers: rx=3.768, cxy=0.176
...
if __name__ == "__main__":
    ...
    rx = float(3.768) # PHP generated
    cxy = float(0.176) # PHP generated
    ...
    print(json.dumps({
        "script_id":59, "input_value":input_value, "op_type":op_name, # Use Python op_name
