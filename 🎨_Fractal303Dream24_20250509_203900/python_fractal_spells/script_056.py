...
# Script ID 56: Op 'clifford_attractor_y', Modifiers: b=-1.73, d=0.45
...
if __name__ == "__main__":
    ...
    b = float(-1.73) # PHP generated
    d = float(0.45) # PHP generated
    ...
    print(json.dumps({
        "script_id":56, "input_value":input_value, "op_type":op_name, # Use Python op_name
