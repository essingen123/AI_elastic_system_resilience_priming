...
# Script ID 300: Op 'de_jong_attractor_y', Modifiers: c=0.94, d=1.77
op_name = "de_jong_attractor_y" # Make op_name global in this Python script's context
...
if __name__ == "__main__":
    ...
    c = float(0.94) # PHP generated
    d = float(1.77) # PHP generated
    ...
    python_modifiers_dict = {"c": c, "d": d}
    
    output_value = perform_operation(input_value, current_depth, 300, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":300, "input_value":input_value, "op_type":op_name, # Use Python op_name
