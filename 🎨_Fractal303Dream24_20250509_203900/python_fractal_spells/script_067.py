...
# Script ID 67: Op 'clifford_attractor_x', Modifiers: a=0.61, c=0.75
...
if __name__ == "__main__":
    ...
    a = float(0.61) # PHP generated
    c = float(0.75) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 67, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":67, "input_value":input_value, "op_type":op_name, # Use Python op_name
