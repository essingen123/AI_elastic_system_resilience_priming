...
# Script ID 147: Op 'sine_power_mix', Modifiers: freq1=0.22, pow1=3, amp1=2.5, freq2=2.84, pow2=3, amp2=3.5
...
if __name__ == "__main__":
    ...
    freq1 = float(0.22) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.5) # PHP generated
    freq2 = float(2.84) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(3.5) # PHP generated
