...
# Script ID 235: Op 'clifford_attractor_x', Modifiers: a=-1.29, c=-1.64
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":235, "input_value":input_value, "op_type":op_name, # Use Python op_name
