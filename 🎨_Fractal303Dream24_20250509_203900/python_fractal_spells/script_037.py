...
# Script ID 37: Op 'de_jong_attractor_x', Modifiers: a=-2.3, b=0.84
...
if __name__ == "__main__":
    ...
    a = float(-2.3) # PHP generated
    b = float(0.84) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 37, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":37, "input_value":input_value, "op_type":op_name, # Use Python op_name
