...
# Script ID 95: Op 'clifford_attractor_y', Modifiers: b=0.14, d=1.71
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":95, "input_value":input_value, "op_type":op_name, # Use Python op_name
