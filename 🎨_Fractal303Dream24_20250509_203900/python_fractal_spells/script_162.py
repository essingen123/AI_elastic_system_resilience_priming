...
# Script ID 162: Op 'de_jong_attractor_y', Modifiers: c=1.77, d=2.86
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 162, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":162, "input_value":input_value, "op_type":op_name, # Use Python op_name
