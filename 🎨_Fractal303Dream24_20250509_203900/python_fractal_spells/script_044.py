...
# Script ID 44: Op 'clifford_attractor_x', Modifiers: a=-1.22, c=0.39
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 44, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":44, "input_value":input_value, "op_type":op_name, # Use Python op_name
