...
# Script ID 69: Op 'clifford_attractor_x', Modifiers: a=-1.03, c=-0.74
...
if __name__ == "__main__":
    ...
    a = float(-1.03) # PHP generated
    c = float(-0.74) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 69, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":69, "input_value":input_value, "op_type":op_name, # Use Python op_name
