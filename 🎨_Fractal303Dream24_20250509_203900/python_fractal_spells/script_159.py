...
# Script ID 159: Op 'de_jong_attractor_y', Modifiers: c=0.22, d=2.19
...
if __name__ == "__main__":
    ...
    c = float(0.22) # PHP generated
    d = float(2.19) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 159, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":159, "input_value":input_value, "op_type":op_name, # Use Python op_name
