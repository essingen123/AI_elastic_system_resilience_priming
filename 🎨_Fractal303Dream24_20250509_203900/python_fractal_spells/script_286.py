...
# Script ID 286: Op 'de_jong_attractor_y', Modifiers: c=0.97, d=-0.71
...
if __name__ == "__main__":
    ...
    c = float(0.97) # PHP generated
    d = float(-0.71) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 286, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":286, "input_value":input_value, "op_type":op_name, # Use Python op_name
