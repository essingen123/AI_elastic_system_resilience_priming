...
# Script ID 272: Op 'clifford_attractor_x', Modifiers: a=-1.14, c=0.41
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 272})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 272, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":272, "input_value":input_value, "op_type":op_name, # Use Python op_name
