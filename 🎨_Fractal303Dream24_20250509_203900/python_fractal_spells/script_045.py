...
# Script ID 45: Op 'clifford_attractor_x', Modifiers: a=0.87, c=-0.52
...
if __name__ == "__main__":
    ...
    a = float(0.87) # PHP generated
    c = float(-0.52) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 45, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":45, "input_value":input_value, "op_type":op_name, # Use Python op_name
