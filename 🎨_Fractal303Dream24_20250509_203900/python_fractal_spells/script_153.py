...
# Script ID 153: Op 'sine_power_mix', Modifiers: freq1=2.72, pow1=1, amp1=4.1, freq2=0.86, pow2=3, amp2=2
...
if __name__ == "__main__":
    ...
    freq1 = float(2.72) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(4.1) # PHP generated
    freq2 = float(0.86) # PHP generated
    ...
    print(json.dumps({
        "script_id":153, "input_value":input_value, "op_type":op_name, # Use Python op_name
