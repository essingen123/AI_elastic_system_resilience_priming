...
# Script ID 212: Op 'clifford_attractor_y', Modifiers: b=-0.45, d=-1.61
...
if __name__ == "__main__":
    ...
    b = float(-0.45) # PHP generated
    d = float(-1.61) # PHP generated
    ...
    print(json.dumps({
        "script_id":212, "input_value":input_value, "op_type":op_name, # Use Python op_name
