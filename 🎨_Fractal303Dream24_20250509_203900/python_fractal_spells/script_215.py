...
# Script ID 215: Op 'sine_power_mix', Modifiers: freq1=2.41, pow1=2, amp1=3.9, freq2=0.55, pow2=3, amp2=2.4
...
if __name__ == "__main__":
    ...
    amp1 = float(3.9) # PHP generated
    freq2 = float(0.55) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(2.4) # PHP generated
