...
# Script ID 11: Op 'de_jong_attractor_x', Modifiers: a=2.62, b=-1.52
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 11, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":11, "input_value":input_value, "op_type":op_name, # Use Python op_name
