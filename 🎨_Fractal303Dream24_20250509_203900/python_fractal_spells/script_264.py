...
# Script ID 264: Op 'swirl_step', Modifiers: strength=1.7
op_name = "swirl_step" # Make op_name global in this Python script's context
...
if __name__ == "__main__":
    ...
    strength = float(1.7) # PHP generated
