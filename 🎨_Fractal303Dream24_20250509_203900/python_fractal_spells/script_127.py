...
# Script ID 127: Op 'clifford_attractor_x', Modifiers: a=-0.81, c=-1.42
...
if __name__ == "__main__":
    ...
    a = float(-0.81) # PHP generated
    c = float(-1.42) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 127, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":127, "input_value":input_value, "op_type":op_name, # Use Python op_name
