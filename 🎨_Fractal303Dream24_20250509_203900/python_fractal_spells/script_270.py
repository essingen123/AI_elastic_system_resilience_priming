...
# Script ID 270: Op 'coupled_logistic_x', Modifiers: rx=3.516, cxy=0.079
...
if __name__ == "__main__":
    ...
    rx = float(3.516) # PHP generated
    cxy = float(0.079) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 270, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":270, "input_value":input_value, "op_type":op_name, # Use Python op_name
