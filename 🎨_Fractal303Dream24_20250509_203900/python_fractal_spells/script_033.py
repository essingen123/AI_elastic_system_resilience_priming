...
# Script ID 33: Op 'lyapunov_exponent_approx', Modifiers: r=3.728
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 33, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":33, "input_value":input_value, "op_type":op_name, # Use Python op_name
