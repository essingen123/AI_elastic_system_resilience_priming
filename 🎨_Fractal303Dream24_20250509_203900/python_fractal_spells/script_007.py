...
# Script ID 7: Op 'clifford_attractor_y', Modifiers: b=1.25, d=1.54
...
if __name__ == "__main__":
    ...
    b = float(1.25) # PHP generated
    d = float(1.54) # PHP generated
    ...
    print(json.dumps({
        "script_id":7, "input_value":input_value, "op_type":op_name, # Use Python op_name
