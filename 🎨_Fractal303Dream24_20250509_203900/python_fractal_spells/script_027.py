...
# Script ID 27: Op 'sine_power_mix', Modifiers: freq1=0.71, pow1=2, amp1=2.6, freq2=2.36, pow2=1, amp2=4.8
...
if __name__ == "__main__":
    ...
    freq1 = float(0.71) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.6) # PHP generated
    freq2 = float(2.36) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(4.8) # PHP generated
