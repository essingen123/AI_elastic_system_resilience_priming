...
# Script ID 284: Op 'logistic_growth', Modifiers: r=3.323, k=94
...
if __name__ == "__main__":
    ...
    r = float(3.323) # PHP generated
    k = float(94) # PHP generated
    ...
    print(json.dumps({
        "script_id":284, "input_value":input_value, "op_type":op_name, # Use Python op_name
