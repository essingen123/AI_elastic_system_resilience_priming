...
# Script ID 196: Op 'sine_power_mix', Modifiers: freq1=1.93, pow1=3, amp1=2.2, freq2=2.38, pow2=2, amp2=4.9
...
if __name__ == "__main__":
    ...
    freq1 = float(1.93) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.2) # PHP generated
    freq2 = float(2.38) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(4.9) # PHP generated
