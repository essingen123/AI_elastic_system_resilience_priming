...
# Script ID 137: Op 'sine_power_mix', Modifiers: freq1=1.04, pow1=3, amp1=4.3, freq2=2.01, pow2=3, amp2=1.3
...
if __name__ == "__main__":
    ...
    freq1 = float(1.04) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(4.3) # PHP generated
    freq2 = float(2.01) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(1.3) # PHP generated
