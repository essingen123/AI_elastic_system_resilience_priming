...
# Script ID 262: Op 'coupled_logistic_x', Modifiers: rx=3.63, cxy=0.013
...
if __name__ == "__main__":
    ...
    rx = float(3.63) # PHP generated
    cxy = float(0.013) # PHP generated
    ...
    print(json.dumps({
        "script_id":262, "input_value":input_value, "op_type":op_name, # Use Python op_name
