...
# Script ID 63: Op 'sine_power_mix', Modifiers: freq1=1.89, pow1=2, amp1=1.7, freq2=0.56, pow2=1, amp2=1.6
...
if __name__ == "__main__":
    ...
    freq2 = float(0.56) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(1.6) # PHP generated
    ...
    print(json.dumps({
        "script_id":63, "input_value":input_value, "op_type":op_name, # Use Python op_name
