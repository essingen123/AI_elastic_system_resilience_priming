...
# Script ID 280: Op 'de_jong_attractor_x', Modifiers: a=-2.9, b=-0.02
...
if __name__ == "__main__":
    ...
    a = float(-2.9) # PHP generated
    b = float(-0.02) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 280, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":280, "input_value":input_value, "op_type":op_name, # Use Python op_name
