...
# Script ID 70: Op 'de_jong_attractor_y', Modifiers: c=2, d=2.3
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":70, "input_value":input_value, "op_type":op_name, # Use Python op_name
