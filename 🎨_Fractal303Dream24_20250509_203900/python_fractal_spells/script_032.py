...
# Script ID 32: Op 'de_jong_attractor_x', Modifiers: a=-1.39, b=-2.88
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 32, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":32, "input_value":input_value, "op_type":op_name, # Use Python op_name
