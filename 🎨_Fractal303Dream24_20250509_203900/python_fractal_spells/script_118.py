...
# Script ID 118: Op 'coupled_logistic_x', Modifiers: rx=3.703, cxy=0.053
...
if __name__ == "__main__":
    ...
    rx = float(3.703) # PHP generated
    cxy = float(0.053) # PHP generated
    ...
    print(json.dumps({
        "script_id":118, "input_value":input_value, "op_type":op_name, # Use Python op_name
