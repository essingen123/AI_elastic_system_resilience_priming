...
# Script ID 245: Op 'sine_power_mix', Modifiers: freq1=0.88, pow1=2, amp1=4.8, freq2=2.28, pow2=3, amp2=4
...
if __name__ == "__main__":
    ...
    freq1 = float(0.88) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(4.8) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 245, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":245, "input_value":input_value, "op_type":op_name, # Use Python op_name
