...
# Script ID 148: Op 'clifford_attractor_x', Modifiers: a=-0.84, c=-0.76
...
if __name__ == "__main__":
    ...
    a = float(-0.84) # PHP generated
    c = float(-0.76) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 148, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":148, "input_value":input_value, "op_type":op_name, # Use Python op_name
