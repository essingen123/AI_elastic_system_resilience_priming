...
# Script ID 210: Op 'clifford_attractor_x', Modifiers: a=0.53, c=1.82
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 210, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":210, "input_value":input_value, "op_type":op_name, # Use Python op_name
