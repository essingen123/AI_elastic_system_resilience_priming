...
# Script ID 151: Op 'clifford_attractor_x', Modifiers: a=-1.69, c=-1.29
...
if __name__ == "__main__":
    ...
    a = float(-1.69) # PHP generated
    c = float(-1.29) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 151, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":151, "input_value":input_value, "op_type":op_name, # Use Python op_name
