...
# Script ID 150: Op 'clifford_attractor_x', Modifiers: a=1.25, c=0.83
...
if __name__ == "__main__":
    ...
    a = float(1.25) # PHP generated
    c = float(0.83) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 150, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":150, "input_value":input_value, "op_type":op_name, # Use Python op_name
