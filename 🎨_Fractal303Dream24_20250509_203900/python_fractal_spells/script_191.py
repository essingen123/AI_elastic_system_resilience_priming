...
# Script ID 191: Op 'sine_power_mix', Modifiers: freq1=0.52, pow1=1, amp1=1, freq2=2.28, pow2=2, amp2=4.6
...
if __name__ == "__main__":
    ...
    freq1 = float(0.52) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(1) # PHP generated
    freq2 = float(2.28) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(4.6) # PHP generated
