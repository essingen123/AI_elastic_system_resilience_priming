...
# Script ID 128: Op 'de_jong_attractor_y', Modifiers: c=1.79, d=-0.75
...
if __name__ == "__main__":
    ...
    c = float(1.79) # PHP generated
    d = float(-0.75) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 128, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":128, "input_value":input_value, "op_type":op_name, # Use Python op_name
