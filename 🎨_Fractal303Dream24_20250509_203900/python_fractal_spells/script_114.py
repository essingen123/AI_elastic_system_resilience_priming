...
# Script ID 114: Op 'de_jong_attractor_x', Modifiers: a=-1.91, b=2.17
...
if __name__ == "__main__":
    ...
    a = float(-1.91) # PHP generated
    b = float(2.17) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 114, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":114, "input_value":input_value, "op_type":op_name, # Use Python op_name
