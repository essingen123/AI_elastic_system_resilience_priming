...
# Script ID 285: Op 'sine_power_mix', Modifiers: freq1=1.45, pow1=1, amp1=4.5, freq2=0.37, pow2=1, amp2=4.7
...
if __name__ == "__main__":
    ...
    freq1 = float(1.45) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(4.5) # PHP generated
    freq2 = float(0.37) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(4.7) # PHP generated
    ...
    print(json.dumps({
        "script_id":285, "input_value":input_value, "op_type":op_name, # Use Python op_name
