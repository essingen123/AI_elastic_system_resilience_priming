...
# Script ID 237: Op 'sine_power_mix', Modifiers: freq1=2.51, pow1=3, amp1=2.7, freq2=1.57, pow2=2, amp2=1
...
if __name__ == "__main__":
    ...
    freq1 = float(2.51) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.7) # PHP generated
    freq2 = float(1.57) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(1) # PHP generated
