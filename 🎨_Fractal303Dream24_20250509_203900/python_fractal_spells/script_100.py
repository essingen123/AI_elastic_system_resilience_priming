...
# Script ID 100: Op 'clifford_attractor_x', Modifiers: a=-0.03, c=-1.91
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 100, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":100, "input_value":input_value, "op_type":op_name, # Use Python op_name
