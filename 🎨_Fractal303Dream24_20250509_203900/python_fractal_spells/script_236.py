...
# Script ID 236: Op 'de_jong_attractor_y', Modifiers: c=-1.12, d=1.56
...
if __name__ == "__main__":
    ...
    c = float(-1.12) # PHP generated
    d = float(1.56) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 236, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":236, "input_value":input_value, "op_type":op_name, # Use Python op_name
