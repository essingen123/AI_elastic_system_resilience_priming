...
# Script ID 110: Op 'logistic_growth', Modifiers: r=3.588, k=98
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":110, "input_value":input_value, "op_type":op_name, # Use Python op_name
