...
# Script ID 180: Op 'sine_power_mix', Modifiers: freq1=2.88, pow1=3, amp1=4.2, freq2=2.22, pow2=2, amp2=1.8
...
if __name__ == "__main__":
    ...
    freq1 = float(2.88) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(4.2) # PHP generated
    freq2 = float(2.22) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(1.8) # PHP generated
