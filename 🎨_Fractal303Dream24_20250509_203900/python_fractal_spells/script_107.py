...
# Script ID 107: Op 'sine_power_mix', Modifiers: freq1=2.99, pow1=3, amp1=2.2, freq2=0.81, pow2=2, amp2=0.7
...
if __name__ == "__main__":
    ...
    freq1 = float(2.99) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.2) # PHP generated
    freq2 = float(0.81) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(0.7) # PHP generated
