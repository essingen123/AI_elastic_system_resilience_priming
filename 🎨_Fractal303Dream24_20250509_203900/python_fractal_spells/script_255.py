...
# Script ID 255: Op 'clifford_attractor_x', Modifiers: a=-0.49, c=-2
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 255})); sys.exit(1)
    ...
    a = float(-0.49) # PHP generated
    c = float(-2) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 255, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":255, "input_value":input_value, "op_type":op_name, # Use Python op_name
