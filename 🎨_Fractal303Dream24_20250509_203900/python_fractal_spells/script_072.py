...
# Script ID 72: Op 'de_jong_attractor_x', Modifiers: a=1.17, b=1.28
...
if __name__ == "__main__":
    ...
    a = float(1.17) # PHP generated
    b = float(1.28) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 72, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":72, "input_value":input_value, "op_type":op_name, # Use Python op_name
