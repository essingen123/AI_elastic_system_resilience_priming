...
# Script ID 290: Op 'clifford_attractor_y', Modifiers: b=0.37, d=0.39
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 290, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":290, "input_value":input_value, "op_type":op_name, # Use Python op_name
