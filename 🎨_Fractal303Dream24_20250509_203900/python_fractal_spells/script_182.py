...
# Script ID 182: Op 'sine_power_mix', Modifiers: freq1=2.91, pow1=3, amp1=2.1, freq2=1.48, pow2=3, amp2=1.8
...
if __name__ == "__main__":
    ...
    freq1 = float(2.91) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.1) # PHP generated
    freq2 = float(1.48) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 182, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":182, "input_value":input_value, "op_type":op_name, # Use Python op_name
