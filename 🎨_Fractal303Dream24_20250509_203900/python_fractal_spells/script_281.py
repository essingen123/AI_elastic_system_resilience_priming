...
# Script ID 281: Op 'de_jong_attractor_x', Modifiers: a=2.78, b=-1.52
...
if __name__ == "__main__":
    ...
    a = float(2.78) # PHP generated
    b = float(-1.52) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 281, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":281, "input_value":input_value, "op_type":op_name, # Use Python op_name
