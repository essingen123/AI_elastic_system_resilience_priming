...
# Script ID 62: Op 'de_jong_attractor_y', Modifiers: c=0.11, d=-0.59
...
if __name__ == "__main__":
    ...
    c = float(0.11) # PHP generated
    d = float(-0.59) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 62, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":62, "input_value":input_value, "op_type":op_name, # Use Python op_name
