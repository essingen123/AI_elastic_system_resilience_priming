...
# Script ID 8: Op 'clifford_attractor_x', Modifiers: a=-1.75, c=1.23
...
if __name__ == "__main__":
    ...
    a = float(-1.75) # PHP generated
    c = float(1.23) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 8, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":8, "input_value":input_value, "op_type":op_name, # Use Python op_name
