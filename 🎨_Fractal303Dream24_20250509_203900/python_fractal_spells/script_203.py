...
# Script ID 203: Op 'de_jong_attractor_x', Modifiers: a=-0.28, b=0.14
...
if __name__ == "__main__":
    ...
    a = float(-0.28) # PHP generated
    b = float(0.14) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 203, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":203, "input_value":input_value, "op_type":op_name, # Use Python op_name
