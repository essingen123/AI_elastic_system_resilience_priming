...
# Script ID 208: Op 'sine_power_mix', Modifiers: freq1=1.47, pow1=2, amp1=1.3, freq2=0.98, pow2=2, amp2=4.5
...
if __name__ == "__main__":
    ...
    freq1 = float(1.47) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(1.3) # PHP generated
    freq2 = float(0.98) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(4.5) # PHP generated
