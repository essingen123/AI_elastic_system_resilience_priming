...
# Script ID 253: Op 'swirl_step', Modifiers: strength=7.3
...
if __name__ == "__main__":
    ...
    strength = float(7.3) # PHP generated
    ...
    print(json.dumps({
        "script_id":253, "input_value":input_value, "op_type":op_name, # Use Python op_name
