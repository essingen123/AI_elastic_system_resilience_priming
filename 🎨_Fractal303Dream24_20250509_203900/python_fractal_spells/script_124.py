...
# Script ID 124: Op 'de_jong_attractor_x', Modifiers: a=-1.62, b=-2.82
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 124})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 124, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":124, "input_value":input_value, "op_type":op_name, # Use Python op_name
