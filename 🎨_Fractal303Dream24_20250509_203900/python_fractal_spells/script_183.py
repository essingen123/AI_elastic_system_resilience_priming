...
# Script ID 183: Op 'sine_power_mix', Modifiers: freq1=2.19, pow1=2, amp1=3.5, freq2=1.71, pow2=2, amp2=5
...
if __name__ == "__main__":
    ...
    freq1 = float(2.19) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(3.5) # PHP generated
    freq2 = float(1.71) # PHP generated
    ...
    print(json.dumps({
        "script_id":183, "input_value":input_value, "op_type":op_name, # Use Python op_name
