...
# Script ID 71: Op 'de_jong_attractor_x', Modifiers: a=1.2, b=-2.28
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 71, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":71, "input_value":input_value, "op_type":op_name, # Use Python op_name
