...
# Script ID 256: Op 'clifford_attractor_y', Modifiers: b=-0.21, d=1.33
...
if __name__ == "__main__":
    ...
    b = float(-0.21) # PHP generated
    d = float(1.33) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 256, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":256, "input_value":input_value, "op_type":op_name, # Use Python op_name
