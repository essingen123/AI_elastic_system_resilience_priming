...
# Script ID 86: Op 'clifford_attractor_y', Modifiers: b=-1.72, d=-0.18
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":86, "input_value":input_value, "op_type":op_name, # Use Python op_name
