...
# Script ID 97: Op 'logistic_growth', Modifiers: r=3.839, k=91
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":97, "input_value":input_value, "op_type":op_name, # Use Python op_name
