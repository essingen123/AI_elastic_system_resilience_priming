...
# Script ID 125: Op 'sine_power_mix', Modifiers: freq1=0.16, pow1=3, amp1=4.7, freq2=2.41, pow2=2, amp2=3.8
...
if __name__ == "__main__":
    ...
    freq1 = float(0.16) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(4.7) # PHP generated
    freq2 = float(2.41) # PHP generated
    ...
    print(json.dumps({
        "script_id":125, "input_value":input_value, "op_type":op_name, # Use Python op_name
