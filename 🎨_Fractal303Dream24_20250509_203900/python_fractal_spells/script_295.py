...
# Script ID 295: Op 'coupled_logistic_x', Modifiers: rx=3.665, cxy=0.037
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 295, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":295, "input_value":input_value, "op_type":op_name, # Use Python op_name
