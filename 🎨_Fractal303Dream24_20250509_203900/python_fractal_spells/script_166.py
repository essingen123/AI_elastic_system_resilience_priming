...
# Script ID 166: Op 'de_jong_attractor_x', Modifiers: a=-0.65, b=-0.52
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 166})); sys.exit(1)
    ...
    a = float(-0.65) # PHP generated
    b = float(-0.52) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 166, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":166, "input_value":input_value, "op_type":op_name, # Use Python op_name
