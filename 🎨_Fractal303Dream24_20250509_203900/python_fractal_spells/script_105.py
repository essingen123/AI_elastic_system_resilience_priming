...
# Script ID 105: Op 'coupled_logistic_x', Modifiers: rx=3.671, cxy=0.093
...
if __name__ == "__main__":
    ...
    rx = float(3.671) # PHP generated
    cxy = float(0.093) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 105, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":105, "input_value":input_value, "op_type":op_name, # Use Python op_name
