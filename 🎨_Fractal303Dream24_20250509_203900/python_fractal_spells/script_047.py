...
# Script ID 47: Op 'sine_power_mix', Modifiers: freq1=0.19, pow1=3, amp1=4.2, freq2=1.51, pow2=3, amp2=3.4
...
if __name__ == "__main__":
    ...
    freq1 = float(0.19) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(4.2) # PHP generated
    freq2 = float(1.51) # PHP generated
    ...
    print(json.dumps({
        "script_id":47, "input_value":input_value, "op_type":op_name, # Use Python op_name
