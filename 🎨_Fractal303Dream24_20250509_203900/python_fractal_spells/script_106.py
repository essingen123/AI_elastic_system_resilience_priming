...
# Script ID 106: Op 'de_jong_attractor_y', Modifiers: c=-0.41, d=2.78
...
if __name__ == "__main__":
    ...
    c = float(-0.41) # PHP generated
    d = float(2.78) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 106, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":106, "input_value":input_value, "op_type":op_name, # Use Python op_name
