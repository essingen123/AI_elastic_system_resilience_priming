...
# Script ID 16: Op 'clifford_attractor_x', Modifiers: a=0.82, c=-0.57
...
if __name__ == "__main__":
    ...
    a = float(0.82) # PHP generated
    c = float(-0.57) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 16, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":16, "input_value":input_value, "op_type":op_name, # Use Python op_name
