...
# Script ID 109: Op 'clifford_attractor_y', Modifiers: b=-0.71, d=-1.63
...
if __name__ == "__main__":
    ...
    b = float(-0.71) # PHP generated
    d = float(-1.63) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 109, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":109, "input_value":input_value, "op_type":op_name, # Use Python op_name
