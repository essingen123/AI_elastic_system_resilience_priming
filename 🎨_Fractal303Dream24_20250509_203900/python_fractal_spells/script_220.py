...
# Script ID 220: Op 'lyapunov_exponent_approx', Modifiers: r=3.644
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 220, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":220, "input_value":input_value, "op_type":op_name, # Use Python op_name
