...
# Script ID 120: Op 'de_jong_attractor_x', Modifiers: a=-1.67, b=-2.15
...
if __name__ == "__main__":
    ...
    a = float(-1.67) # PHP generated
    b = float(-2.15) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 120, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":120, "input_value":input_value, "op_type":op_name, # Use Python op_name
