...
# Script ID 80: Op 'de_jong_attractor_x', Modifiers: a=1.78, b=-0.35
...
if __name__ == "__main__":
    ...
    a = float(1.78) # PHP generated
    b = float(-0.35) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 80, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":80, "input_value":input_value, "op_type":op_name, # Use Python op_name
