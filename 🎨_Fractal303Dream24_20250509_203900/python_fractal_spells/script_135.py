...
# Script ID 135: Op 'de_jong_attractor_x', Modifiers: a=2.19, b=-1.91
...
if __name__ == "__main__":
    ...
    a = float(2.19) # PHP generated
    b = float(-1.91) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 135, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":135, "input_value":input_value, "op_type":op_name, # Use Python op_name
