...
# Script ID 88: Op 'coupled_logistic_x', Modifiers: rx=3.98, cxy=0.162
...
if __name__ == "__main__":
    ...
    rx = float(3.98) # PHP generated
    cxy = float(0.162) # PHP generated
    ...
    print(json.dumps({
        "script_id":88, "input_value":input_value, "op_type":op_name, # Use Python op_name
