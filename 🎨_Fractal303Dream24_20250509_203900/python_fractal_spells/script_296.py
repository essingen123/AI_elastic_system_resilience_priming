...
# Script ID 296: Op 'clifford_attractor_x', Modifiers: a=-1.21, c=-1.19
...
if __name__ == "__main__":
    ...
    a = float(-1.21) # PHP generated
    c = float(-1.19) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 296, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":296, "input_value":input_value, "op_type":op_name, # Use Python op_name
