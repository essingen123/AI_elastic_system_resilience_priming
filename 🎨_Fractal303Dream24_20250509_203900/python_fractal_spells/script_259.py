...
# Script ID 259: Op 'de_jong_attractor_x', Modifiers: a=-0.95, b=2.82
...
if __name__ == "__main__":
    ...
    a = float(-0.95) # PHP generated
    b = float(2.82) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 259, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":259, "input_value":input_value, "op_type":op_name, # Use Python op_name
