...
# Script ID 174: Op 'clifford_attractor_x', Modifiers: a=-0.63, c=-1.82
...
if __name__ == "__main__":
    ...
    a = float(-0.63) # PHP generated
    c = float(-1.82) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 174, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":174, "input_value":input_value, "op_type":op_name, # Use Python op_name
