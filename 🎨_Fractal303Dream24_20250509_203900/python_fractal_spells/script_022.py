...
# Script ID 22: Op 'de_jong_attractor_x', Modifiers: a=2.1, b=-0.68
...
if __name__ == "__main__":
    ...
    a = float(2.1) # PHP generated
    b = float(-0.68) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 22, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":22, "input_value":input_value, "op_type":op_name, # Use Python op_name
