...
# Script ID 289: Op 'coupled_logistic_x', Modifiers: rx=3.995, cxy=0.098
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":289, "input_value":input_value, "op_type":op_name, # Use Python op_name
