...
# Script ID 193: Op 'coupled_logistic_x', Modifiers: rx=3.782, cxy=0.043
...
if __name__ == "__main__":
    ...
    rx = float(3.782) # PHP generated
    cxy = float(0.043) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 193, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":193, "input_value":input_value, "op_type":op_name, # Use Python op_name
