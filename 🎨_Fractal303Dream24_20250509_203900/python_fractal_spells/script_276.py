...
# Script ID 276: Op 'de_jong_attractor_y', Modifiers: c=1.53, d=-2.36
...
if __name__ == "__main__":
    ...
    c = float(1.53) # PHP generated
    d = float(-2.36) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 276, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":276, "input_value":input_value, "op_type":op_name, # Use Python op_name
