...
# Script ID 21: Op 'de_jong_attractor_x', Modifiers: a=-1.65, b=2.38
...
if __name__ == "__main__":
    ...
    a = float(-1.65) # PHP generated
    b = float(2.38) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 21, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":21, "input_value":input_value, "op_type":op_name, # Use Python op_name
