...
# Script ID 49: Op 'clifford_attractor_y', Modifiers: b=1.32, d=1.08
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 49, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":49, "input_value":input_value, "op_type":op_name, # Use Python op_name
