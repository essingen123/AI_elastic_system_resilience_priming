...
# Script ID 205: Op 'clifford_attractor_y', Modifiers: b=-0.73, d=0.92
op_name = "clifford_attractor_y" # Make op_name global in this Python script's context
...
if __name__ == "__main__":
    ...
    b = float(-0.73) # PHP generated
    d = float(0.92) # PHP generated
