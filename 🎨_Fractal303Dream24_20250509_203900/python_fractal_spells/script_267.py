...
# Script ID 267: Op 'clifford_attractor_x', Modifiers: a=-1.59, c=1.35
...
if __name__ == "__main__":
    ...
    a = float(-1.59) # PHP generated
    c = float(1.35) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 267, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":267, "input_value":input_value, "op_type":op_name, # Use Python op_name
