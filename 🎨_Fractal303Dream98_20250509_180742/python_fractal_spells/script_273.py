...
# Script ID 273: Op 'sine_power_mix', Modifiers: freq1=0.23, pow1=3, amp1=2.1, freq2=1.05, pow2=3, amp2=3.7
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.23)
    modifier_pow1 = float(3)
    modifier_amp1 = float(2.1)
    modifier_freq2 = float(1.05)
    modifier_pow2 = float(3)
    modifier_amp2 = float(3.7)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 273, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":273, "input_value":input_value, "op_type":"sine_power_mix", 
