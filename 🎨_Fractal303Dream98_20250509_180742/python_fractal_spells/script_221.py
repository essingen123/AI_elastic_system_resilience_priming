...
# Script ID 221: Op 'sine_power_mix', Modifiers: freq1=0.19, pow1=3, amp1=3.8, freq2=1.62, pow2=1, amp2=4.8
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.19)
    modifier_pow1 = float(3)
    modifier_amp1 = float(3.8)
    modifier_freq2 = float(1.62)
    ...
    output_value = perform_operation(input_value, current_depth, 221, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":221, "input_value":input_value, "op_type":"sine_power_mix", 
