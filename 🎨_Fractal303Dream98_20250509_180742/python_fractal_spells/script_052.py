...
# Script ID 52: Op 'lyapunov_exponent_approx', Modifiers: r=3.73
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 52})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 52, prev_val_placeholder_py, **({"modifier_r": modifier_r}))
    ...
    print(json.dumps({
        "script_id":52, "input_value":input_value, "op_type":"lyapunov_exponent_approx", 
