...
# Script ID 71: Op 'sine_power_mix', Modifiers: freq1=0.11, pow1=1, amp1=4.9, freq2=2.65, pow2=2, amp2=4.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.11)
    modifier_pow1 = float(1)
    modifier_amp1 = float(4.9)
    modifier_freq2 = float(2.65)
    ...
    output_value = perform_operation(input_value, current_depth, 71, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":71, "input_value":input_value, "op_type":"sine_power_mix", 
