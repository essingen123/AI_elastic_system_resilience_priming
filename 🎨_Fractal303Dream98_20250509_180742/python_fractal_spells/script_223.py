...
# Script ID 223: Op 'sine_power_mix', Modifiers: freq1=0.46, pow1=3, amp1=4, freq2=0.38, pow2=2, amp2=0.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 223, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":223, "input_value":input_value, "op_type":"sine_power_mix", 
