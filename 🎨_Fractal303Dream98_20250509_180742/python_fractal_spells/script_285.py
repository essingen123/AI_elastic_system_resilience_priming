...
# Script ID 285: Op 'de_jong_attractor_y', Modifiers: c=2.61, d=-0.2
...
if __name__ == "__main__":
    ...
    modifier_c = float(2.61)
    modifier_d = float(-0.2)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 285, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":285, "input_value":input_value, "op_type":"de_jong_attractor_y", 
