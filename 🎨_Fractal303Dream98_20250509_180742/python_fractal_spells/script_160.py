...
# Script ID 160: Op 'logistic_growth', Modifiers: r=3.291, k=68
...
if __name__ == "__main__":
    ...
    modifier_r = float(3.291)
    modifier_k = float(68)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 160, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":160, "input_value":input_value, "op_type":"logistic_growth", 
