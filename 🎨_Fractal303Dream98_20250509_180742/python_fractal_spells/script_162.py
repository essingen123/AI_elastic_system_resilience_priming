...
# Script ID 162: Op 'sine_power_mix', Modifiers: freq1=1.66, pow1=2, amp1=2.6, freq2=1.47, pow2=1, amp2=1.1
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.66)
    modifier_pow1 = float(2)
    modifier_amp1 = float(2.6)
    modifier_freq2 = float(1.47)
    ...
    output_value = perform_operation(input_value, current_depth, 162, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":162, "input_value":input_value, "op_type":"sine_power_mix", 
