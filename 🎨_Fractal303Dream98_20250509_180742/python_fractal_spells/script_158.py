...
# Script ID 158: Op 'clifford_attractor_x', Modifiers: a=1.86, c=-0.97
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 158, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":158, "input_value":input_value, "op_type":"clifford_attractor_x", 
