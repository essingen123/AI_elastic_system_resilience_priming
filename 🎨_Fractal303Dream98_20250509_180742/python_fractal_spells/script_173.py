...
# Script ID 173: Op 'coupled_logistic_x', Modifiers: rx=3.565, cxy=0.014
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.565)
    modifier_cxy = float(0.014)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 173, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":173, "input_value":input_value, "op_type":"coupled_logistic_x", 
