...
# Script ID 43: Op 'sine_power_mix', Modifiers: freq1=1.36, pow1=2, amp1=3.7, freq2=1.64, pow2=3, amp2=1.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.36)
    modifier_pow1 = float(2)
    modifier_amp1 = float(3.7)
    modifier_freq2 = float(1.64)
    ...
    output_value = perform_operation(input_value, current_depth, 43, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":43, "input_value":input_value, "op_type":"sine_power_mix", 
