...
# Script ID 108: Op 'clifford_attractor_y', Modifiers: b=-1.8, d=1.21
...
if __name__ == "__main__":
    ...
    modifier_b = float(-1.8)
    modifier_d = float(1.21)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 108, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":108, "input_value":input_value, "op_type":"clifford_attractor_y", 
