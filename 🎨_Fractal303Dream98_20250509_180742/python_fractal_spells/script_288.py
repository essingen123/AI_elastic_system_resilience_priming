...
# Script ID 288: Op 'sine_power_mix', Modifiers: freq1=2.28, pow1=2, amp1=1, freq2=2.55, pow2=2, amp2=2.2
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.28)
    modifier_pow1 = float(2)
    modifier_amp1 = float(1)
    modifier_freq2 = float(2.55)
