...
# Script ID 87: Op 'de_jong_attractor_y', Modifiers: c=2.19, d=-2.14
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 87, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":87, "input_value":input_value, "op_type":"de_jong_attractor_y", 
