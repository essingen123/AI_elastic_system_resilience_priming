...
# Script ID 263: Op 'sine_power_mix', Modifiers: freq1=2.06, pow1=1, amp1=2.7, freq2=2.05, pow2=2, amp2=1.2
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.06)
    modifier_pow1 = float(1)
    modifier_amp1 = float(2.7)
    modifier_freq2 = float(2.05)
    ...
    output_value = perform_operation(input_value, current_depth, 263, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":263, "input_value":input_value, "op_type":"sine_power_mix", 
