...
# Script ID 55: Op 'clifford_attractor_y', Modifiers: b=0.54, d=1.63
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 55, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":55, "input_value":input_value, "op_type":"clifford_attractor_y", 
