...
# Script ID 196: Op 'coupled_logistic_x', Modifiers: rx=3.553, cxy=0.122
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.553)
    modifier_cxy = float(0.122)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 196, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":196, "input_value":input_value, "op_type":"coupled_logistic_x", 
