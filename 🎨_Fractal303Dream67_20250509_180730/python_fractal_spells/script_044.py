...
# Script ID 44: Op 'de_jong_attractor_y', Modifiers: c=1.96, d=0.61
...
if __name__ == "__main__":
    ...
    modifier_c = float(1.96)
    modifier_d = float(0.61)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 44, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":44, "input_value":input_value, "op_type":"de_jong_attractor_y", 
