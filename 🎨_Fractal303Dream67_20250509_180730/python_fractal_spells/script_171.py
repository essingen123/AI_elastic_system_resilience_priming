...
# Script ID 171: Op 'de_jong_attractor_y', Modifiers: c=0.38, d=-1.27
...
if __name__ == "__main__":
    ...
    modifier_c = float(0.38)
    modifier_d = float(-1.27)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 171, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":171, "input_value":input_value, "op_type":"de_jong_attractor_y", 
