...
# Script ID 198: Op 'sine_power_mix', Modifiers: freq1=1.05, pow1=3, amp1=2.7, freq2=2.28, pow2=3, amp2=0.9
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.05)
    modifier_pow1 = float(3)
    modifier_amp1 = float(2.7)
    modifier_freq2 = float(2.28)
    ...
    output_value = perform_operation(input_value, current_depth, 198, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":198, "input_value":input_value, "op_type":"sine_power_mix", 
