...
# Script ID 54: Op 'logistic_growth', Modifiers: r=3.548, k=11
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 54, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":54, "input_value":input_value, "op_type":"logistic_growth", 
