...
# Script ID 179: Op 'sine_power_mix', Modifiers: freq1=1.18, pow1=2, amp1=2.7, freq2=2.15, pow2=2, amp2=4.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 179, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":179, "input_value":input_value, "op_type":"sine_power_mix", 
