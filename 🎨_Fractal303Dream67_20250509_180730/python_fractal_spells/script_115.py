...
# Script ID 115: Op 'sine_power_mix', Modifiers: freq1=0.49, pow1=2, amp1=5, freq2=1.37, pow2=3, amp2=2.1
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.49)
    modifier_pow1 = float(2)
    modifier_amp1 = float(5)
    modifier_freq2 = float(1.37)
    ...
    output_value = perform_operation(input_value, current_depth, 115, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":115, "input_value":input_value, "op_type":"sine_power_mix", 
