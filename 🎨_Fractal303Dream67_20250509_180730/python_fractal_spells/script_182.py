...
# Script ID 182: Op 'sine_power_mix', Modifiers: freq1=1.32, pow1=1, amp1=4.7, freq2=2.15, pow2=2, amp2=1.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.32)
    modifier_pow1 = float(1)
    modifier_amp1 = float(4.7)
    modifier_freq2 = float(2.15)
    ...
    output_value = perform_operation(input_value, current_depth, 182, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":182, "input_value":input_value, "op_type":"sine_power_mix", 
