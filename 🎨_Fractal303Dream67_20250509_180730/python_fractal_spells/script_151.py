...
# Script ID 151: Op 'logistic_growth', Modifiers: r=2.82, k=52
...
if __name__ == "__main__":
    ...
    modifier_r = float(2.82)
    modifier_k = float(52)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 151, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":151, "input_value":input_value, "op_type":"logistic_growth", 
