...
# Script ID 250: Op 'sine_power_mix', Modifiers: freq1=0.17, pow1=1, amp1=4, freq2=1.5, pow2=2, amp2=4.3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.17)
    modifier_pow1 = float(1)
    modifier_amp1 = float(4)
    modifier_freq2 = float(1.5)
    ...
    output_value = perform_operation(input_value, current_depth, 250, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":250, "input_value":input_value, "op_type":"sine_power_mix", 
