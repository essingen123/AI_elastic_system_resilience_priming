...
# Script ID 189: Op 'de_jong_attractor_y', Modifiers: c=1.17, d=0.82
...
if __name__ == "__main__":
    ...
    modifier_d = float(0.82)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 189, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":189, "input_value":input_value, "op_type":"de_jong_attractor_y", 
