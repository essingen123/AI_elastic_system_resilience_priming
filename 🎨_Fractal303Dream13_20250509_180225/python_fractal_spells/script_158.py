...
# Script ID 158: Op 'de_jong_attractor_x', Modifiers: a=-0.78, b=0.06
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.78)
    modifier_b = float(0.06)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 158, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":158, "input_value":input_value, "op_type":"de_jong_attractor_x", 
