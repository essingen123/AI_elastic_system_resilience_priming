...
# Script ID 109: Op 'clifford_attractor_x', Modifiers: a=1.24, c=1.24
...
if __name__ == "__main__":
    ...
    modifier_c = float(1.24)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 109, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":109, "input_value":input_value, "op_type":"clifford_attractor_x", 
