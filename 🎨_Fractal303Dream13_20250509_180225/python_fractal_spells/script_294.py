...
# Script ID 294: Op 'de_jong_attractor_y', Modifiers: c=-0.84, d=0.72
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 294, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":294, "input_value":input_value, "op_type":"de_jong_attractor_y", 
