...
# Script ID 55: Op 'sine_power_mix', Modifiers: freq1=1.96, pow1=3, amp1=1.8, freq2=0.57, pow2=3, amp2=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 55, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":55, "input_value":input_value, "op_type":"sine_power_mix", 
