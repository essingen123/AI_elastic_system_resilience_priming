...
# Script ID 145: Op 'sine_power_mix', Modifiers: freq1=0.36, pow1=3, amp1=1.5, freq2=0.6, pow2=1, amp2=0.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.36)
    modifier_pow1 = float(3)
    modifier_amp1 = float(1.5)
    modifier_freq2 = float(0.6)
    ...
    output_value = perform_operation(input_value, current_depth, 145, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":145, "input_value":input_value, "op_type":"sine_power_mix", 
