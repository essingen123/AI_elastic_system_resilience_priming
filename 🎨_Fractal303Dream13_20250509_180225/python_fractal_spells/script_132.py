...
# Script ID 132: Op 'de_jong_attractor_y', Modifiers: c=0.27, d=-1.93
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 132, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":132, "input_value":input_value, "op_type":"de_jong_attractor_y", 
