...
# Script ID 2: Op 'coupled_logistic_x', Modifiers: rx=3.935, cxy=0.114
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 2, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":2, "input_value":input_value, "op_type":"coupled_logistic_x", 
