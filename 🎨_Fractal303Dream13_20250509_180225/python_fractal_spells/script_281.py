...
# Script ID 281: Op 'sine_power_mix', Modifiers: freq1=1.73, pow1=3, amp1=4.7, freq2=2.82, pow2=1, amp2=3.8
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 281})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 281, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":281, "input_value":input_value, "op_type":"sine_power_mix", 
