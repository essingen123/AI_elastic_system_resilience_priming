...
# Script ID 255: Op 'clifford_attractor_y', Modifiers: b=0.08, d=-1.94
...
if __name__ == "__main__":
    ...
    modifier_b = float(0.08)
    modifier_d = float(-1.94)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 255, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":255, "input_value":input_value, "op_type":"clifford_attractor_y", 
