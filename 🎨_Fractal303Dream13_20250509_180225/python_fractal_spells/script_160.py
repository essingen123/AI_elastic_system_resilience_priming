...
# Script ID 160: Op 'clifford_attractor_x', Modifiers: a=1.53, c=1.44
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 160, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":160, "input_value":input_value, "op_type":"clifford_attractor_x", 
