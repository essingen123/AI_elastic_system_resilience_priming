...
# Script ID 167: Op 'de_jong_attractor_y', Modifiers: c=2.31, d=2.99
...
if __name__ == "__main__":
    ...
    modifier_c = float(2.31)
    modifier_d = float(2.99)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 167, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":167, "input_value":input_value, "op_type":"de_jong_attractor_y", 
