...
# Script ID 136: Op 'de_jong_attractor_x', Modifiers: a=-0.07, b=-2.98
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.07)
    modifier_b = float(-2.98)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 136, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":"de_jong_attractor_x", 
