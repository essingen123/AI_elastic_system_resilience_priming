...
# Script ID 185: Op 'sine_power_mix', Modifiers: freq1=0.96, pow1=3, amp1=1.8, freq2=1.71, pow2=2, amp2=4.3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.96)
    modifier_pow1 = float(3)
    modifier_amp1 = float(1.8)
    modifier_freq2 = float(1.71)
    ...
    output_value = perform_operation(input_value, current_depth, 185, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":185, "input_value":input_value, "op_type":"sine_power_mix", 
