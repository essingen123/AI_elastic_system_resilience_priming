...
# Script ID 267: Op 'sine_power_mix', Modifiers: freq1=2.38, pow1=3, amp1=4.5, freq2=1.54, pow2=1, amp2=1.4
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.38)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.5)
    modifier_freq2 = float(1.54)
    modifier_pow2 = float(1)
    modifier_amp2 = float(1.4)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 267, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":267, "input_value":input_value, "op_type":"sine_power_mix", 
