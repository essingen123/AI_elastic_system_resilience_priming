...
# Script ID 113: Op 'sine_power_mix', Modifiers: freq1=0.37, pow1=1, amp1=3.9, freq2=2.17, pow2=2, amp2=3.7
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.37)
    modifier_pow1 = float(1)
    modifier_amp1 = float(3.9)
    modifier_freq2 = float(2.17)
    ...
    output_value = perform_operation(input_value, current_depth, 113, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":113, "input_value":input_value, "op_type":"sine_power_mix", 
