...
# Script ID 30: Op 'sine_power_mix', Modifiers: freq1=0.97, pow1=3, amp1=0.8, freq2=1.12, pow2=3, amp2=2.9
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.97)
    modifier_pow1 = float(3)
    modifier_amp1 = float(0.8)
    modifier_freq2 = float(1.12)
    modifier_pow2 = float(3)
    modifier_amp2 = float(2.9)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 30, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":30, "input_value":input_value, "op_type":"sine_power_mix", 
