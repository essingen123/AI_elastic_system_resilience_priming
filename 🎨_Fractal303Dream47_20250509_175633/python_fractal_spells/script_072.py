...
# Script ID 72: Op 'sine_power_mix', Modifiers: freq1=1.75, pow1=2, amp1=0.6, freq2=1.93, pow2=3, amp2=1.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 72, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":72, "input_value":input_value, "op_type":"sine_power_mix", 
