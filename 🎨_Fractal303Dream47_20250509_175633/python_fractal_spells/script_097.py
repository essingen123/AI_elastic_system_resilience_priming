...
# Script ID 97: Op 'sine_power_mix', Modifiers: freq1=2.17, pow1=3, amp1=4.3, freq2=0.5, pow2=2, amp2=3.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.17)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.3)
    modifier_freq2 = float(0.5)
    ...
    output_value = perform_operation(input_value, current_depth, 97, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":97, "input_value":input_value, "op_type":"sine_power_mix", 
