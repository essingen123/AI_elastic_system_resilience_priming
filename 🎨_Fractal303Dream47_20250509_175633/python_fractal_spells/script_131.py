...
# Script ID 131: Op 'de_jong_attractor_x', Modifiers: a=-0.73, b=-0.12
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.73)
    modifier_b = float(-0.12)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 131, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":"de_jong_attractor_x", 
