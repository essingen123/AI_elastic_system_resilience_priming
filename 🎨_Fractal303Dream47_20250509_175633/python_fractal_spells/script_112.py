...
# Script ID 112: Op 'sine_power_mix', Modifiers: freq1=2.86, pow1=3, amp1=3.1, freq2=1.6, pow2=3, amp2=0.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.86)
    modifier_pow1 = float(3)
    modifier_amp1 = float(3.1)
    modifier_freq2 = float(1.6)
    ...
    output_value = perform_operation(input_value, current_depth, 112, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":112, "input_value":input_value, "op_type":"sine_power_mix", 
