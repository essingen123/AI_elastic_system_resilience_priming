...
# Script ID 247: Op 'de_jong_attractor_x', Modifiers: a=0.08, b=-0.13
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 247, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":247, "input_value":input_value, "op_type":"de_jong_attractor_x", 
