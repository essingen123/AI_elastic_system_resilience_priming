...
# Script ID 226: Op 'de_jong_attractor_x', Modifiers: a=-0.41, b=2.03
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 226, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":226, "input_value":input_value, "op_type":"de_jong_attractor_x", 
