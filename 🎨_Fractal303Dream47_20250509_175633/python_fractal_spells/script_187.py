...
# Script ID 187: Op 'sine_power_mix', Modifiers: freq1=2.95, pow1=1, amp1=2.7, freq2=1.45, pow2=3, amp2=1.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 187, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":187, "input_value":input_value, "op_type":"sine_power_mix", 
