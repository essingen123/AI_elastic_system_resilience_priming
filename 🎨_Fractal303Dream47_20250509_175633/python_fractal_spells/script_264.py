...
# Script ID 264: Op 'de_jong_attractor_y', Modifiers: c=2.56, d=-2.47
...
if __name__ == "__main__":
    ...
    modifier_c = float(2.56)
    modifier_d = float(-2.47)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 264, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":264, "input_value":input_value, "op_type":"de_jong_attractor_y", 
