...
# Script ID 260: Op 'sine_power_mix', Modifiers: freq1=1.46, pow1=3, amp1=2.7, freq2=2.1, pow2=1, amp2=3.4
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.46)
    modifier_pow1 = float(3)
    modifier_amp1 = float(2.7)
    modifier_freq2 = float(2.1)
    ...
    output_value = perform_operation(input_value, current_depth, 260, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":260, "input_value":input_value, "op_type":"sine_power_mix", 
