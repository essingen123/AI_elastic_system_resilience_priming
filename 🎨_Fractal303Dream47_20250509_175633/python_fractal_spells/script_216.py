...
# Script ID 216: Op 'swirl_step', Modifiers: strength=1
op_name = "swirl_step" 
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 216, prev_val_placeholder_py, **({"modifier_strength": modifier_strength}))
    ...
    print(json.dumps({
        "script_id":216, "input_value":input_value, "op_type":"swirl_step", 
