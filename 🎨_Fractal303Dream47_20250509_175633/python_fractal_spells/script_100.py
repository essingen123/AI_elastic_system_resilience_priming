...
# Script ID 100: Op 'coupled_logistic_x', Modifiers: rx=3.666, cxy=0.185
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.666)
    modifier_cxy = float(0.185)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 100, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":100, "input_value":input_value, "op_type":"coupled_logistic_x", 
