...
# Script ID 143: Op 'de_jong_attractor_y', Modifiers: c=-1.48, d=-1.87
...
if __name__ == "__main__":
    ...
    modifier_d = float(-1.87)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 143, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":143, "input_value":input_value, "op_type":"de_jong_attractor_y", 
