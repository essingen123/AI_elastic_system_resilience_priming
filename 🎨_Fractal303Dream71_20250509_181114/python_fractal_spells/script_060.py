...
# Script ID 60: Op 'sine_power_mix', Modifiers: freq1=0.59, pow1=1, amp1=3.2, freq2=1.52, pow2=1, amp2=2.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 60, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":60, "input_value":input_value, "op_type":"sine_power_mix", 
