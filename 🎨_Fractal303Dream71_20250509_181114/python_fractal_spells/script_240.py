...
# Script ID 240: Op 'sine_power_mix', Modifiers: freq1=0.35, pow1=3, amp1=1.7, freq2=1.21, pow2=3, amp2=2.8
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.35)
    modifier_pow1 = float(3)
    modifier_amp1 = float(1.7)
    modifier_freq2 = float(1.21)
    ...
    output_value = perform_operation(input_value, current_depth, 240, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":240, "input_value":input_value, "op_type":"sine_power_mix", 
