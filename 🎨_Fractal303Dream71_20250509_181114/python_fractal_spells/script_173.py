...
# Script ID 173: Op 'clifford_attractor_y', Modifiers: b=0.42, d=-1.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 173, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":173, "input_value":input_value, "op_type":"clifford_attractor_y", 
