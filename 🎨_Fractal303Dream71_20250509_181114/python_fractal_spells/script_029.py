...
# Script ID 29: Op 'de_jong_attractor_x', Modifiers: a=-1.45, b=-2.18
...
if __name__ == "__main__":
    ...
    modifier_a = float(-1.45)
    modifier_b = float(-2.18)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 29, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":29, "input_value":input_value, "op_type":"de_jong_attractor_x", 
