...
# Script ID 91: Op 'coupled_logistic_x', Modifiers: rx=3.591, cxy=0.161
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 91, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":91, "input_value":input_value, "op_type":"coupled_logistic_x", 
