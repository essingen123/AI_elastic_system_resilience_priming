...
# Script ID 63: Op 'sine_power_mix', Modifiers: freq1=2.57, pow1=3, amp1=4.7, freq2=1.67, pow2=2, amp2=1.4
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.57)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.7)
    modifier_freq2 = float(1.67)
    ...
    output_value = perform_operation(input_value, current_depth, 63, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":63, "input_value":input_value, "op_type":"sine_power_mix", 
