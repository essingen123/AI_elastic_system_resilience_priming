...
# Script ID 49: Op 'sine_power_mix', Modifiers: freq1=2.47, pow1=3, amp1=4.6, freq2=2.27, pow2=2, amp2=3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.47)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.6)
    modifier_freq2 = float(2.27)
    modifier_pow2 = float(2)
    modifier_amp2 = float(3)
