...
# Script ID 108: Op 'sine_power_mix', Modifiers: freq1=0.27, pow1=3, amp1=4.4, freq2=0.81, pow2=3, amp2=2.9
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 108})); sys.exit(1)
    ...
    modifier_freq1 = float(0.27)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.4)
    modifier_freq2 = float(0.81)
    ...
    output_value = perform_operation(input_value, current_depth, 108, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":108, "input_value":input_value, "op_type":"sine_power_mix", 
