...
# Script ID 143: Op 'clifford_attractor_y', Modifiers: b=-1.93, d=-1.91
...
if __name__ == "__main__":
    ...
    modifier_d = float(-1.91)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 143, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":143, "input_value":input_value, "op_type":"clifford_attractor_y", 
