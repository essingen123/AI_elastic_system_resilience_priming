...
# Script ID 160: Op 'de_jong_attractor_x', Modifiers: a=-0.4, b=1.65
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.4)
    modifier_b = float(1.65)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 160, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":160, "input_value":input_value, "op_type":"de_jong_attractor_x", 
