...
# Script ID 141: Op 'de_jong_attractor_y', Modifiers: c=-0.67, d=1.32
...
if __name__ == "__main__":
    ...
    modifier_c = float(-0.67)
    modifier_d = float(1.32)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 141, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":141, "input_value":input_value, "op_type":"de_jong_attractor_y", 
