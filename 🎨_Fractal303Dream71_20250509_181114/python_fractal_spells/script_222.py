...
# Script ID 222: Op 'de_jong_attractor_x', Modifiers: a=-1.61, b=0.07
...
if __name__ == "__main__":
    ...
    modifier_a = float(-1.61)
    modifier_b = float(0.07)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 222, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":222, "input_value":input_value, "op_type":"de_jong_attractor_x", 
