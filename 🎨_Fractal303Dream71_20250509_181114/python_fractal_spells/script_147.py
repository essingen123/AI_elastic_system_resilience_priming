...
# Script ID 147: Op 'clifford_attractor_x', Modifiers: a=-0.23, c=1.87
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 147, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":147, "input_value":input_value, "op_type":"clifford_attractor_x", 
