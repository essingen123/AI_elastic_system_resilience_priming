...
# Script ID 152: Op 'sine_power_mix', Modifiers: freq1=1.12, pow1=3, amp1=0.6, freq2=2.52, pow2=3, amp2=1.9
...
if __name__ == "__main__":
    ...
    modifier_amp2 = float(1.9)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 152, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":152, "input_value":input_value, "op_type":"sine_power_mix", 
