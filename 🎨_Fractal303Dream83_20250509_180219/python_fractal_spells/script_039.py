...
# Script ID 39: Op 'de_jong_attractor_y', Modifiers: c=1.62, d=0.67
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 39, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":39, "input_value":input_value, "op_type":"de_jong_attractor_y", 
