...
# Script ID 246: Op 'sine_power_mix', Modifiers: freq1=0.8, pow1=3, amp1=3, freq2=0.5, pow2=3, amp2=4.1
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.8)
    modifier_pow1 = float(3)
    modifier_amp1 = float(3)
    ...
    output_value = perform_operation(input_value, current_depth, 246, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":246, "input_value":input_value, "op_type":"sine_power_mix", 
