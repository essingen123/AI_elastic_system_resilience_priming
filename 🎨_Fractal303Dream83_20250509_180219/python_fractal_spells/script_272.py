...
# Script ID 272: Op 'sine_power_mix', Modifiers: freq1=2.87, pow1=1, amp1=0.7, freq2=2.85, pow2=1, amp2=4.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 272, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":272, "input_value":input_value, "op_type":"sine_power_mix", 
