...
# Script ID 259: Op 'de_jong_attractor_x', Modifiers: a=1.44, b=-2.77
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 259, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":259, "input_value":input_value, "op_type":"de_jong_attractor_x", 
