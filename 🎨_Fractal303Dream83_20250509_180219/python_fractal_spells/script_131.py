...
# Script ID 131: Op 'de_jong_attractor_y', Modifiers: c=-1.18, d=-1.98
...
if __name__ == "__main__":
    ...
    modifier_d = float(-1.98)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 131, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":"de_jong_attractor_y", 
