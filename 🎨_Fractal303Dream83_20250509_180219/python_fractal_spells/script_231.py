...
# Script ID 231: Op 'clifford_attractor_y', Modifiers: b=0.49, d=-0.23
...
if __name__ == "__main__":
    ...
    modifier_b = float(0.49)
    modifier_d = float(-0.23)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 231, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":231, "input_value":input_value, "op_type":"clifford_attractor_y", 
