...
# Script ID 104: Op 'sine_power_mix', Modifiers: freq1=1.44, pow1=2, amp1=1, freq2=0.43, pow2=3, amp2=2.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.44)
    modifier_pow1 = float(2)
    modifier_amp1 = float(1)
    modifier_freq2 = float(0.43)
    ...
    output_value = perform_operation(input_value, current_depth, 104, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":104, "input_value":input_value, "op_type":"sine_power_mix", 
