...
# Script ID 17: Op 'de_jong_attractor_x', Modifiers: a=-0.83, b=-1.74
...
if __name__ == "__main__":
    ...
    modifier_a = float(-0.83)
    modifier_b = float(-1.74)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 17, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":17, "input_value":input_value, "op_type":"de_jong_attractor_x", 
