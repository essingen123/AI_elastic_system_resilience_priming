...
# Script ID 275: Op 'clifford_attractor_y', Modifiers: b=-0.92, d=0.65
...
if __name__ == "__main__":
    ...
    modifier_d = float(0.65)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 275, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":275, "input_value":input_value, "op_type":"clifford_attractor_y", 
