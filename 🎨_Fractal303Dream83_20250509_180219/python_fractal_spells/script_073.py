...
# Script ID 73: Op 'sine_power_mix', Modifiers: freq1=2.16, pow1=2, amp1=3.4, freq2=0.66, pow2=3, amp2=4.3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.16)
    modifier_pow1 = float(2)
    modifier_amp1 = float(3.4)
    modifier_freq2 = float(0.66)
    ...
    output_value = perform_operation(input_value, current_depth, 73, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":73, "input_value":input_value, "op_type":"sine_power_mix", 
