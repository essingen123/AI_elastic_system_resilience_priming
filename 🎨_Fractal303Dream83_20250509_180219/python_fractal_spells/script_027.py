...
# Script ID 27: Op 'sine_power_mix', Modifiers: freq1=0.33, pow1=1, amp1=0.7, freq2=1.46, pow2=1, amp2=4.4
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.33)
    modifier_pow1 = float(1)
    modifier_amp1 = float(0.7)
    modifier_freq2 = float(1.46)
    ...
    output_value = perform_operation(input_value, current_depth, 27, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":27, "input_value":input_value, "op_type":"sine_power_mix", 
