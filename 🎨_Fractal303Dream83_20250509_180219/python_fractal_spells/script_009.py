...
# Script ID 9: Op 'swirl_step', Modifiers: strength=4.7
op_name = "swirl_step" 
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 9, prev_val_placeholder_py, **({"modifier_strength": modifier_strength}))
    ...
    print(json.dumps({
        "script_id":9, "input_value":input_value, "op_type":"swirl_step", 
