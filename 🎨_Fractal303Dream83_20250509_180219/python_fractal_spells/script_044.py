...
# Script ID 44: Op 'coupled_logistic_x', Modifiers: rx=3.988, cxy=0.04
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 44, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":44, "input_value":input_value, "op_type":"coupled_logistic_x", 
