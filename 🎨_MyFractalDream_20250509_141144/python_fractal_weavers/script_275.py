...
# Script ID 275: Op 'spiral_step_x', Modifiers: angle_rate=0.47, step_size=0.7
op_name = "spiral_step_x" # Make op_name available in Python global scope
...
def perform_operation(val, current_depth, script_id, **modifiers):
    ...
    try: 
        ...
        return val + math.cos(current_depth * modifier_angle_rate + script_id * 0.1) * modifier_step_size
...
if __name__ == "__main__":
    ...
    modifier_angle_rate = 0.47
    modifier_step_size = 0.7

    
    output_value = perform_operation(input_value, current_depth, 275, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id_py = 285 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":275, "input_value":input_value, "op_type":"spiral_step_x", 
