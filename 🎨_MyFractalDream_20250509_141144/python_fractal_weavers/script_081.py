...
# Script ID 81: Op 'power_clip', Modifiers: modifier=0.65
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 81, **({"modifier": modifier}))
    ...
    next_call_id_py = 74 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":81, "input_value":input_value, "op_type":"power_clip", 
