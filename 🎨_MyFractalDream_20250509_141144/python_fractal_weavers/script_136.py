...
# Script ID 136: Op 'subtract', Modifiers: modifier=5
...
if __name__ == "__main__":
    ...
    next_call_id_py = 155 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":"subtract", 
