...
# Script ID 215: Op 'cosine_transform', Modifiers: angle=0.2, amp=1.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 215, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":215, "input_value":input_value, "op_type":"cosine_transform", 
