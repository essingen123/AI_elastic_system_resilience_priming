...
# Script ID 40: Op 'modulo_chaos', Modifiers: factor=1.9, add=-4.1, mod=9.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 40, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 49 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":40, "input_value":input_value, "op_type":"modulo_chaos", 
