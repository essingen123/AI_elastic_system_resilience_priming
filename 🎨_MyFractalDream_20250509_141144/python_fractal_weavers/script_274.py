...
# Script ID 274: Op 'subtract', Modifiers: modifier=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 274, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":274, "input_value":input_value, "op_type":"subtract", 
