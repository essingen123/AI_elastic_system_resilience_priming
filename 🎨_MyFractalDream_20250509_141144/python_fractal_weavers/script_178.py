...
# Script ID 178: Op 'subtract', Modifiers: modifier=-4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 178, **({"modifier": modifier}))
    ...
    next_call_id_py = 195 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":178, "input_value":input_value, "op_type":"subtract", 
