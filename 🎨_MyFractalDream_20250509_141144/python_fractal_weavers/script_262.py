...
# Script ID 262: Op 'sine_transform', Modifiers: angle=0.7, amp=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 262, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":262, "input_value":input_value, "op_type":"sine_transform", 
