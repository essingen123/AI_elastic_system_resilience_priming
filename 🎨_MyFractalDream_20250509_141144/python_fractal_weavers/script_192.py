...
# Script ID 192: Op 'spiral_step_x', Modifiers: angle_rate=0.45, step_size=4.9
...
if __name__ == "__main__":
    ...
    modifier_step_size = 4.9

    
    output_value = perform_operation(input_value, current_depth, 192, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":192, "input_value":input_value, "op_type":"spiral_step_x", 
