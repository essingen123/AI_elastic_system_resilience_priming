...
# Script ID 297: Op 'add', Modifiers: modifier=3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 297, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":297, "input_value":input_value, "op_type":"add", 
