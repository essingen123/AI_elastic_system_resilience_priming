...
# Script ID 28: Op 'power_clip', Modifiers: modifier=1.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 28, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":28, "input_value":input_value, "op_type":"power_clip", 
