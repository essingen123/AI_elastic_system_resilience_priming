...
# Script ID 103: Op 'power_clip', Modifiers: modifier=0.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 103, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":103, "input_value":input_value, "op_type":"power_clip", 
