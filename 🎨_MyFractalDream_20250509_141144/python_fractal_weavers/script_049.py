...
# Script ID 49: Op 'add', Modifiers: modifier=7
...
if __name__ == "__main__":
    ...
    next_call_id_py = 37 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":49, "input_value":input_value, "op_type":"add", 
