...
# Script ID 233: Op 'modulo_chaos', Modifiers: factor=2.2, add=1.6, mod=11.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 233, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":233, "input_value":input_value, "op_type":"modulo_chaos", 
