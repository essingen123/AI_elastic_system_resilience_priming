...
# Script ID 284: Op 'logistic_map', Modifiers: r=3.515, limit=1
op_name = "logistic_map" # Make op_name available in Python global scope
...
def perform_operation(val, current_depth, script_id, **modifiers):
    ...
    try: 
        ...
        return modifier_r * val * (1.0 - val / modifier_limit if modifier_limit !=0 else 1.0-val)
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 284, **({"modifier_r": modifier_r, "modifier_limit": modifier_limit}))
    ...
    print(json.dumps({
        "script_id":284, "input_value":input_value, "op_type":"logistic_map", 
