...
# Script ID 128: Op 'spiral_step_y', Modifiers: angle_rate=0.12, step_size=0.6
...
if __name__ == "__main__":
    ...
    modifier_step_size = 0.6

    
    output_value = perform_operation(input_value, current_depth, 128, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id_py = 109 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":128, "input_value":input_value, "op_type":"spiral_step_y", 
