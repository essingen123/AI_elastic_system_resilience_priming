...
# Script ID 242: Op 'divide', Modifiers: modifier=1.35
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 242, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":242, "input_value":input_value, "op_type":"divide", 
