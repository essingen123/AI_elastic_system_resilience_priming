...
# Script ID 158: Op 'multiply', Modifiers: modifier=2.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 158, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":158, "input_value":input_value, "op_type":"multiply", 
