...
# Script ID 9: Op 'modulo_chaos', Modifiers: factor=1.8, add=4.6, mod=10.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 9, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":9, "input_value":input_value, "op_type":"modulo_chaos", 
