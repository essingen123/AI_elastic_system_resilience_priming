...
# Script ID 221: Op 'sine_transform', Modifiers: angle=3.1, amp=8.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 221, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 217 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":221, "input_value":input_value, "op_type":"sine_transform", 
