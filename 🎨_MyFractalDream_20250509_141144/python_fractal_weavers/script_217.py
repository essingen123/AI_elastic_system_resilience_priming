...
# Script ID 217: Op 'multiply', Modifiers: modifier=0.35
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 217, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":217, "input_value":input_value, "op_type":"multiply", 
