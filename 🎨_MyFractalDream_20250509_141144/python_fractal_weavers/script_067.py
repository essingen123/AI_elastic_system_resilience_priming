...
# Script ID 67: Op 'cosine_transform', Modifiers: angle=0.6, amp=8.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 67, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":67, "input_value":input_value, "op_type":"cosine_transform", 
