...
# Script ID 104: Op 'modulo_chaos', Modifiers: factor=1.2, add=-3.2, mod=12.3
op_name = "modulo_chaos" # Make op_name available in Python global scope
...
def perform_operation(val, current_depth, script_id, **modifiers):
    ...
    try: 
        ...
        return (val * modifier_factor + modifier_add) % modifier_mod if modifier_mod != 0 else val
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 104, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 102 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":104, "input_value":input_value, "op_type":"modulo_chaos", 
        "modifiers_used": {"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}, "output_value":output_value, 
