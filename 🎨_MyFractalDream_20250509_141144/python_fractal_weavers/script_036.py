...
# Script ID 36: Op 'multiply', Modifiers: modifier=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 36, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":36, "input_value":input_value, "op_type":"multiply", 
