...
# Script ID 29: Op 'divide', Modifiers: modifier=0.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 29, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":29, "input_value":input_value, "op_type":"divide", 
