...
# Script ID 32: Op 'divide', Modifiers: modifier=2.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 32, **({"modifier": modifier}))
    ...
    next_call_id_py = 29 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":32, "input_value":input_value, "op_type":"divide", 
