...
# Script ID 126: Op 'divide', Modifiers: modifier=1.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 126, **({"modifier": modifier}))
    ...
    next_call_id_py = 148 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":126, "input_value":input_value, "op_type":"divide", 
