...
# Script ID 198: Op 'cosine_transform', Modifiers: angle=4.9, amp=3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 198, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 179 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":198, "input_value":input_value, "op_type":"cosine_transform", 
