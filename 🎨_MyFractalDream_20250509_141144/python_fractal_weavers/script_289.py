...
# Script ID 289: Op 'power_clip', Modifiers: modifier=0.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 289, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":289, "input_value":input_value, "op_type":"power_clip", 
