...
# Script ID 201: Op 'subtract', Modifiers: modifier=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 201, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":201, "input_value":input_value, "op_type":"subtract", 
