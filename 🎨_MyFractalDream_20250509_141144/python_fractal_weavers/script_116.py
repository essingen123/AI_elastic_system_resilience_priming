...
# Script ID 116: Op 'cosine_transform', Modifiers: angle=2.2, amp=7.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 116, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":116, "input_value":input_value, "op_type":"cosine_transform", 
