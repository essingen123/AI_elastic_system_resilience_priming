...
# Script ID 294: Op 'add', Modifiers: modifier=0
...
if __name__ == "__main__":
    ...
    next_call_id_py = 272 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":294, "input_value":input_value, "op_type":"add", 
