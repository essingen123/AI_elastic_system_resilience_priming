...
# Script ID 301: Op 'spiral_step_y', Modifiers: angle_rate=0.09, step_size=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 301, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":301, "input_value":input_value, "op_type":"spiral_step_y", 
