...
# Script ID 145: Op 'modulo_chaos', Modifiers: factor=1.8, add=-3.5, mod=14.9
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 145})); sys.exit(1)
    ...
    output_value = perform_operation(input_value, current_depth, 145, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":145, "input_value":input_value, "op_type":"modulo_chaos", 
