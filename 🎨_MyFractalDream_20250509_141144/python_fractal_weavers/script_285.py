...
# Script ID 285: Op 'subtract', Modifiers: modifier=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 285, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":285, "input_value":input_value, "op_type":"subtract", 
