...
# Script ID 24: Op 'spiral_step_y', Modifiers: angle_rate=0.4, step_size=4.3
...
if __name__ == "__main__":
    ...
    modifier_step_size = 4.3

    
    output_value = perform_operation(input_value, current_depth, 24, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id_py = 33 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":24, "input_value":input_value, "op_type":"spiral_step_y", 
