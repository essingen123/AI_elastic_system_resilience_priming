...
# Script ID 107: Op 'multiply', Modifiers: modifier=1.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 107, **({"modifier": modifier}))
    ...
    next_call_id_py = 129 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":107, "input_value":input_value, "op_type":"multiply", 
