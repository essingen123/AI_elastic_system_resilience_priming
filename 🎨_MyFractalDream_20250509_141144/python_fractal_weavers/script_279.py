...
# Script ID 279: Op 'subtract', Modifiers: modifier=-2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 279, **({"modifier": modifier}))
    ...
    next_call_id_py = 275 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":279, "input_value":input_value, "op_type":"subtract", 
