...
# Script ID 176: Op 'power_clip', Modifiers: modifier=0.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 176, **({"modifier": modifier}))
    ...
    next_call_id_py = 147 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":176, "input_value":input_value, "op_type":"power_clip", 
