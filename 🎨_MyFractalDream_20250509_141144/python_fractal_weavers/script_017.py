...
# Script ID 17: Op 'spiral_step_y', Modifiers: angle_rate=0.11, step_size=0.5
...
if __name__ == "__main__":
    ...
    modifier_step_size = 0.5

    
    output_value = perform_operation(input_value, current_depth, 17, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":17, "input_value":input_value, "op_type":"spiral_step_y", 
