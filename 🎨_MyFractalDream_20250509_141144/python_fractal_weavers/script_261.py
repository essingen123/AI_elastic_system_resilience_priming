...
# Script ID 261: Op 'subtract', Modifiers: modifier=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 261, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":261, "input_value":input_value, "op_type":"subtract", 
