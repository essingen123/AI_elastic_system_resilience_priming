...
# Script ID 142: Op 'sine_transform', Modifiers: angle=5.1, amp=1.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 142, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":142, "input_value":input_value, "op_type":"sine_transform", 
