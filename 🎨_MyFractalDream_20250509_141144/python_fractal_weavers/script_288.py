...
# Script ID 288: Op 'cosine_transform', Modifiers: angle=6, amp=5.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 288, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":288, "input_value":input_value, "op_type":"cosine_transform", 
