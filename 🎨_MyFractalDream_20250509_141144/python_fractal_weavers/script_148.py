...
# Script ID 148: Op 'cosine_transform', Modifiers: angle=6.3, amp=4.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 148, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 146 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":148, "input_value":input_value, "op_type":"cosine_transform", 
