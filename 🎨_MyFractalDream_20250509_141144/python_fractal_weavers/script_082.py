...
# Script ID 82: Op 'cosine_transform', Modifiers: angle=6.1, amp=0.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 82, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 75 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":82, "input_value":input_value, "op_type":"cosine_transform", 
