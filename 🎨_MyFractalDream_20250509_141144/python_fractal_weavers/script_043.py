...
# Script ID 43: Op 'sine_transform', Modifiers: angle=1.8, amp=9.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 43, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":43, "input_value":input_value, "op_type":"sine_transform", 
