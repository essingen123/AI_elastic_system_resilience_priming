...
# Script ID 296: Op 'multiply', Modifiers: modifier=2.15
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 296, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":296, "input_value":input_value, "op_type":"multiply", 
