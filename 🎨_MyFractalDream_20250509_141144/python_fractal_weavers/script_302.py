...
# Script ID 302: Op 'divide', Modifiers: modifier=1.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 302, **({"modifier": modifier}))
    ...
    next_call_id_py = 293 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":302, "input_value":input_value, "op_type":"divide", 
