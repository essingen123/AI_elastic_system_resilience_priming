...
# Script ID 152: Op 'modulo_chaos', Modifiers: factor=2, add=-3.4, mod=17.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 152, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 135 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":152, "input_value":input_value, "op_type":"modulo_chaos", 
