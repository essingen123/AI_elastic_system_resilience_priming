...
# Script ID 197: Op 'multiply', Modifiers: modifier=0.9
...
if __name__ == "__main__":
    ...
    next_call_id_py = 205 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":197, "input_value":input_value, "op_type":"multiply", 
