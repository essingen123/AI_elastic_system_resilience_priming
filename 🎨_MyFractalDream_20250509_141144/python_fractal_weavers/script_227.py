...
# Script ID 227: Op 'spiral_step_x', Modifiers: angle_rate=0.42, step_size=2.2
...
if __name__ == "__main__":
    ...
    modifier_angle_rate = 0.42
    modifier_step_size = 2.2

    
    output_value = perform_operation(input_value, current_depth, 227, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":227, "input_value":input_value, "op_type":"spiral_step_x", 
