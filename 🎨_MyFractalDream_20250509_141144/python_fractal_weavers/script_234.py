...
# Script ID 234: Op 'modulo_chaos', Modifiers: factor=2.1, add=1.7, mod=13.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 234, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":234, "input_value":input_value, "op_type":"modulo_chaos", 
