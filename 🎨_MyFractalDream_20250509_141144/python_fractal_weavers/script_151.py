...
# Script ID 151: Op 'multiply', Modifiers: modifier=1.95
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 151, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":151, "input_value":input_value, "op_type":"multiply", 
