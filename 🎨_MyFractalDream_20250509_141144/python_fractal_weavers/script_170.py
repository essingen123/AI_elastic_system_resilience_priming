...
# Script ID 170: Op 'logistic_map', Modifiers: r=3.96, limit=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 170, **({"modifier_r": modifier_r, "modifier_limit": modifier_limit}))
    ...
    next_call_id_py = 150 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":170, "input_value":input_value, "op_type":"logistic_map", 
