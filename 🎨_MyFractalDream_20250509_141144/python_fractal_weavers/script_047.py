...
# Script ID 47: Op 'subtract', Modifiers: modifier=-3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 47, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":47, "input_value":input_value, "op_type":"subtract", 
