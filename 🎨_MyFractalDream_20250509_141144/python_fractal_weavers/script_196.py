...
# Script ID 196: Op 'cosine_transform', Modifiers: angle=4, amp=8.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 196, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 171 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":196, "input_value":input_value, "op_type":"cosine_transform", 
