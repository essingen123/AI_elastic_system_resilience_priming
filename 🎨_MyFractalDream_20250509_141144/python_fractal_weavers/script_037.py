...
# Script ID 37: Op 'subtract', Modifiers: modifier=-4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 37, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":37, "input_value":input_value, "op_type":"subtract", 
