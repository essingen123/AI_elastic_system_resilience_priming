...
# Script ID 23: Op 'cosine_transform', Modifiers: angle=1.3, amp=2.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 23, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 1 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":23, "input_value":input_value, "op_type":"cosine_transform", 
