...
# Script ID 180: Op 'sine_transform', Modifiers: angle=2.3, amp=7.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 180, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":180, "input_value":input_value, "op_type":"sine_transform", 
