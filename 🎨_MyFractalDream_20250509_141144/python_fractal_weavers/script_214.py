...
# Script ID 214: Op 'power_clip', Modifiers: modifier=0.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 214, **({"modifier": modifier}))
    ...
    next_call_id_py = 209 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":214, "input_value":input_value, "op_type":"power_clip", 
