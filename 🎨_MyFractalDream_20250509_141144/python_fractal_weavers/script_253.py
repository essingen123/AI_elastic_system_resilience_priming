...
# Script ID 253: Op 'modulo_chaos', Modifiers: factor=2.3, add=3.7, mod=14.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 253, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 251 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":253, "input_value":input_value, "op_type":"modulo_chaos", 
