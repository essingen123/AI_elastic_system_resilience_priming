...
# Script ID 186: Op 'multiply', Modifiers: modifier=1.85
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 186, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":186, "input_value":input_value, "op_type":"multiply", 
