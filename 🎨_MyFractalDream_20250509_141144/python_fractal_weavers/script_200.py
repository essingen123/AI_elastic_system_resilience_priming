...
# Script ID 200: Op 'cosine_transform', Modifiers: angle=0.6, amp=2.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 200, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":200, "input_value":input_value, "op_type":"cosine_transform", 
