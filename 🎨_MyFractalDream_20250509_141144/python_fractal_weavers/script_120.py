...
# Script ID 120: Op 'divide', Modifiers: modifier=1.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 120, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":120, "input_value":input_value, "op_type":"divide", 
