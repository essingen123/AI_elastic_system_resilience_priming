...
# Script ID 69: Op 'add', Modifiers: modifier=-7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 69, **({"modifier": modifier}))
    ...
    next_call_id_py = 53 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":69, "input_value":input_value, "op_type":"add", 
