...
# Script ID 223: Op 'spiral_step_x', Modifiers: angle_rate=0.18, step_size=4
...
if __name__ == "__main__":
    ...
    modifier_step_size = 4

    
    output_value = perform_operation(input_value, current_depth, 223, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id_py = 237 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":223, "input_value":input_value, "op_type":"spiral_step_x", 
