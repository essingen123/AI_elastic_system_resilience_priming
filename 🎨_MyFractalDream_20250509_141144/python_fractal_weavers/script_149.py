...
# Script ID 149: Op 'modulo_chaos', Modifiers: factor=0.9, add=5, mod=5.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 149, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":149, "input_value":input_value, "op_type":"modulo_chaos", 
