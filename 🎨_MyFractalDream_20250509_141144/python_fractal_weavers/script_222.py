...
# Script ID 222: Op 'add', Modifiers: modifier=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 222, **({"modifier": modifier}))
    ...
    next_call_id_py = 214 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":222, "input_value":input_value, "op_type":"add", 
