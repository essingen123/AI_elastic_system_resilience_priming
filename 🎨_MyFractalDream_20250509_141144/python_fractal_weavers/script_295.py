...
# Script ID 295: Op 'add', Modifiers: modifier=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 295, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":295, "input_value":input_value, "op_type":"add", 
