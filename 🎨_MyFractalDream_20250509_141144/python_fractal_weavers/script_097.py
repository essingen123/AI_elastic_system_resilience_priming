...
# Script ID 97: Op 'multiply', Modifiers: modifier=1.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 97, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":97, "input_value":input_value, "op_type":"multiply", 
