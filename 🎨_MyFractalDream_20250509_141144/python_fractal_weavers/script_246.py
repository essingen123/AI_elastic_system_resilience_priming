...
# Script ID 246: Op 'sine_transform', Modifiers: angle=5.9, amp=2.7
...
if __name__ == "__main__":
    ...
    next_call_id_py = 265 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":246, "input_value":input_value, "op_type":"sine_transform", 
