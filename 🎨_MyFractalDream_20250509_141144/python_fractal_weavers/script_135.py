...
# Script ID 135: Op 'multiply', Modifiers: modifier=1.7
...
if __name__ == "__main__":
    ...
    next_call_id_py = 160 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":135, "input_value":input_value, "op_type":"multiply", 
