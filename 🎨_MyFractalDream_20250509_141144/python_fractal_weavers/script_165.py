...
# Script ID 165: Op 'modulo_chaos', Modifiers: factor=1.2, add=0.9, mod=10.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 165, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 161 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":165, "input_value":input_value, "op_type":"modulo_chaos", 
