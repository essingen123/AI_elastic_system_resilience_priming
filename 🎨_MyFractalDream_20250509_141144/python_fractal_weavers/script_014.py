...
# Script ID 14: Op 'add', Modifiers: modifier=-5
...
if __name__ == "__main__":
    ...
    next_call_id_py = 21 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":14, "input_value":input_value, "op_type":"add", 
