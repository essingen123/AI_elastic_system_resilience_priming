...
# Script ID 143: Op 'cosine_transform', Modifiers: angle=5.5, amp=3.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 143, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":143, "input_value":input_value, "op_type":"cosine_transform", 
