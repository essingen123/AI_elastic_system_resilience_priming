...
# Script ID 79: Op 'divide', Modifiers: modifier=1.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 79, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":79, "input_value":input_value, "op_type":"divide", 
