...
# Script ID 156: Op 'cosine_transform', Modifiers: angle=1.2, amp=3.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 156, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":156, "input_value":input_value, "op_type":"cosine_transform", 
