...
# Script ID 163: Op 'divide', Modifiers: modifier=1.8
...
if __name__ == "__main__":
    ...
    next_call_id_py = 156 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":163, "input_value":input_value, "op_type":"divide", 
