...
# Script ID 117: Op 'sine_transform', Modifiers: angle=4, amp=9.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 117, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":117, "input_value":input_value, "op_type":"sine_transform", 
