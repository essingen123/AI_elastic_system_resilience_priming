...
# Script ID 167: Op 'spiral_step_y', Modifiers: angle_rate=0.37, step_size=1
...
if __name__ == "__main__":
    ...
    modifier_angle_rate = 0.37
    modifier_step_size = 1

    
    output_value = perform_operation(input_value, current_depth, 167, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":167, "input_value":input_value, "op_type":"spiral_step_y", 
