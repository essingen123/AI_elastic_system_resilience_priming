...
# Script ID 169: Op 'spiral_step_x', Modifiers: angle_rate=0.33, step_size=4.7
...
if __name__ == "__main__":
    ...
    modifier_angle_rate = 0.33
    modifier_step_size = 4.7

    
    output_value = perform_operation(input_value, current_depth, 169, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":169, "input_value":input_value, "op_type":"spiral_step_x", 
