...
# Script ID 286: Op 'spiral_step_x', Modifiers: angle_rate=0.25, step_size=1.2
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 286})); sys.exit(1)
    ...
    modifier_angle_rate = 0.25
    modifier_step_size = 1.2

    
    output_value = perform_operation(input_value, current_depth, 286, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id_py = 276 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":286, "input_value":input_value, "op_type":"spiral_step_x", 
