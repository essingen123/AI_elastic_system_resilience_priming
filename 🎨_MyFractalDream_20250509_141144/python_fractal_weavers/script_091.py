...
# Script ID 91: Op 'modulo_chaos', Modifiers: factor=1.1, add=4.6, mod=17.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 91, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 99 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":91, "input_value":input_value, "op_type":"modulo_chaos", 
