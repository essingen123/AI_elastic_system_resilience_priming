...
# Script ID 119: Op 'multiply', Modifiers: modifier=1.05
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 119, **({"modifier": modifier}))
    ...
    next_call_id_py = 108 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":119, "input_value":input_value, "op_type":"multiply", 
