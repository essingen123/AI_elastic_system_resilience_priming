...
# Script ID 228: Op 'multiply', Modifiers: modifier=2.15
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 228, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":228, "input_value":input_value, "op_type":"multiply", 
