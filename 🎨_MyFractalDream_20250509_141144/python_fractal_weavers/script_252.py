...
# Script ID 252: Op 'multiply', Modifiers: modifier=0.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 252, **({"modifier": modifier}))
    ...
    next_call_id_py = 256 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":252, "input_value":input_value, "op_type":"multiply", 
