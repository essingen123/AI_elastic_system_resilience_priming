...
# Script ID 138: Op 'add', Modifiers: modifier=-3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 138, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":138, "input_value":input_value, "op_type":"add", 
