...
# Script ID 144: Op 'cosine_transform', Modifiers: angle=4.8, amp=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 144, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 140 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":144, "input_value":input_value, "op_type":"cosine_transform", 
