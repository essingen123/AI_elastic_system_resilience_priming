...
# Script ID 218: Op 'subtract', Modifiers: modifier=-1
...
if __name__ == "__main__":
    ...
    next_call_id_py = 203 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":218, "input_value":input_value, "op_type":"subtract", 
