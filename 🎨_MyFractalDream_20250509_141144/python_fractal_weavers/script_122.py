...
# Script ID 122: Op 'multiply', Modifiers: modifier=2.05
op_name = "multiply" # Make op_name available in Python global scope
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 122, **({"modifier": modifier}))
    ...
    next_call_id_py = 128 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":122, "input_value":input_value, "op_type":"multiply", 
