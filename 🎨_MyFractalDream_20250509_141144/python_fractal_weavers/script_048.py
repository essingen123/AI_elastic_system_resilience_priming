...
# Script ID 48: Op 'subtract', Modifiers: modifier=4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 48, **({"modifier": modifier}))
    ...
    next_call_id_py = 24 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":48, "input_value":input_value, "op_type":"subtract", 
