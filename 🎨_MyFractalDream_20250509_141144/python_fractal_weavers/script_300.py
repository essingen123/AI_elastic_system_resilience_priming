...
# Script ID 300: Op 'divide', Modifiers: modifier=2.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 300, **({"modifier": modifier}))
    ...
    next_call_id_py = 279 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":300, "input_value":input_value, "op_type":"divide", 
