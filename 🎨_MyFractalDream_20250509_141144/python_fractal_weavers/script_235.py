...
# Script ID 235: Op 'sine_transform', Modifiers: angle=4.3, amp=2.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 235, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":235, "input_value":input_value, "op_type":"sine_transform", 
