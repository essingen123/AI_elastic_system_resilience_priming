...
# Script ID 140: Op 'spiral_step_y', Modifiers: angle_rate=0.47, step_size=3.2
...
if __name__ == "__main__":
    ...
    modifier_step_size = 3.2

    
    output_value = perform_operation(input_value, current_depth, 140, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":140, "input_value":input_value, "op_type":"spiral_step_y", 
