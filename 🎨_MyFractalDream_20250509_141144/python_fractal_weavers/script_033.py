...
# Script ID 33: Op 'divide', Modifiers: modifier=1.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 33, **({"modifier": modifier}))
    ...
    next_call_id_py = 56 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":33, "input_value":input_value, "op_type":"divide", 
