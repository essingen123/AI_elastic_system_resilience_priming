...
# Script ID 231: Op 'modulo_chaos', Modifiers: factor=0.7, add=-2.1, mod=11.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 231, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 222 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":231, "input_value":input_value, "op_type":"modulo_chaos", 
