...
# Script ID 99: Op 'sine_transform', Modifiers: angle=2.2, amp=1.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 99, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 87 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":99, "input_value":input_value, "op_type":"sine_transform", 
