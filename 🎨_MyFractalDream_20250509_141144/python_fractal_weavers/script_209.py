...
# Script ID 209: Op 'henon_map_x', Modifiers: a=1.37
op_name = "henon_map_x" # Make op_name available in Python global scope
...
def perform_operation(val, current_depth, script_id, **modifiers):
    ...
    try: 
        ...
        return 1.0 - modifier_a * val**2 + prev_val_placeholder
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 209, **({"modifier_a": modifier_a}))
    ...
    next_call_id_py = 236 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":209, "input_value":input_value, "op_type":"henon_map_x", 
        "modifiers_used": {"modifier_a": modifier_a}, "output_value":output_value, 
