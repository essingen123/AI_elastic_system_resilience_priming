...
# Script ID 121: Op 'modulo_chaos', Modifiers: factor=0.5, add=-4.4, mod=18
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 121, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 137 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":121, "input_value":input_value, "op_type":"modulo_chaos", 
