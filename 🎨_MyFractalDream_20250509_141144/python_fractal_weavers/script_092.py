...
# Script ID 92: Op 'divide', Modifiers: modifier=0.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 92, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":92, "input_value":input_value, "op_type":"divide", 
