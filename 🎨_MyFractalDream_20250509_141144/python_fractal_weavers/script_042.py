...
# Script ID 42: Op 'divide', Modifiers: modifier=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 42, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":42, "input_value":input_value, "op_type":"divide", 
