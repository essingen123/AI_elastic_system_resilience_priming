...
# Script ID 102: Op 'power_clip', Modifiers: modifier=0.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 102, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":102, "input_value":input_value, "op_type":"power_clip", 
