...
# Script ID 175: Op 'modulo_chaos', Modifiers: factor=1.6, add=-2.3, mod=16.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 175, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 164 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":175, "input_value":input_value, "op_type":"modulo_chaos", 
