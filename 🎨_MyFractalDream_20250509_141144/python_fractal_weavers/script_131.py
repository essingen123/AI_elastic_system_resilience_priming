...
# Script ID 131: Op 'cosine_transform', Modifiers: angle=5.3, amp=2.8
op_name = "cosine_transform" # Make op_name available in Python global scope
...
def perform_operation(val, current_depth, script_id, **modifiers):
    ...
    try: 
        ...
        return math.cos(val * modifier_angle) * modifier_amp
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 131, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 116 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":"cosine_transform", 
