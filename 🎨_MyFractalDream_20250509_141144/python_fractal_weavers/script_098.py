...
# Script ID 98: Op 'power_clip', Modifiers: modifier=0.85
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 98, **({"modifier": modifier}))
    ...
    next_call_id_py = 83 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":98, "input_value":input_value, "op_type":"power_clip", 
