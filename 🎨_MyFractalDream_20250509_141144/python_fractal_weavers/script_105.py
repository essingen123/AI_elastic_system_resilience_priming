...
# Script ID 105: Op 'divide', Modifiers: modifier=1.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 105, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":105, "input_value":input_value, "op_type":"divide", 
