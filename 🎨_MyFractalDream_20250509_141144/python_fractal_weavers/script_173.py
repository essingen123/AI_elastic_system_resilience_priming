...
# Script ID 173: Op 'cosine_transform', Modifiers: angle=6.1, amp=1.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 173, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":173, "input_value":input_value, "op_type":"cosine_transform", 
