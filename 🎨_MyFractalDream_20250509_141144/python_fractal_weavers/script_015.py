...
# Script ID 15: Op 'add', Modifiers: modifier=-2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 15, **({"modifier": modifier}))
    ...
    next_call_id_py = 5 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":15, "input_value":input_value, "op_type":"add", 
