...
# Script ID 22: Op 'modulo_chaos', Modifiers: factor=2.2, add=3.3, mod=13.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 22, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":22, "input_value":input_value, "op_type":"modulo_chaos", 
