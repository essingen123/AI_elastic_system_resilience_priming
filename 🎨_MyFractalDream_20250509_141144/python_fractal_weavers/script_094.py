...
# Script ID 94: Op 'divide', Modifiers: modifier=1.85
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 94, **({"modifier": modifier}))
    ...
    next_call_id_py = 69 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":94, "input_value":input_value, "op_type":"divide", 
