...
# Script ID 213: Op 'cosine_transform', Modifiers: angle=1.8, amp=7.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 213, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":213, "input_value":input_value, "op_type":"cosine_transform", 
