...
# Script ID 77: Op 'modulo_chaos', Modifiers: factor=1.4, add=3.5, mod=8.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 77, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 82 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":77, "input_value":input_value, "op_type":"modulo_chaos", 
