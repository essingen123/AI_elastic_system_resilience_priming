...
# Script ID 276: Op 'power_clip', Modifiers: modifier=0.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 276, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":276, "input_value":input_value, "op_type":"power_clip", 
