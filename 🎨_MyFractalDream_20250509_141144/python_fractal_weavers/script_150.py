...
# Script ID 150: Op 'sine_transform', Modifiers: angle=3.7, amp=8.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 150, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":150, "input_value":input_value, "op_type":"sine_transform", 
