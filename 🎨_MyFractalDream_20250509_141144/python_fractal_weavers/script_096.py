...
# Script ID 96: Op 'add', Modifiers: modifier=-5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 96, **({"modifier": modifier}))
    ...
    next_call_id_py = 104 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":96, "input_value":input_value, "op_type":"add", 
