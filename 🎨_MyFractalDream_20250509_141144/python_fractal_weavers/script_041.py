...
# Script ID 41: Op 'modulo_chaos', Modifiers: factor=2.4, add=4.8, mod=12
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 41, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id_py = 25 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":41, "input_value":input_value, "op_type":"modulo_chaos", 
