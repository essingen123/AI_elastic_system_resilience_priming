...
# Script ID 164: Op 'spiral_step_y', Modifiers: angle_rate=0.44, step_size=4.7
...
if __name__ == "__main__":
    ...
    modifier_step_size = 4.7

    
    output_value = perform_operation(input_value, current_depth, 164, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    print(json.dumps({
        "script_id":164, "input_value":input_value, "op_type":"spiral_step_y", 
