...
# Script ID 61: Op 'add', Modifiers: modifier=-4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 61, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":61, "input_value":input_value, "op_type":"add", 
