...
# Script ID 191: Op 'sine_transform', Modifiers: angle=0.3, amp=6.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 191, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":191, "input_value":input_value, "op_type":"sine_transform", 
