...
# Script ID 76: Op 'cosine_transform', Modifiers: angle=2.7, amp=2.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 76, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id_py = 103 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":76, "input_value":input_value, "op_type":"cosine_transform", 
