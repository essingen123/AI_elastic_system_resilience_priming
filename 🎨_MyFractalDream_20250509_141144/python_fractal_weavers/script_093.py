...
# Script ID 93: Op 'divide', Modifiers: modifier=1.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 93, **({"modifier": modifier}))
    ...
    next_call_id_py = 91 # This will be 'None' string or a number string
    ...
    print(json.dumps({
        "script_id":93, "input_value":input_value, "op_type":"divide", 
