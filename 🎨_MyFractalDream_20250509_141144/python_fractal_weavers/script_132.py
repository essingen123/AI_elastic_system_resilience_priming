...
# Script ID 132: Op 'cosine_transform', Modifiers: angle=1.5, amp=9.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 132, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":132, "input_value":input_value, "op_type":"cosine_transform", 
