...
# Script ID 152: Op 'subtract', Modifiers: modifier=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 152, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":152, "input_value":input_value, "op_type":"subtract", 
