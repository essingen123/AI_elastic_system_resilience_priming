...
# Script ID 72: Op 'multiply', Modifiers: modifier=1.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 72, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":72, "input_value":input_value, "op_type":"multiply", 
