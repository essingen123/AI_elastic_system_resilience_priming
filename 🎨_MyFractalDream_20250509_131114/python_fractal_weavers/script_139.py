...
# Script ID 139: Op 'divide', Modifiers: modifier=0.35
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 139, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":139, "input_value":input_value, "op_type":"divide", 
