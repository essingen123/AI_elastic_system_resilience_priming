...
# Script ID 113: Op 'subtract', Modifiers: modifier=1
...
if __name__ == "__main__":
    ...
    next_call_id = 97 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":113, "input_value":input_value, "op_type":"subtract", 
