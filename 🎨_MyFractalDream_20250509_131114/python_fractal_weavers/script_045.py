...
# Script ID 45: Op 'multiply', Modifiers: modifier=2.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 45, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":45, "input_value":input_value, "op_type":"multiply", 
