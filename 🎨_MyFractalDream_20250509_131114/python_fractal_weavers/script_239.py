...
# Script ID 239: Op 'multiply', Modifiers: modifier=1.8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 239, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":239, "input_value":input_value, "op_type":"multiply", 
