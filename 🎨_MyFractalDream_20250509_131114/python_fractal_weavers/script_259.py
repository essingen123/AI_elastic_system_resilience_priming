...
# Script ID 259: Op 'sine_transform', Modifiers: angle=2, amp=8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 259, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":259, "input_value":input_value, "op_type":"sine_transform", 
