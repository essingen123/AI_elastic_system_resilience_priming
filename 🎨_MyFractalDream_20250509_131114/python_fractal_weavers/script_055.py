...
# Script ID 55: Op 'add', Modifiers: modifier=3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 55, **({"modifier": modifier}))
    ...
    next_call_id = 25 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":55, "input_value":input_value, "op_type":"add", 
