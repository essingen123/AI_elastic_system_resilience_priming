...
# Script ID 291: Op 'multiply', Modifiers: modifier=1.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 291, **({"modifier": modifier}))
    ...
    next_call_id = 296 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":291, "input_value":input_value, "op_type":"multiply", 
