...
# Script ID 212: Op 'power_clip', Modifiers: modifier=0.75
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 212, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":212, "input_value":input_value, "op_type":"power_clip", 
