...
# Script ID 276: Op 'multiply', Modifiers: modifier=1.05
...
if __name__ == "__main__":
    ...
    next_call_id = 248 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":276, "input_value":input_value, "op_type":"multiply", 
