...
# Script ID 257: Op 'modulo_chaos', Modifiers: factor=2.4, add=-1, mod=7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 257, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id = 255 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":257, "input_value":input_value, "op_type":"modulo_chaos", 
