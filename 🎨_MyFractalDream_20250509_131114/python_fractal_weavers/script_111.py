...
# Script ID 111: Op 'modulo_chaos', Modifiers: factor=2, add=-4, mod=15
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 111, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id = 126 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":111, "input_value":input_value, "op_type":"modulo_chaos", 
