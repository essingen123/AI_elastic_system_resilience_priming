...
# Script ID 161: Op 'divide', Modifiers: modifier=2.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 161, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":161, "input_value":input_value, "op_type":"divide", 
