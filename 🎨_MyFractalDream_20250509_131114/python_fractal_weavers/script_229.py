...
# Script ID 229: Op 'divide', Modifiers: modifier=2.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 229, **({"modifier": modifier}))
    ...
    next_call_id = 223 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":229, "input_value":input_value, "op_type":"divide", 
