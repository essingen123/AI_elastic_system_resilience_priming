...
# Script ID 86: Op 'divide', Modifiers: modifier=2.25
...
if __name__ == "__main__":
    ...
    next_call_id = 69 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":86, "input_value":input_value, "op_type":"divide", 
