...
# Script ID 64: Op 'subtract', Modifiers: modifier=-2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 64, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":64, "input_value":input_value, "op_type":"subtract", 
