...
# Script ID 164: Op 'power_clip', Modifiers: modifier=1.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 164, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":164, "input_value":input_value, "op_type":"power_clip", 
