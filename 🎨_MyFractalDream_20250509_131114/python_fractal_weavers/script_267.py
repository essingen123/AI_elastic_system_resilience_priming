...
# Script ID 267: Op 'subtract', Modifiers: modifier=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 267, **({"modifier": modifier}))
    ...
    next_call_id = 263 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":267, "input_value":input_value, "op_type":"subtract", 
