...
# Script ID 300: Op 'modulo_chaos', Modifiers: factor=0.8, add=-2, mod=18
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 300, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":300, "input_value":input_value, "op_type":"modulo_chaos", 
