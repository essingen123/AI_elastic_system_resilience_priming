...
# Script ID 174: Op 'power_clip', Modifiers: modifier=1.55
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 174, **({"modifier": modifier}))
    ...
    next_call_id = 145 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":174, "input_value":input_value, "op_type":"power_clip", 
