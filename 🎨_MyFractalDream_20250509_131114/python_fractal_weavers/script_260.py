...
# Script ID 260: Op 'subtract', Modifiers: modifier=-6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 260, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":260, "input_value":input_value, "op_type":"subtract", 
