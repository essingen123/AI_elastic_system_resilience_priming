...
# Script ID 288: Op 'multiply', Modifiers: modifier=2.35
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 288, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":288, "input_value":input_value, "op_type":"multiply", 
