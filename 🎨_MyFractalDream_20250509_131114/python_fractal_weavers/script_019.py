...
# Script ID 19: Op 'divide', Modifiers: modifier=0.35
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 19, **({"modifier": modifier}))
    ...
    next_call_id = 44 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":19, "input_value":input_value, "op_type":"divide", 
