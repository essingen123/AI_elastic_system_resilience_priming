...
# Script ID 65: Op 'divide', Modifiers: modifier=2.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 65, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":65, "input_value":input_value, "op_type":"divide", 
