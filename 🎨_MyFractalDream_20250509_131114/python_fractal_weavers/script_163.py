...
# Script ID 163: Op 'spiral_step_y', Modifiers: angle_rate=0.05, step_size=4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 163, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id = 148 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":163, "input_value":input_value, "op_type":"spiral_step_y", 
