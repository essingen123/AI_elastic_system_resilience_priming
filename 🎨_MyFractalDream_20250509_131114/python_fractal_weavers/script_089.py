...
# Script ID 89: Op 'add', Modifiers: modifier=7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 89, **({"modifier": modifier}))
    ...
    next_call_id = 63 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":89, "input_value":input_value, "op_type":"add", 
