...
# Script ID 193: Op 'power_clip', Modifiers: modifier=1.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 193, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":193, "input_value":input_value, "op_type":"power_clip", 
