...
# Script ID 101: Op 'sine_transform', Modifiers: angle=1.5, amp=0
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 101, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":"sine_transform", 
