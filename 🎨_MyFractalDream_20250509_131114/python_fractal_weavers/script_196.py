...
# Script ID 196: Op 'spiral_step_x', Modifiers: angle_rate=0.39, step_size=0
...
if __name__ == "__main__":
    ...
    next_call_id = 222 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":196, "input_value":input_value, "op_type":"spiral_step_x", 
