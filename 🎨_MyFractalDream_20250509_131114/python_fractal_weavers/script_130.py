...
# Script ID 130: Op 'modulo_chaos', Modifiers: factor=1.9, add=-2, mod=20
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 130, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":130, "input_value":input_value, "op_type":"modulo_chaos", 
