...
# Script ID 236: Op 'multiply', Modifiers: modifier=0.75
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 236, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":236, "input_value":input_value, "op_type":"multiply", 
