...
# Script ID 41: Op 'cosine_transform', Modifiers: angle=1.7, amp=2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 41, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":41, "input_value":input_value, "op_type":"cosine_transform", 
