...
# Script ID 145: Op 'divide', Modifiers: modifier=1.25
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 145, **({"modifier": modifier}))
    ...
    next_call_id = 143 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":145, "input_value":input_value, "op_type":"divide", 
