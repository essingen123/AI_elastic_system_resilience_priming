...
# Script ID 208: Op 'multiply', Modifiers: modifier=0.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 208, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":208, "input_value":input_value, "op_type":"multiply", 
