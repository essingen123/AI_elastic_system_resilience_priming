...
# Script ID 242: Op 'modulo_chaos', Modifiers: factor=1.1, add=-4, mod=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 242, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":242, "input_value":input_value, "op_type":"modulo_chaos", 
