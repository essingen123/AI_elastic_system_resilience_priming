...
# Script ID 247: Op 'power_clip', Modifiers: modifier=0.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 247, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":247, "input_value":input_value, "op_type":"power_clip", 
