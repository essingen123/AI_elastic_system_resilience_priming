...
# Script ID 182: Op 'modulo_chaos', Modifiers: factor=0.6, add=0, mod=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 182, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":182, "input_value":input_value, "op_type":"modulo_chaos", 
