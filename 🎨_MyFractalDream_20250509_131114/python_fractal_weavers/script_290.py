...
# Script ID 290: Op 'sine_transform', Modifiers: angle=0.2, amp=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 290, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":290, "input_value":input_value, "op_type":"sine_transform", 
