...
# Script ID 162: Op 'power_clip', Modifiers: modifier=1.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 162, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":162, "input_value":input_value, "op_type":"power_clip", 
