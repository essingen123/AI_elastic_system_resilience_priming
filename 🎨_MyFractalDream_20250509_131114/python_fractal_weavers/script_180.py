...
# Script ID 180: Op 'divide', Modifiers: modifier=0.25
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 180, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":180, "input_value":input_value, "op_type":"divide", 
