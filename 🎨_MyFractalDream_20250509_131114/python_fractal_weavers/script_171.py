...
# Script ID 171: Op 'divide', Modifiers: modifier=2.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 171, **({"modifier": modifier}))
    ...
    next_call_id = 175 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":171, "input_value":input_value, "op_type":"divide", 
