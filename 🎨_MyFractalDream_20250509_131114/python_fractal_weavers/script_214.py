...
# Script ID 214: Op 'spiral_step_y', Modifiers: angle_rate=0.29, step_size=0
...
if __name__ == "__main__":
    ...
    next_call_id = 235 if current_depth < max_allowed_depth and 1 else None
