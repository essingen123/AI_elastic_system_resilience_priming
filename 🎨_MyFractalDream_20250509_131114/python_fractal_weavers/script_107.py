...
# Script ID 107: Op 'sine_transform', Modifiers: angle=2, amp=6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 107, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id = 86 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":107, "input_value":input_value, "op_type":"sine_transform", 
