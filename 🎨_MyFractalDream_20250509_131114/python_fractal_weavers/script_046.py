...
# Script ID 46: Op 'multiply', Modifiers: modifier=0.95
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 46, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":46, "input_value":input_value, "op_type":"multiply", 
