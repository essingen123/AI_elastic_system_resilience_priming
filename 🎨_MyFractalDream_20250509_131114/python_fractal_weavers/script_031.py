...
# Script ID 31: Op 'add', Modifiers: modifier=-1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 31, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":31, "input_value":input_value, "op_type":"add", 
