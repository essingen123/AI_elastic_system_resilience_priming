...
# Script ID 274: Op 'cosine_transform', Modifiers: angle=0.4, amp=7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 274, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    print(json.dumps({
        "script_id":274, "input_value":input_value, "op_type":"cosine_transform", 
