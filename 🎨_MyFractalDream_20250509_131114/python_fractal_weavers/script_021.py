...
# Script ID 21: Op 'spiral_step_x', Modifiers: angle_rate=0.08, step_size=5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 21, **({"modifier_angle_rate": modifier_angle_rate, "modifier_step_size": modifier_step_size}))
    ...
    next_call_id = 45 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":21, "input_value":input_value, "op_type":"spiral_step_x", 
