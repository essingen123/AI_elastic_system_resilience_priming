...
# Script ID 153: Op 'modulo_chaos', Modifiers: factor=2.5, add=-2, mod=7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 153, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    print(json.dumps({
        "script_id":153, "input_value":input_value, "op_type":"modulo_chaos", 
