...
# Script ID 50: Op 'power_clip', Modifiers: modifier=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 50, **({"modifier": modifier}))
    ...
    next_call_id = 47 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":50, "input_value":input_value, "op_type":"power_clip", 
