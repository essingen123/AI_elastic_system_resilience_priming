...
# Script ID 244: Op 'divide', Modifiers: modifier=1.05
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 244, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":244, "input_value":input_value, "op_type":"divide", 
