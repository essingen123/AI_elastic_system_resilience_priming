...
# Script ID 88: Op 'divide', Modifiers: modifier=2.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 88, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":88, "input_value":input_value, "op_type":"divide", 
