...
# Script ID 5: Op 'divide', Modifiers: modifier=1.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 5, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":5, "input_value":input_value, "op_type":"divide", 
