...
# Script ID 54: Op 'subtract', Modifiers: modifier=-1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 54, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":54, "input_value":input_value, "op_type":"subtract", 
