...
# Script ID 136: Op 'power_clip', Modifiers: modifier=0.85
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 136, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":"power_clip", 
