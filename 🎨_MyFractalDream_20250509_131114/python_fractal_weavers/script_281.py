...
# Script ID 281: Op 'cosine_transform', Modifiers: angle=0.9, amp=8
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 281, **({"modifier_angle": modifier_angle, "modifier_amp": modifier_amp}))
    ...
    next_call_id = 285 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":281, "input_value":input_value, "op_type":"cosine_transform", 
