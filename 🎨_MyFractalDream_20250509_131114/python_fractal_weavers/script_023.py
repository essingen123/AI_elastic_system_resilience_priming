...
# Script ID 23: Op 'henon_map_x', Modifiers: a=1.2
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 23, **({"modifier_a": modifier_a}))
    ...
    next_call_id = 26 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":23, "input_value":input_value, "op_type":"henon_map_x", 
