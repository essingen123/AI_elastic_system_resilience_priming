...
# Script ID 166: Op 'power_clip', Modifiers: modifier=0.6
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 166, **({"modifier": modifier}))
    ...
    print(json.dumps({
        "script_id":166, "input_value":input_value, "op_type":"power_clip", 
