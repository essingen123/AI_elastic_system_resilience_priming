...
# Script ID 132: Op 'power_clip', Modifiers: modifier=1.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 132, **({"modifier": modifier}))
    ...
    next_call_id = 133 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":132, "input_value":input_value, "op_type":"power_clip", 
