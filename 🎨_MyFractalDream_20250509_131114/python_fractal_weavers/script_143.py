...
# Script ID 143: Op 'logistic_map', Modifiers: r=3.98, limit=1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 143, **({"modifier_r": modifier_r, "modifier_limit": modifier_limit}))
    ...
    next_call_id = 166 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":143, "input_value":input_value, "op_type":"logistic_map", 
