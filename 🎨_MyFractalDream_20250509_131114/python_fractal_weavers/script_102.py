...
# Script ID 102: Op 'divide', Modifiers: modifier=1.9
...
if __name__ == "__main__":
    ...
    next_call_id = 90 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":102, "input_value":input_value, "op_type":"divide", 
