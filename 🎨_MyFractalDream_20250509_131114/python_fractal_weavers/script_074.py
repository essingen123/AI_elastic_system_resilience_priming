...
# Script ID 74: Op 'subtract', Modifiers: modifier=6
...
if __name__ == "__main__":
    ...
    next_call_id = 73 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":74, "input_value":input_value, "op_type":"subtract", 
