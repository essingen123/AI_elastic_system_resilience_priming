...
# Script ID 167: Op 'modulo_chaos', Modifiers: factor=1.6, add=5, mod=14
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 167, **({"modifier_factor": modifier_factor, "modifier_add": modifier_add, "modifier_mod": modifier_mod}))
    ...
    next_call_id = 157 if current_depth < max_allowed_depth and 1 else None
    ...
    print(json.dumps({
        "script_id":167, "input_value":input_value, "op_type":"modulo_chaos", 
