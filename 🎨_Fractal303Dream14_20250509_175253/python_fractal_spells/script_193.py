...
# Script ID 193: Op 'sine_power_mix', Modifiers: freq1=1.04, pow1=2, amp1=2.9, freq2=1.14, pow2=1, amp2=4.8
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.04)
    modifier_pow1 = float(2)
    modifier_amp1 = float(2.9)
    modifier_freq2 = float(1.14)
    ...
    output_value = perform_operation(input_value, current_depth, 193, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":193, "input_value":input_value, "op_type":"sine_power_mix", 
