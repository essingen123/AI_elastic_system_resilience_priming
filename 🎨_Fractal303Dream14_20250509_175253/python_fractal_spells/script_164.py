...
# Script ID 164: Op 'sine_power_mix', Modifiers: freq1=1.05, pow1=1, amp1=4.2, freq2=2.44, pow2=3, amp2=4.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 164, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":164, "input_value":input_value, "op_type":"sine_power_mix", 
