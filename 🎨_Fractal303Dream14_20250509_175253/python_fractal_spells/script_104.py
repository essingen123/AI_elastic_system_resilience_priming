...
# Script ID 104: Op 'de_jong_attractor_y', Modifiers: c=-2.29, d=1.52
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 104, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":104, "input_value":input_value, "op_type":"de_jong_attractor_y", 
