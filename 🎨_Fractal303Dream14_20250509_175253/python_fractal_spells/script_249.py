...
# Script ID 249: Op 'sine_power_mix', Modifiers: freq1=2.47, pow1=1, amp1=2.4, freq2=0.45, pow2=3, amp2=4.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 249, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":249, "input_value":input_value, "op_type":"sine_power_mix", 
