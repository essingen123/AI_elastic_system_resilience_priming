...
# Script ID 150: Op 'logistic_growth', Modifiers: r=3.077, k=20
...
if __name__ == "__main__":
    ...
    modifier_r = float(3.077)
    modifier_k = float(20)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 150, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":150, "input_value":input_value, "op_type":"logistic_growth", 
