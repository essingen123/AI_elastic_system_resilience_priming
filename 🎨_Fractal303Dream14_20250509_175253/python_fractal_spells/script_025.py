...
# Script ID 25: Op 'sine_power_mix', Modifiers: freq1=2.45, pow1=1, amp1=2.3, freq2=0.48, pow2=2, amp2=0.8
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.45)
    modifier_pow1 = float(1)
    modifier_amp1 = float(2.3)
    modifier_freq2 = float(0.48)
    ...
    output_value = perform_operation(input_value, current_depth, 25, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":25, "input_value":input_value, "op_type":"sine_power_mix", 
