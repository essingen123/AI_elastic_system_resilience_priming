...
# Script ID 134: Op 'de_jong_attractor_x', Modifiers: a=2.83, b=2.53
...
if __name__ == "__main__":
    ...
    modifier_a = float(2.83)
    modifier_b = float(2.53)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 134, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":134, "input_value":input_value, "op_type":"de_jong_attractor_x", 
