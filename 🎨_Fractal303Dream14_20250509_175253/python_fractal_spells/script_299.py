...
# Script ID 299: Op 'sine_power_mix', Modifiers: freq1=1.92, pow1=3, amp1=4.7, freq2=1.56, pow2=3, amp2=2.5
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 299, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":299, "input_value":input_value, "op_type":"sine_power_mix", 
