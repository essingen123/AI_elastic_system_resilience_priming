...
# Script ID 67: Op 'de_jong_attractor_y', Modifiers: c=-0.24, d=-2.61
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 67, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":67, "input_value":input_value, "op_type":"de_jong_attractor_y", 
