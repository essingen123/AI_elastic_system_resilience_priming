...
# Script ID 17: Op 'sine_power_mix', Modifiers: freq1=1.06, pow1=2, amp1=4.3, freq2=0.41, pow2=1, amp2=1.7
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.06)
    modifier_pow1 = float(2)
    modifier_amp1 = float(4.3)
    modifier_freq2 = float(0.41)
    ...
    output_value = perform_operation(input_value, current_depth, 17, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":17, "input_value":input_value, "op_type":"sine_power_mix", 
