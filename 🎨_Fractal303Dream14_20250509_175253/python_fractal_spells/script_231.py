...
# Script ID 231: Op 'sine_power_mix', Modifiers: freq1=0.44, pow1=3, amp1=5, freq2=0.75, pow2=1, amp2=1.1
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.44)
    modifier_pow1 = float(3)
    modifier_amp1 = float(5)
    modifier_freq2 = float(0.75)
    modifier_pow2 = float(1)
    modifier_amp2 = float(1.1)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 231, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":231, "input_value":input_value, "op_type":"sine_power_mix", 
