...
# Script ID 83: Op 'sine_power_mix', Modifiers: freq1=1.56, pow1=2, amp1=2.2, freq2=1.07, pow2=2, amp2=0.6
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 83, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":83, "input_value":input_value, "op_type":"sine_power_mix", 
