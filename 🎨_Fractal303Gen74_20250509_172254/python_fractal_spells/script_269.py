...
# Script ID 269: Op 'sine_power_mix', Modifiers: freq1=2.71, pow1=2, amp1=4.4, freq2=1.92, pow2=3, amp2=2.2
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 269, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":269, "input_value":input_value, "op_type":"sine_power_mix", 
