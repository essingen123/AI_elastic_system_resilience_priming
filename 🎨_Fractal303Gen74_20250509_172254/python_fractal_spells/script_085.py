...
# Script ID 85: Op 'de_jong_attractor_y', Modifiers: c=-2.01, d=1.17
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 85, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":85, "input_value":input_value, "op_type":"de_jong_attractor_y", 
