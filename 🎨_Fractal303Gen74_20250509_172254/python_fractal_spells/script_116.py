...
# Script ID 116: Op 'coupled_logistic_x', Modifiers: rx=3.675, cxy=0.069
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.675)
    modifier_cxy = float(0.069)
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 116, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":116, "input_value":input_value, "op_type":"coupled_logistic_x", 
