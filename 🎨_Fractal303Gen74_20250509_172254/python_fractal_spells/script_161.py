...
# Script ID 161: Op 'sine_power_mix', Modifiers: freq1=0.95, pow1=3, amp1=4.1, freq2=1.33, pow2=1, amp2=3.1
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.95)
    modifier_pow1 = float(3)
    modifier_amp1 = float(4.1)
    modifier_freq2 = float(1.33)
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 161, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":161, "input_value":input_value, "op_type":"sine_power_mix", 
