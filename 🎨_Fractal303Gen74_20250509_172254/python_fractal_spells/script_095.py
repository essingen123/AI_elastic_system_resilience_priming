...
# Script ID 95: Op 'sine_power_mix', Modifiers: freq1=2.77, pow1=3, amp1=4.5, freq2=1.17, pow2=3, amp2=4.4
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 95, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":95, "input_value":input_value, "op_type":"sine_power_mix", 
