...
# Script ID 18: Op 'de_jong_attractor_y', Modifiers: c=-1.16, d=1.02
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 18, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":18, "input_value":input_value, "op_type":"de_jong_attractor_y", 
