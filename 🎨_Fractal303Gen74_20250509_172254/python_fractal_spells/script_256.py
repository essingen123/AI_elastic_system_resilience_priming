...
# Script ID 256: Op 'de_jong_attractor_y', Modifiers: c=2.96, d=1.84
...
if __name__ == "__main__":
    ...
    modifier_c = float(2.96)
    modifier_d = float(1.84)
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 256, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":256, "input_value":input_value, "op_type":"de_jong_attractor_y", 
