...
# Script ID 131: Op 'clifford_attractor_x', Modifiers: a=1.77, c=1.46
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 131, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":"clifford_attractor_x", 
