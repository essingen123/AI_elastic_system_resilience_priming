...
# Script ID 125: Op 'de_jong_attractor_x', Modifiers: a=-1.01, b=-2.4
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 125, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":125, "input_value":input_value, "op_type":"de_jong_attractor_x", 
