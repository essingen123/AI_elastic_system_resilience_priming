...
# Script ID 101: Op 'clifford_attractor_x', Modifiers: a=0.29, c=-0.02
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 101, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":"clifford_attractor_x", 
