...
# Script ID 270: Op 'de_jong_attractor_y', Modifiers: c=1.05, d=0.08
...
if __name__ == "__main__":
    ...
    modifier_c = float(1.05)
    modifier_d = float(0.08)
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 270, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":270, "input_value":input_value, "op_type":"de_jong_attractor_y", 
