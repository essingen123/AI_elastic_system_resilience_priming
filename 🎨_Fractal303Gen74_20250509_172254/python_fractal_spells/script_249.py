...
# Script ID 249: Op 'clifford_attractor_x', Modifiers: a=1.04, c=0.25
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 249, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":249, "input_value":input_value, "op_type":"clifford_attractor_x", 
