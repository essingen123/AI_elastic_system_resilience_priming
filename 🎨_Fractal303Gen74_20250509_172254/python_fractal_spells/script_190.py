...
# Script ID 190: Op 'swirl_step', Modifiers: strength=5.8
op_name = "swirl_step" 
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 190, prev_val_placeholder_py, **({"modifier_strength": modifier_strength}))
    ...
    print(json.dumps({
        "script_id":190, "input_value":input_value, "op_type":"swirl_step", 
