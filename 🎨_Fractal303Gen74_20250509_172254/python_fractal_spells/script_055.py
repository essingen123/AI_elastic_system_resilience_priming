...
# Script ID 55: Op 'de_jong_attractor_y', Modifiers: c=1.32, d=1.34
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 55, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":55, "input_value":input_value, "op_type":"de_jong_attractor_y", 
