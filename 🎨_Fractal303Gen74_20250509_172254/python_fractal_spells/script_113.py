...
# Script ID 113: Op 'clifford_attractor_y', Modifiers: b=-0.49, d=1.91
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 113, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":113, "input_value":input_value, "op_type":"clifford_attractor_y", 
