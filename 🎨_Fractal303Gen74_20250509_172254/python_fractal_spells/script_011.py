...
# Script ID 11: Op 'coupled_logistic_x', Modifiers: rx=3.939, cxy=0.189
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 11, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":11, "input_value":input_value, "op_type":"coupled_logistic_x", 
