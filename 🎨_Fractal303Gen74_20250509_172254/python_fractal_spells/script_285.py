...
# Script ID 285: Op 'lyapunov_exponent_approx', Modifiers: r=3.695
...
if __name__ == "__main__":
    if len(sys.argv) < 5: print(json.dumps({"error": "Insufficient args", "script_id": 285})); sys.exit(1)
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 285, prev_val_placeholder_py, **({"modifier_r": modifier_r}))
    ...
    print(json.dumps({
        "script_id":285, "input_value":input_value, "op_type":"lyapunov_exponent_approx", 
