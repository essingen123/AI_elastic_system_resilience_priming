...
# Script ID 119: Op 'sine_power_mix', Modifiers: freq1=2.12, pow1=1, amp1=1.7, freq2=2.74, pow2=3, amp2=0.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.12)
    modifier_pow1 = float(1)
    modifier_amp1 = float(1.7)
    modifier_freq2 = float(2.74)
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 119, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":119, "input_value":input_value, "op_type":"sine_power_mix", 
