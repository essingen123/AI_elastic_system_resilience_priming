...
# Script ID 205: Op 'de_jong_attractor_y', Modifiers: c=-0.11, d=-0.61
...
if __name__ == "__main__":
    ...
    modifier_c = float(-0.11)
    modifier_d = float(-0.61)
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 205, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":205, "input_value":input_value, "op_type":"de_jong_attractor_y", 
