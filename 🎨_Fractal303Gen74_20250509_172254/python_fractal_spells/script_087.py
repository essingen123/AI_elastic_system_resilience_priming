...
# Script ID 87: Op 'coupled_logistic_x', Modifiers: rx=3.579, cxy=0.179
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 87, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":87, "input_value":input_value, "op_type":"coupled_logistic_x", 
