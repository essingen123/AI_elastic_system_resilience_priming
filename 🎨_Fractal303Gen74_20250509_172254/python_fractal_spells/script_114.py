...
# Script ID 114: Op 'coupled_logistic_x', Modifiers: rx=3.983, cxy=0.091
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 114, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":114, "input_value":input_value, "op_type":"coupled_logistic_x", 
