...
# Script ID 172: Op 'swirl_step', Modifiers: strength=5.2
op_name = "swirl_step" 
...
if __name__ == "__main__":
 ...
 # PHP injects modifier assignments here.
    ...
    output_value = perform_operation(input_value, current_depth, 172, prev_val_placeholder_py, **({"modifier_strength": modifier_strength}))
    ...
    print(json.dumps({
        "script_id":172, "input_value":input_value, "op_type":"swirl_step", 
