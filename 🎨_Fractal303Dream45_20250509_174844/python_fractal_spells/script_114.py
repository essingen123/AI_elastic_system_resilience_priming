...
# Script ID 114: Op 'sine_power_mix', Modifiers: freq1=2.47, pow1=2, amp1=0.6, freq2=2.82, pow2=3, amp2=3.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 114, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":114, "input_value":input_value, "op_type":"sine_power_mix", 
