...
# Script ID 234: Op 'sine_power_mix', Modifiers: freq1=0.72, pow1=2, amp1=3.7, freq2=1.05, pow2=1, amp2=3.7
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 234, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":234, "input_value":input_value, "op_type":"sine_power_mix", 
