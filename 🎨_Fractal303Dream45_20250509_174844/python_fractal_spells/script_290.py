...
# Script ID 290: Op 'sine_power_mix', Modifiers: freq1=0.14, pow1=3, amp1=0.8, freq2=0.26, pow2=3, amp2=2
...
if __name__ == "__main__":
    ...
    modifier_freq2 = float(0.26)
    modifier_pow2 = float(3)
    modifier_amp2 = float(2)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 290, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":290, "input_value":input_value, "op_type":"sine_power_mix", 
