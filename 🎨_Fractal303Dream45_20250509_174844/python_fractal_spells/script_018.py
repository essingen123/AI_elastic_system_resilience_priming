...
# Script ID 18: Op 'sine_power_mix', Modifiers: freq1=1.3, pow1=3, amp1=1.5, freq2=2.95, pow2=3, amp2=1.1
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.3)
    modifier_pow1 = float(3)
    modifier_amp1 = float(1.5)
    modifier_freq2 = float(2.95)
    ...
    output_value = perform_operation(input_value, current_depth, 18, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":18, "input_value":input_value, "op_type":"sine_power_mix", 
