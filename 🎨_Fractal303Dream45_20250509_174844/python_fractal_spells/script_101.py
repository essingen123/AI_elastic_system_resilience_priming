...
# Script ID 101: Op 'de_jong_attractor_x', Modifiers: a=-1.19, b=-2.03
...
if __name__ == "__main__":
    ...
    modifier_a = float(-1.19)
    modifier_b = float(-2.03)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 101, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":"de_jong_attractor_x", 
