...
# Script ID 156: Op 'clifford_attractor_y', Modifiers: b=1.36, d=0.51
...
if __name__ == "__main__":
    ...
    modifier_d = float(0.51)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 156, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":156, "input_value":input_value, "op_type":"clifford_attractor_y", 
