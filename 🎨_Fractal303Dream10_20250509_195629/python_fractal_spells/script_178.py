...
# Script ID 178: Op 'clifford_attractor_x', Modifiers: a=1.79, c=-0.4
...
if __name__ == "__main__":
    ...
    modifier_a = float(1.79)
    modifier_c = float(-0.4)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 178, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":178, "input_value":input_value, "op_type":"clifford_attractor_x", 
