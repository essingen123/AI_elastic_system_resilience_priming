...
# Script ID 200: Op 'logistic_growth', Modifiers: r=3.998, k=55
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 200, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":200, "input_value":input_value, "op_type":"logistic_growth", 
