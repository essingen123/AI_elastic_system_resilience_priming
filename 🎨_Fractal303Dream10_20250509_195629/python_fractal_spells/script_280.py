...
# Script ID 280: Op 'clifford_attractor_y', Modifiers: b=0.63, d=-1.71
...
if __name__ == "__main__":
    ...
    modifier_b = float(0.63)
    modifier_d = float(-1.71)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 280, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":280, "input_value":input_value, "op_type":"clifford_attractor_y", 
