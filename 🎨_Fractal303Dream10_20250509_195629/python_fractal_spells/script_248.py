...
# Script ID 248: Op 'sine_power_mix', Modifiers: freq1=1.35, pow1=1, amp1=2.5, freq2=1.63, pow2=3, amp2=4.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.35)
    modifier_pow1 = float(1)
    modifier_amp1 = float(2.5)
    modifier_freq2 = float(1.63)
    modifier_pow2 = float(3)
    modifier_amp2 = float(4.5)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 248, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":248, "input_value":input_value, "op_type":"sine_power_mix", 
