...
# Script ID 53: Op 'sine_power_mix', Modifiers: freq1=0.62, pow1=2, amp1=4, freq2=2.91, pow2=1, amp2=2.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.62)
    modifier_pow1 = float(2)
    modifier_amp1 = float(4)
    modifier_freq2 = float(2.91)
    modifier_pow2 = float(1)
    modifier_amp2 = float(2.5)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 53, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":53, "input_value":input_value, "op_type":"sine_power_mix", 
