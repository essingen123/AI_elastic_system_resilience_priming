...
# Script ID 97: Op 'coupled_logistic_x', Modifiers: rx=3.779, cxy=0.119
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.779)
    modifier_cxy = float(0.119)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 97, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":97, "input_value":input_value, "op_type":"coupled_logistic_x", 
