...
# Script ID 38: Op 'de_jong_attractor_x', Modifiers: a=-1.86, b=1.37
...
if __name__ == "__main__":
    ...
    modifier_a = float(-1.86)
    modifier_b = float(1.37)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 38, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":38, "input_value":input_value, "op_type":"de_jong_attractor_x", 
