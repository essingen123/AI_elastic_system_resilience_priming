...
# Script ID 194: Op 'clifford_attractor_x', Modifiers: a=-0.84, c=1.43
...
if __name__ == "__main__":
    ...
    modifier_c = float(1.43)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 194, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":194, "input_value":input_value, "op_type":"clifford_attractor_x", 
