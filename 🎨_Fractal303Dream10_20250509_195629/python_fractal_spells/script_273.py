...
# Script ID 273: Op 'lyapunov_exponent_approx', Modifiers: r=3.616
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 273, prev_val_placeholder_py, **({"modifier_r": modifier_r}))
    ...
    print(json.dumps({
        "script_id":273, "input_value":input_value, "op_type":"lyapunov_exponent_approx", 
