...
# Script ID 62: Op 'de_jong_attractor_y', Modifiers: c=0.84, d=0.09
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 62, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":62, "input_value":input_value, "op_type":"de_jong_attractor_y", 
