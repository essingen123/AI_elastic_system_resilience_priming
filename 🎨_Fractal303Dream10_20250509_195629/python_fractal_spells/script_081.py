...
# Script ID 81: Op 'clifford_attractor_x', Modifiers: a=1.29, c=-0.28
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 81, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":81, "input_value":input_value, "op_type":"clifford_attractor_x", 
