...
# Script ID 207: Op 'clifford_attractor_x', Modifiers: a=0.79, c=-1.23
...
if __name__ == "__main__":
    ...
    modifier_c = float(-1.23)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 207, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":207, "input_value":input_value, "op_type":"clifford_attractor_x", 
