...
# Script ID 201: Op 'sine_power_mix', Modifiers: freq1=0.6, pow1=1, amp1=1.3, freq2=2.78, pow2=2, amp2=4.2
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(0.6)
    modifier_pow1 = float(1)
    modifier_amp1 = float(1.3)
    modifier_freq2 = float(2.78)
    modifier_pow2 = float(2)
    modifier_amp2 = float(4.2)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 201, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":201, "input_value":input_value, "op_type":"sine_power_mix", 
