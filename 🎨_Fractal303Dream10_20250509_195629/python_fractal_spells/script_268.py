...
# Script ID 268: Op 'sine_power_mix', Modifiers: freq1=2.17, pow1=1, amp1=3, freq2=2.26, pow2=2, amp2=0.5
...
if __name__ == "__main__":
    ...
    modifier_freq2 = float(2.26)
    modifier_pow2 = float(2)
    modifier_amp2 = float(0.5)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 268, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":268, "input_value":input_value, "op_type":"sine_power_mix", 
