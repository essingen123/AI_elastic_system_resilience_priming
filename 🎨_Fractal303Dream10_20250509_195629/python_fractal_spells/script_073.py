...
# Script ID 73: Op 'clifford_attractor_x', Modifiers: a=-1.32, c=-1.33
...
if __name__ == "__main__":
    ...
    modifier_c = float(-1.33)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 73, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":73, "input_value":input_value, "op_type":"clifford_attractor_x", 
