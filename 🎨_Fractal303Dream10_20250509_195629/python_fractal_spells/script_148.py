...
# Script ID 148: Op 'clifford_attractor_y', Modifiers: b=-1.79, d=-1.8
...
if __name__ == "__main__":
    ...
    modifier_d = float(-1.8)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 148, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":148, "input_value":input_value, "op_type":"clifford_attractor_y", 
