...
# Script ID 299: Op 'clifford_attractor_x', Modifiers: a=-0.44, c=1.02
...
if __name__ == "__main__":
    ...
    modifier_c = float(1.02)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 299, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":299, "input_value":input_value, "op_type":"clifford_attractor_x", 
