...
# Script ID 160: Op 'sine_power_mix', Modifiers: freq1=1.37, pow1=3, amp1=1.4, freq2=0.33, pow2=2, amp2=2.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.37)
    modifier_pow1 = float(3)
    modifier_amp1 = float(1.4)
    modifier_freq2 = float(0.33)
    modifier_pow2 = float(2)
    modifier_amp2 = float(2.6)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 160, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":160, "input_value":input_value, "op_type":"sine_power_mix", 
