...
# Script ID 130: Op 'clifford_attractor_x', Modifiers: a=1.6, c=1.84
...
if __name__ == "__main__":
    ...
    modifier_a = float(1.6)
    modifier_c = float(1.84)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 130, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":130, "input_value":input_value, "op_type":"clifford_attractor_x", 
