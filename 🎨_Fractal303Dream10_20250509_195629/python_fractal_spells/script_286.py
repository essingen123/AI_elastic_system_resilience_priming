...
# Script ID 286: Op 'de_jong_attractor_y', Modifiers: c=-1.79, d=-0.36
...
if __name__ == "__main__":
    ...
    modifier_c = float(-1.79)
    modifier_d = float(-0.36)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 286, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":286, "input_value":input_value, "op_type":"de_jong_attractor_y", 
