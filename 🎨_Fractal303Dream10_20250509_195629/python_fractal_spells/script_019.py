...
# Script ID 19: Op 'sine_power_mix', Modifiers: freq1=0.32, pow1=3, amp1=3.6, freq2=0.44, pow2=3, amp2=4.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 19, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":19, "input_value":input_value, "op_type":"sine_power_mix", 
