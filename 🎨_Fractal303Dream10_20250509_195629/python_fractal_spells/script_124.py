...
# Script ID 124: Op 'sine_power_mix', Modifiers: freq1=0.26, pow1=1, amp1=1.7, freq2=0.83, pow2=1, amp2=1
...
if __name__ == "__main__":
    ...
    modifier_freq2 = float(0.83)
    modifier_pow2 = float(1)
    modifier_amp2 = float(1)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 124, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":124, "input_value":input_value, "op_type":"sine_power_mix", 
