...
# Script ID 101: Op 'clifford_attractor_y', Modifiers: b=1.18, d=1.34
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 101, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":"clifford_attractor_y", 
