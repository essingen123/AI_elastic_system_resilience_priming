...
# Script ID 189: Op 'coupled_logistic_x', Modifiers: rx=3.587, cxy=0.129
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.587)
    modifier_cxy = float(0.129)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 189, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":189, "input_value":input_value, "op_type":"coupled_logistic_x", 
