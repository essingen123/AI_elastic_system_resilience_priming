...
# Script ID 162: Op 'de_jong_attractor_x', Modifiers: a=1.21, b=-1.39
...
if __name__ == "__main__":
    ...
    modifier_a = float(1.21)
    modifier_b = float(-1.39)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 162, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":162, "input_value":input_value, "op_type":"de_jong_attractor_x", 
