...
# Script ID 0: Op 'clifford_attractor_x', Modifiers: a=-1.53, c=-0.29
...
if __name__ == "__main__":
    ...
    modifier_a = float(-1.53)
    modifier_c = float(-0.29)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 0, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":0, "input_value":input_value, "op_type":"clifford_attractor_x", 
