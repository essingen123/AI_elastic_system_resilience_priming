...
# Script ID 132: Op 'clifford_attractor_x', Modifiers: a=0.52, c=-0.59
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 132, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":132, "input_value":input_value, "op_type":"clifford_attractor_x", 
