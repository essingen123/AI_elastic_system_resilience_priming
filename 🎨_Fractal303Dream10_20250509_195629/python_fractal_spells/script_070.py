...
# Script ID 70: Op 'de_jong_attractor_y', Modifiers: c=0.77, d=2.4
...
if __name__ == "__main__":
    ...
    modifier_d = float(2.4)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 70, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":70, "input_value":input_value, "op_type":"de_jong_attractor_y", 
