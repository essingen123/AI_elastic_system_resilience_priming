...
# Script ID 221: Op 'lyapunov_exponent_approx', Modifiers: r=3.858
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 221, prev_val_placeholder_py, **({"modifier_r": modifier_r}))
    ...
    print(json.dumps({
        "script_id":221, "input_value":input_value, "op_type":"lyapunov_exponent_approx", 
