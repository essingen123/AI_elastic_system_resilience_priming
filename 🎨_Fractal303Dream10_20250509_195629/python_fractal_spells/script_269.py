...
# Script ID 269: Op 'clifford_attractor_y', Modifiers: b=-0.57, d=1.47
...
if __name__ == "__main__":
    ...
    modifier_b = float(-0.57)
    modifier_d = float(1.47)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 269, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":269, "input_value":input_value, "op_type":"clifford_attractor_y", 
