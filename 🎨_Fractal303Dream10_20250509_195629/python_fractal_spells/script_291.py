...
# Script ID 291: Op 'clifford_attractor_x', Modifiers: a=-1.1, c=-0.74
...
if __name__ == "__main__":
    ...
    modifier_a = float(-1.1)
    modifier_c = float(-0.74)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 291, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":291, "input_value":input_value, "op_type":"clifford_attractor_x", 
