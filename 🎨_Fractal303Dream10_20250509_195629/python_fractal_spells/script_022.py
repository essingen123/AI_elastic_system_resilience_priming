...
# Script ID 22: Op 'de_jong_attractor_y', Modifiers: c=-1.8, d=-2.07
...
if __name__ == "__main__":
    ...
    modifier_c = float(-1.8)
    modifier_d = float(-2.07)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 22, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":22, "input_value":input_value, "op_type":"de_jong_attractor_y", 
