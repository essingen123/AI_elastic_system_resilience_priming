...
# Script ID 136: Op 'coupled_logistic_x', Modifiers: rx=3.908, cxy=0.197
...
if __name__ == "__main__":
    ...
    modifier_rx = float(3.908)
    modifier_cxy = float(0.197)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 136, prev_val_placeholder_py, **({"modifier_rx": modifier_rx, "modifier_cxy": modifier_cxy}))
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":"coupled_logistic_x", 
