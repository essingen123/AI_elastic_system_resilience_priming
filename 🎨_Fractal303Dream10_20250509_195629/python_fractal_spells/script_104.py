...
# Script ID 104: Op 'clifford_attractor_x', Modifiers: a=1.14, c=0.27
...
if __name__ == "__main__":
    ...
    modifier_a = float(1.14)
    modifier_c = float(0.27)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 104, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":104, "input_value":input_value, "op_type":"clifford_attractor_x", 
