...
# Script ID 115: Op 'clifford_attractor_y', Modifiers: b=1.33, d=-0.35
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 115, prev_val_placeholder_py, **({"modifier_b": modifier_b, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":115, "input_value":input_value, "op_type":"clifford_attractor_y", 
