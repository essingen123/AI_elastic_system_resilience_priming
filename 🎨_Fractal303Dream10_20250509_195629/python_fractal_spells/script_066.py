...
# Script ID 66: Op 'clifford_attractor_x', Modifiers: a=-1.02, c=1.45
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 66, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":66, "input_value":input_value, "op_type":"clifford_attractor_x", 
