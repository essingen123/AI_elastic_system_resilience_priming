...
# Script ID 48: Op 'de_jong_attractor_x', Modifiers: a=2.14, b=2.07
...
if __name__ == "__main__":
    ...
    modifier_a = float(2.14)
    modifier_b = float(2.07)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 48, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":48, "input_value":input_value, "op_type":"de_jong_attractor_x", 
