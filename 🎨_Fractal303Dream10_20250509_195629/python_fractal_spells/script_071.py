...
# Script ID 71: Op 'de_jong_attractor_y', Modifiers: c=0.88, d=0.06
...
if __name__ == "__main__":
    ...
    modifier_c = float(0.88)
    modifier_d = float(0.06)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 71, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":71, "input_value":input_value, "op_type":"de_jong_attractor_y", 
