...
# Script ID 256: Op 'sine_power_mix', Modifiers: freq1=2.75, pow1=3, amp1=0.8, freq2=0.8, pow2=1, amp2=2.5
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.75)
    modifier_pow1 = float(3)
    modifier_amp1 = float(0.8)
    modifier_freq2 = float(0.8)
    modifier_pow2 = float(1)
    modifier_amp2 = float(2.5)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 256, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":256, "input_value":input_value, "op_type":"sine_power_mix", 
