...
# Script ID 192: Op 'sine_power_mix', Modifiers: freq1=1.77, pow1=1, amp1=3, freq2=2.9, pow2=2, amp2=0.7
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.77)
    modifier_pow1 = float(1)
    modifier_amp1 = float(3)
    modifier_freq2 = float(2.9)
    modifier_pow2 = float(2)
    modifier_amp2 = float(0.7)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 192, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":192, "input_value":input_value, "op_type":"sine_power_mix", 
