...
# Script ID 137: Op 'de_jong_attractor_y', Modifiers: c=-0.92, d=-0.17
...
if __name__ == "__main__":
    ...
    modifier_c = float(-0.92)
    modifier_d = float(-0.17)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    output_value = perform_operation(input_value, current_depth, 137, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":137, "input_value":input_value, "op_type":"de_jong_attractor_y", 
