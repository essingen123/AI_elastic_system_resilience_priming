...
# Script ID 219: Op 'logistic_growth', Modifiers: r=3.361, k=36
...
if __name__ == "__main__":
    ...
    r = float(3.361) # PHP generated
    k = float(36) # PHP generated
    ...
    print(json.dumps({
        "script_id":219, "input_value":input_value, "op_type":op_name, 
