...
# Script ID 124: Op 'logistic_growth', Modifiers: r=3.183, k=47
...
if __name__ == "__main__":
    ...
    r = float(3.183) # PHP generated
    k = float(47) # PHP generated
    ...
    print(json.dumps({
        "script_id":124, "input_value":input_value, "op_type":op_name, 
