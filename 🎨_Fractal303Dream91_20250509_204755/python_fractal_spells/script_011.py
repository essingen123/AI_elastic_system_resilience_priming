...
# Script ID 11: Op 'sine_power_mix', Modifiers: freq1=1.89, pow1=2, amp1=0.8, freq2=0.62, pow2=2, amp2=3.4
...
if __name__ == "__main__":
    ...
    freq1 = float(1.89) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(0.8) # PHP generated
    freq2 = float(0.62) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(3.4) # PHP generated
    ...
    print(json.dumps({
        "script_id":11, "input_value":input_value, "op_type":op_name, 
