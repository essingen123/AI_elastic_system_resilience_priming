...
# Script ID 131: Op 'de_jong_attractor_y', Modifiers: c=-2.28, d=-2.05
...
if __name__ == "__main__":
    ...
    c = float(-2.28) # PHP generated
    d = float(-2.05) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"c": c, "d": d}
    output_value = perform_operation(input_value, current_depth, 131, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":131, "input_value":input_value, "op_type":op_name, 
