...
# Script ID 96: Op 'de_jong_attractor_y', Modifiers: c=-1.39, d=2.15
...
if __name__ == "__main__":
    ...
    c = float(-1.39) # PHP generated
    d = float(2.15) # PHP generated
    ...
    print(json.dumps({
        "script_id":96, "input_value":input_value, "op_type":op_name, 
