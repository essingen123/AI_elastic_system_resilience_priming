...
# Script ID 141: Op 'coupled_logistic_x', Modifiers: rx=3.88, cxy=0.131
...
if __name__ == "__main__":
    ...
    rx = float(3.88) # PHP generated
    cxy = float(0.131) # PHP generated
    ...
    print(json.dumps({
        "script_id":141, "input_value":input_value, "op_type":op_name, 
