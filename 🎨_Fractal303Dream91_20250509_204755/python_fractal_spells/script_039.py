...
# Script ID 39: Op 'sine_power_mix', Modifiers: freq1=0.8, pow1=1, amp1=2.1, freq2=2.58, pow2=1, amp2=4.3
...
if __name__ == "__main__":
    ...
    freq1 = float(0.8) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(2.1) # PHP generated
    freq2 = float(2.58) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 39, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":39, "input_value":input_value, "op_type":op_name, 
