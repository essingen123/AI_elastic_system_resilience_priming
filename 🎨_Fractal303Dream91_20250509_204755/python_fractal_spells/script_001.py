...
# Script ID 1: Op 'de_jong_attractor_y', Modifiers: c=-1.65, d=1.87
...
if __name__ == "__main__":
    ...
    c = float(-1.65) # PHP generated
    d = float(1.87) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"c": c, "d": d}
    output_value = perform_operation(input_value, current_depth, 1, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":1, "input_value":input_value, "op_type":op_name, 
