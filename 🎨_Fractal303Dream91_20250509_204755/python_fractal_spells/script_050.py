...
# Script ID 50: Op 'de_jong_attractor_x', Modifiers: a=-0.32, b=2.48
...
if __name__ == "__main__":
    ...
    a = float(-0.32) # PHP generated
    b = float(2.48) # PHP generated
    ...
    print(json.dumps({
        "script_id":50, "input_value":input_value, "op_type":op_name, 
