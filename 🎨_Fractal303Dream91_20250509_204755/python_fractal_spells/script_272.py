...
# Script ID 272: Op 'sine_power_mix', Modifiers: freq1=2.09, pow1=2, amp1=2.4, freq2=2.73, pow2=2, amp2=1.8
...
if __name__ == "__main__":
    ...
    freq1 = float(2.09) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.4) # PHP generated
    freq2 = float(2.73) # PHP generated
    ...
    print(json.dumps({
        "script_id":272, "input_value":input_value, "op_type":op_name, 
