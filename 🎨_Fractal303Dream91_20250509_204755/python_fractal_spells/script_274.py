...
# Script ID 274: Op 'sine_power_mix', Modifiers: freq1=1.83, pow1=3, amp1=2.6, freq2=0.73, pow2=3, amp2=2.8
...
if __name__ == "__main__":
    ...
    freq1 = float(1.83) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.6) # PHP generated
    freq2 = float(0.73) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 274, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":274, "input_value":input_value, "op_type":op_name, 
