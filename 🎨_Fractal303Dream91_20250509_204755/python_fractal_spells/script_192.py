...
# Script ID 192: Op 'coupled_logistic_x', Modifiers: rx=3.764, cxy=0.012
...
if __name__ == "__main__":
    ...
    rx = float(3.764) # PHP generated
    cxy = float(0.012) # PHP generated
    ...
    print(json.dumps({
        "script_id":192, "input_value":input_value, "op_type":op_name, 
