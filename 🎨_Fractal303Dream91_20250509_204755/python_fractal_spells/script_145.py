...
# Script ID 145: Op 'clifford_attractor_y', Modifiers: b=-0.7, d=1.49
...
if __name__ == "__main__":
    ...
    b = float(-0.7) # PHP generated
    d = float(1.49) # PHP generated
    ...
    print(json.dumps({
        "script_id":145, "input_value":input_value, "op_type":op_name, 
