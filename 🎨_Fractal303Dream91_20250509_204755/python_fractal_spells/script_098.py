...
# Script ID 98: Op 'sine_power_mix', Modifiers: freq1=0.48, pow1=3, amp1=3.6, freq2=2.15, pow2=1, amp2=4.9
...
if __name__ == "__main__":
    ...
    freq1 = float(0.48) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(3.6) # PHP generated
    freq2 = float(2.15) # PHP generated
    ...
    print(json.dumps({
        "script_id":98, "input_value":input_value, "op_type":op_name, 
