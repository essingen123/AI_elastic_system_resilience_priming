...
# Script ID 74: Op 'de_jong_attractor_x', Modifiers: a=0.56, b=2.07
...
if __name__ == "__main__":
    ...
    a = float(0.56) # PHP generated
    b = float(2.07) # PHP generated
    ...
    print(json.dumps({
        "script_id":74, "input_value":input_value, "op_type":op_name, 
