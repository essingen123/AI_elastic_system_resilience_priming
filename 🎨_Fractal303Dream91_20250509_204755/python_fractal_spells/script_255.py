...
# Script ID 255: Op 'clifford_attractor_y', Modifiers: b=-0.75, d=0.63
...
if __name__ == "__main__":
    ...
    b = float(-0.75) # PHP generated
    d = float(0.63) # PHP generated
    ...
    print(json.dumps({
        "script_id":255, "input_value":input_value, "op_type":op_name, 
