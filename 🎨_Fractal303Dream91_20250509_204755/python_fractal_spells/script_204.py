...
# Script ID 204: Op 'coupled_logistic_x', Modifiers: rx=3.906, cxy=0.039
...
if __name__ == "__main__":
    ...
    rx = float(3.906) # PHP generated
    cxy = float(0.039) # PHP generated
    ...
    print(json.dumps({
        "script_id":204, "input_value":input_value, "op_type":op_name, 
