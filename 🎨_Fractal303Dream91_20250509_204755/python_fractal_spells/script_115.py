...
# Script ID 115: Op 'sine_power_mix', Modifiers: freq1=2.16, pow1=2, amp1=2.2, freq2=2.04, pow2=2, amp2=3.7
...
if __name__ == "__main__":
    ...
    freq1 = float(2.16) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.2) # PHP generated
    freq2 = float(2.04) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(3.7) # PHP generated
    ...
    print(json.dumps({
        "script_id":115, "input_value":input_value, "op_type":op_name, 
