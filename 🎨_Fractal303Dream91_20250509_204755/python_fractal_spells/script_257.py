...
# Script ID 257: Op 'logistic_growth', Modifiers: r=2.83, k=54
...
if __name__ == "__main__":
    ...
    r = float(2.83) # PHP generated
    k = float(54) # PHP generated
    ...
    print(json.dumps({
        "script_id":257, "input_value":input_value, "op_type":op_name, 
