...
# Script ID 254: Op 'logistic_growth', Modifiers: r=2.969, k=72
...
if __name__ == "__main__":
    ...
    r = float(2.969) # PHP generated
    k = float(72) # PHP generated
    ...
    print(json.dumps({
        "script_id":254, "input_value":input_value, "op_type":op_name, 
