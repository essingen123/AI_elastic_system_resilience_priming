...
# Script ID 228: Op 'logistic_growth', Modifiers: r=3.453, k=100
...
if __name__ == "__main__":
    ...
    r = float(3.453) # PHP generated
    k = float(100) # PHP generated
    ...
    print(json.dumps({
        "script_id":228, "input_value":input_value, "op_type":op_name, 
