...
# Script ID 189: Op 'sine_power_mix', Modifiers: freq1=0.77, pow1=3, amp1=0.9, freq2=1.54, pow2=2, amp2=1.5
...
if __name__ == "__main__":
    ...
    freq1 = float(0.77) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(0.9) # PHP generated
    freq2 = float(1.54) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(1.5) # PHP generated
    ...
    print(json.dumps({
        "script_id":189, "input_value":input_value, "op_type":op_name, 
