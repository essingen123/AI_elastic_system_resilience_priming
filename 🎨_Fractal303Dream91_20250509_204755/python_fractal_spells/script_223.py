...
# Script ID 223: Op 'de_jong_attractor_y', Modifiers: c=0.14, d=2.6
...
if __name__ == "__main__":
    ...
    c = float(0.14) # PHP generated
    d = float(2.6) # PHP generated
    ...
    print(json.dumps({
        "script_id":223, "input_value":input_value, "op_type":op_name, 
