...
# Script ID 193: Op 'de_jong_attractor_y', Modifiers: c=-1.38, d=1.82
...
if __name__ == "__main__":
    ...
    c = float(-1.38) # PHP generated
    d = float(1.82) # PHP generated
    ...
    print(json.dumps({
        "script_id":193, "input_value":input_value, "op_type":op_name, 
