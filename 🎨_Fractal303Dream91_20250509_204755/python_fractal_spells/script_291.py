...
# Script ID 291: Op 'de_jong_attractor_x', Modifiers: a=1.39, b=-2.4
...
if __name__ == "__main__":
    ...
    b = float(-2.4) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "b": b}
    output_value = perform_operation(input_value, current_depth, 291, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":291, "input_value":input_value, "op_type":op_name, 
