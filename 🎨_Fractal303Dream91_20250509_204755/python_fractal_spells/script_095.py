...
# Script ID 95: Op 'de_jong_attractor_y', Modifiers: c=0.96, d=-0.91
...
if __name__ == "__main__":
    ...
    d = float(-0.91) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"c": c, "d": d}
    output_value = perform_operation(input_value, current_depth, 95, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":95, "input_value":input_value, "op_type":op_name, 
