...
# Script ID 278: Op 'logistic_growth', Modifiers: r=3.758, k=93
...
if __name__ == "__main__":
    ...
    r = float(3.758) # PHP generated
    k = float(93) # PHP generated
    ...
    print(json.dumps({
        "script_id":278, "input_value":input_value, "op_type":op_name, 
