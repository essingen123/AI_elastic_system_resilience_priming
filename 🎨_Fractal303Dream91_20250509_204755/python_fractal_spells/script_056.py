...
# Script ID 56: Op 'de_jong_attractor_x', Modifiers: a=-2.55, b=1.59
...
if __name__ == "__main__":
    ...
    a = float(-2.55) # PHP generated
    b = float(1.59) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "b": b}
    output_value = perform_operation(input_value, current_depth, 56, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":56, "input_value":input_value, "op_type":op_name, 
