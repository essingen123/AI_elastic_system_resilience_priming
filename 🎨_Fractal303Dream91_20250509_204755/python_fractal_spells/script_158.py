...
# Script ID 158: Op 'de_jong_attractor_y', Modifiers: c=-0.91, d=-0.35
...
if __name__ == "__main__":
    ...
    c = float(-0.91) # PHP generated
    d = float(-0.35) # PHP generated
    ...
    print(json.dumps({
        "script_id":158, "input_value":input_value, "op_type":op_name, 
