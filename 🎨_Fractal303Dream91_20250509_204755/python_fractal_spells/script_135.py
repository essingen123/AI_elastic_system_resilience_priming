...
# Script ID 135: Op 'coupled_logistic_x', Modifiers: rx=3.784, cxy=0.021
...
if __name__ == "__main__":
    ...
    rx = float(3.784) # PHP generated
    cxy = float(0.021) # PHP generated
    ...
    print(json.dumps({
        "script_id":135, "input_value":input_value, "op_type":op_name, 
