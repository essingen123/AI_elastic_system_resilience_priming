...
# Script ID 93: Op 'sine_power_mix', Modifiers: freq1=0.56, pow1=3, amp1=3.1, freq2=0.85, pow2=2, amp2=2
...
if __name__ == "__main__":
    ...
    freq2 = float(0.85) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(2) # PHP generated
    ...
    print(json.dumps({
        "script_id":93, "input_value":input_value, "op_type":op_name, 
