...
# Script ID 147: Op 'de_jong_attractor_y', Modifiers: c=1.82, d=1.22
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 147, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":147, "input_value":input_value, "op_type":op_name, 
