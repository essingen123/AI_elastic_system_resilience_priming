...
# Script ID 294: Op 'clifford_attractor_x', Modifiers: a=-1.47, c=-0.5
...
if __name__ == "__main__":
    ...
    a = float(-1.47) # PHP generated
    c = float(-0.5) # PHP generated
    ...
    print(json.dumps({
        "script_id":294, "input_value":input_value, "op_type":op_name, 
