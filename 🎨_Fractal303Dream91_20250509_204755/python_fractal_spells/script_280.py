...
# Script ID 280: Op 'coupled_logistic_x', Modifiers: rx=3.853, cxy=0.057
...
if __name__ == "__main__":
    ...
    rx = float(3.853) # PHP generated
    cxy = float(0.057) # PHP generated
    ...
    print(json.dumps({
        "script_id":280, "input_value":input_value, "op_type":op_name, 
