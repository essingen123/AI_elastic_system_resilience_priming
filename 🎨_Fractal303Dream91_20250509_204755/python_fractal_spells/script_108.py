...
# Script ID 108: Op 'sine_power_mix', Modifiers: freq1=2.5, pow1=2, amp1=2.6, freq2=2.47, pow2=2, amp2=3.3
...
if __name__ == "__main__":
    ...
    freq1 = float(2.5) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.6) # PHP generated
    freq2 = float(2.47) # PHP generated
    ...
    print(json.dumps({
        "script_id":108, "input_value":input_value, "op_type":op_name, 
