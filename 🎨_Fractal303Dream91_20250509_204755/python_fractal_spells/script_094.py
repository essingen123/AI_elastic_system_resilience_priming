...
# Script ID 94: Op 'coupled_logistic_x', Modifiers: rx=3.762, cxy=0.078
...
if __name__ == "__main__":
    ...
    rx = float(3.762) # PHP generated
    cxy = float(0.078) # PHP generated
    ...
    print(json.dumps({
        "script_id":94, "input_value":input_value, "op_type":op_name, 
