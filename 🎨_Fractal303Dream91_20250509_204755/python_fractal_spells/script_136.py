...
# Script ID 136: Op 'coupled_logistic_x', Modifiers: rx=3.744, cxy=0.177
...
if __name__ == "__main__":
    ...
    rx = float(3.744) # PHP generated
    cxy = float(0.177) # PHP generated
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":op_name, 
