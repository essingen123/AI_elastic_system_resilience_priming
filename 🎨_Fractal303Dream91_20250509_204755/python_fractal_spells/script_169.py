...
# Script ID 169: Op 'sine_power_mix', Modifiers: freq1=0.55, pow1=1, amp1=2, freq2=2.21, pow2=2, amp2=4.9
...
if __name__ == "__main__":
    ...
    freq2 = float(2.21) # PHP generated
    ...
    print(json.dumps({
        "script_id":169, "input_value":input_value, "op_type":op_name, 
