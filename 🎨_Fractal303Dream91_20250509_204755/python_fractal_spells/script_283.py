...
# Script ID 283: Op 'de_jong_attractor_x', Modifiers: a=2.66, b=-2.79
...
if __name__ == "__main__":
    ...
    a = float(2.66) # PHP generated
    b = float(-2.79) # PHP generated
    ...
    print(json.dumps({
        "script_id":283, "input_value":input_value, "op_type":op_name, 
