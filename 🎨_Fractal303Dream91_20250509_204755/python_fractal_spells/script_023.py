...
# Script ID 23: Op 'de_jong_attractor_x', Modifiers: a=-1.88, b=-0.14
...
if __name__ == "__main__":
    ...
    a = float(-1.88) # PHP generated
    b = float(-0.14) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "b": b}
    output_value = perform_operation(input_value, current_depth, 23, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":23, "input_value":input_value, "op_type":op_name, 
