...
# Script ID 171: Op 'lyapunov_exponent_approx', Modifiers: r=3.775
...
if __name__ == "__main__":
    ...
    r = float(3.775) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"r": r}
    output_value = perform_operation(input_value, current_depth, 171, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":171, "input_value":input_value, "op_type":op_name, 
