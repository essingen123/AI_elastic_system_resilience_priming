...
# Script ID 299: Op 'clifford_attractor_y', Modifiers: b=-1.05, d=1.46
...
if __name__ == "__main__":
    ...
    b = float(-1.05) # PHP generated
    d = float(1.46) # PHP generated
    ...
    print(json.dumps({
        "script_id":299, "input_value":input_value, "op_type":op_name, 
