...
# Script ID 71: Op 'coupled_logistic_x', Modifiers: rx=3.994, cxy=0.1
...
if __name__ == "__main__":
    ...
    rx = float(3.994) # PHP generated
    cxy = float(0.1) # PHP generated
    ...
    print(json.dumps({
        "script_id":71, "input_value":input_value, "op_type":op_name, 
