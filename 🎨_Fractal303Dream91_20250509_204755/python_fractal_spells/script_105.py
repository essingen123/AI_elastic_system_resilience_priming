...
# Script ID 105: Op 'coupled_logistic_x', Modifiers: rx=3.508, cxy=0.038
...
if __name__ == "__main__":
    ...
    rx = float(3.508) # PHP generated
    cxy = float(0.038) # PHP generated
    ...
    print(json.dumps({
        "script_id":105, "input_value":input_value, "op_type":op_name, 
