...
# Script ID 45: Op 'clifford_attractor_x', Modifiers: a=1.11, c=-1.5
...
if __name__ == "__main__":
    ...
    a = float(1.11) # PHP generated
    c = float(-1.5) # PHP generated
    ...
    print(json.dumps({
        "script_id":45, "input_value":input_value, "op_type":op_name, 
