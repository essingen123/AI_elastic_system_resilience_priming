...
# Script ID 126: Op 'coupled_logistic_x', Modifiers: rx=3.915, cxy=0.065
...
if __name__ == "__main__":
    ...
    rx = float(3.915) # PHP generated
    cxy = float(0.065) # PHP generated
    ...
    print(json.dumps({
        "script_id":126, "input_value":input_value, "op_type":op_name, 
