...
# Script ID 118: Op 'sine_power_mix', Modifiers: freq1=2.9, pow1=3, amp1=1.4, freq2=2.88, pow2=2, amp2=1.7
...
if __name__ == "__main__":
    ...
    freq1 = float(2.9) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(1.4) # PHP generated
    freq2 = float(2.88) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 118, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":118, "input_value":input_value, "op_type":op_name, 
