...
# Script ID 183: Op 'de_jong_attractor_x', Modifiers: a=2.4, b=0.82
...
if __name__ == "__main__":
    ...
    a = float(2.4) # PHP generated
    b = float(0.82) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "b": b}
    output_value = perform_operation(input_value, current_depth, 183, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":183, "input_value":input_value, "op_type":op_name, 
