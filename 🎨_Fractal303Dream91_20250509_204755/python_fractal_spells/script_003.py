...
# Script ID 3: Op 'sine_power_mix', Modifiers: freq1=0.3, pow1=1, amp1=1.4, freq2=2.41, pow2=2, amp2=3.3
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":3, "input_value":input_value, "op_type":op_name, 
