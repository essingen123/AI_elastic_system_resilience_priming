...
# Script ID 238: Op 'logistic_growth', Modifiers: r=3.053, k=64
...
if __name__ == "__main__":
    ...
    r = float(3.053) # PHP generated
    k = float(64) # PHP generated
    ...
    print(json.dumps({
        "script_id":238, "input_value":input_value, "op_type":op_name, 
