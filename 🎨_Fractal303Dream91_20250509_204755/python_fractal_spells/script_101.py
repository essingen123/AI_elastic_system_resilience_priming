...
# Script ID 101: Op 'de_jong_attractor_y', Modifiers: c=2.08, d=0.81
...
if __name__ == "__main__":
    ...
    c = float(2.08) # PHP generated
    d = float(0.81) # PHP generated
    ...
    print(json.dumps({
        "script_id":101, "input_value":input_value, "op_type":op_name, 
