...
# Script ID 5: Op 'de_jong_attractor_y', Modifiers: c=2.94, d=1.72
...
if __name__ == "__main__":
    ...
    c = float(2.94) # PHP generated
    d = float(1.72) # PHP generated
    ...
    print(json.dumps({
        "script_id":5, "input_value":input_value, "op_type":op_name, 
