...
# Script ID 117: Op 'logistic_growth', Modifiers: r=3.34, k=60
...
if __name__ == "__main__":
    ...
    r = float(3.34) # PHP generated
    k = float(60) # PHP generated
    ...
    print(json.dumps({
        "script_id":117, "input_value":input_value, "op_type":op_name, 
