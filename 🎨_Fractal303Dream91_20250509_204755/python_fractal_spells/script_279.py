...
# Script ID 279: Op 'sine_power_mix', Modifiers: freq1=0.78, pow1=1, amp1=4.4, freq2=1.12, pow2=1, amp2=3.6
...
if __name__ == "__main__":
    ...
    freq1 = float(0.78) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(4.4) # PHP generated
    freq2 = float(1.12) # PHP generated
    ...
    print(json.dumps({
        "script_id":279, "input_value":input_value, "op_type":op_name, 
