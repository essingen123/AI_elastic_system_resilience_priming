...
# Script ID 34: Op 'sine_power_mix', Modifiers: freq1=2.57, pow1=2, amp1=2.2, freq2=1.85, pow2=3, amp2=4.8
...
if __name__ == "__main__":
    ...
    freq2 = float(1.85) # PHP generated
    ...
    print(json.dumps({
        "script_id":34, "input_value":input_value, "op_type":op_name, 
