...
# Script ID 68: Op 'de_jong_attractor_x', Modifiers: a=2.89, b=2.05
...
if __name__ == "__main__":
    ...
    a = float(2.89) # PHP generated
    b = float(2.05) # PHP generated
    ...
    print(json.dumps({
        "script_id":68, "input_value":input_value, "op_type":op_name, 
