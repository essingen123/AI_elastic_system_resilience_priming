...
# Script ID 187: Op 'logistic_growth', Modifiers: r=2.819, k=42
...
if __name__ == "__main__":
    ...
    r = float(2.819) # PHP generated
    k = float(42) # PHP generated
    ...
    print(json.dumps({
        "script_id":187, "input_value":input_value, "op_type":op_name, 
