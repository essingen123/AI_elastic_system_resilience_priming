...
# Script ID 224: Op 'coupled_logistic_x', Modifiers: rx=3.84, cxy=0.047
...
if __name__ == "__main__":
    ...
    rx = float(3.84) # PHP generated
    cxy = float(0.047) # PHP generated
    ...
    print(json.dumps({
        "script_id":224, "input_value":input_value, "op_type":op_name, 
