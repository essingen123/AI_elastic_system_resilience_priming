...
# Script ID 116: Op 'sine_power_mix', Modifiers: freq1=0.2, pow1=2, amp1=1.3, freq2=0.29, pow2=1, amp2=1
...
if __name__ == "__main__":
    ...
    freq2 = float(0.29) # PHP generated
    ...
    print(json.dumps({
        "script_id":116, "input_value":input_value, "op_type":op_name, 
