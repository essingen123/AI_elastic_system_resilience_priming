...
# Script ID 251: Op 'clifford_attractor_x', Modifiers: a=1.96, c=0.43
...
if __name__ == "__main__":
    ...
    a = float(1.96) # PHP generated
    c = float(0.43) # PHP generated
    ...
    print(json.dumps({
        "script_id":251, "input_value":input_value, "op_type":op_name, 
