...
# Script ID 7: Op 'de_jong_attractor_y', Modifiers: c=-0.46, d=2.77
...
if __name__ == "__main__":
    ...
    c = float(-0.46) # PHP generated
    d = float(2.77) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"c": c, "d": d}
    output_value = perform_operation(input_value, current_depth, 7, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":7, "input_value":input_value, "op_type":op_name, 
