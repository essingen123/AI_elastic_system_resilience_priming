...
# Script ID 177: Op 'sine_power_mix', Modifiers: freq1=0.66, pow1=3, amp1=1.8, freq2=0.97, pow2=1, amp2=0.8
...
if __name__ == "__main__":
    ...
    freq1 = float(0.66) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(1.8) # PHP generated
    freq2 = float(0.97) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(0.8) # PHP generated
    ...
    print(json.dumps({
        "script_id":177, "input_value":input_value, "op_type":op_name, 
