...
# Script ID 47: Op 'clifford_attractor_x', Modifiers: a=1.31, c=1.09
...
if __name__ == "__main__":
    ...
    c = float(1.09) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "c": c}
    output_value = perform_operation(input_value, current_depth, 47, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":47, "input_value":input_value, "op_type":op_name, 
