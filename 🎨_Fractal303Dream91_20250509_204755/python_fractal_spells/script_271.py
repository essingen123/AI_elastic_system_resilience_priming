...
# Script ID 271: Op 'de_jong_attractor_y', Modifiers: c=-2.49, d=0.07
...
if __name__ == "__main__":
    ...
    c = float(-2.49) # PHP generated
    d = float(0.07) # PHP generated
    ...
    print(json.dumps({
        "script_id":271, "input_value":input_value, "op_type":op_name, 
