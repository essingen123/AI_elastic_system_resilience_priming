...
# Script ID 275: Op 'sine_power_mix', Modifiers: freq1=0.48, pow1=2, amp1=2.2, freq2=0.76, pow2=2, amp2=1.8
...
if __name__ == "__main__":
    ...
    freq2 = float(0.76) # PHP generated
    ...
    print(json.dumps({
        "script_id":275, "input_value":input_value, "op_type":op_name, 
