...
# Script ID 202: Op 'coupled_logistic_x', Modifiers: rx=3.943, cxy=0.123
...
if __name__ == "__main__":
    ...
    rx = float(3.943) # PHP generated
    cxy = float(0.123) # PHP generated
    ...
    print(json.dumps({
        "script_id":202, "input_value":input_value, "op_type":op_name, 
