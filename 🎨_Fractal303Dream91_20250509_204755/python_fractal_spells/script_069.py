...
# Script ID 69: Op 'sine_power_mix', Modifiers: freq1=2.31, pow1=2, amp1=3, freq2=2.93, pow2=1, amp2=3.9
...
if __name__ == "__main__":
    ...
    freq1 = float(2.31) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(3) # PHP generated
    freq2 = float(2.93) # PHP generated
    ...
    print(json.dumps({
        "script_id":69, "input_value":input_value, "op_type":op_name, 
