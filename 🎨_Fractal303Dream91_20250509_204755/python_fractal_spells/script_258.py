...
# Script ID 258: Op 'logistic_growth', Modifiers: r=2.954, k=24
...
if __name__ == "__main__":
    ...
    r = float(2.954) # PHP generated
    k = float(24) # PHP generated
    ...
    print(json.dumps({
        "script_id":258, "input_value":input_value, "op_type":op_name, 
