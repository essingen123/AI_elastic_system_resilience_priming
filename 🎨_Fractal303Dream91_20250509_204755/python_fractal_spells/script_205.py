...
# Script ID 205: Op 'de_jong_attractor_x', Modifiers: a=-1.29, b=-1.45
...
if __name__ == "__main__":
    ...
    a = float(-1.29) # PHP generated
    b = float(-1.45) # PHP generated
    ...
    print(json.dumps({
        "script_id":205, "input_value":input_value, "op_type":op_name, 
