...
# Script ID 209: Op 'coupled_logistic_x', Modifiers: rx=3.743, cxy=0.084
...
if __name__ == "__main__":
    ...
    rx = float(3.743) # PHP generated
    cxy = float(0.084) # PHP generated
    ...
    print(json.dumps({
        "script_id":209, "input_value":input_value, "op_type":op_name, 
