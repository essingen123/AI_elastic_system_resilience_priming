...
# Script ID 133: Op 'clifford_attractor_y', Modifiers: b=-0.83, d=-0.4
...
if __name__ == "__main__":
    ...
    b = float(-0.83) # PHP generated
    d = float(-0.4) # PHP generated
    ...
    print(json.dumps({
        "script_id":133, "input_value":input_value, "op_type":op_name, 
