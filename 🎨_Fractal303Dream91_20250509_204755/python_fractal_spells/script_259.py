...
# Script ID 259: Op 'de_jong_attractor_y', Modifiers: c=-2.32, d=2.06
...
if __name__ == "__main__":
    ...
    c = float(-2.32) # PHP generated
    d = float(2.06) # PHP generated
    ...
    print(json.dumps({
        "script_id":259, "input_value":input_value, "op_type":op_name, 
