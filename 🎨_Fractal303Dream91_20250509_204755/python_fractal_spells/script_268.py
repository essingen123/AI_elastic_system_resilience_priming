...
# Script ID 268: Op 'clifford_attractor_x', Modifiers: a=1.12, c=0.53
...
if __name__ == "__main__":
    ...
    a = float(1.12) # PHP generated
    c = float(0.53) # PHP generated
    ...
    print(json.dumps({
        "script_id":268, "input_value":input_value, "op_type":op_name, 
