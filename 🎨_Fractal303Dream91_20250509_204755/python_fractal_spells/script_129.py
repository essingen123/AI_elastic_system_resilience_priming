...
# Script ID 129: Op 'sine_power_mix', Modifiers: freq1=1.13, pow1=3, amp1=4.9, freq2=0.94, pow2=1, amp2=3.8
...
if __name__ == "__main__":
    ...
    freq1 = float(1.13) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(4.9) # PHP generated
    freq2 = float(0.94) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(3.8) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 129, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":129, "input_value":input_value, "op_type":op_name, 
