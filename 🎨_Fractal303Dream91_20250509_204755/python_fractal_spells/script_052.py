...
# Script ID 52: Op 'clifford_attractor_x', Modifiers: a=0.6, c=-0.19
...
if __name__ == "__main__":
    ...
    a = float(0.6) # PHP generated
    c = float(-0.19) # PHP generated
    ...
    print(json.dumps({
        "script_id":52, "input_value":input_value, "op_type":op_name, 
