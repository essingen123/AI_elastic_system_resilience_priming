...
# Script ID 36: Op 'logistic_growth', Modifiers: r=3.289, k=55
...
if __name__ == "__main__":
    ...
    r = float(3.289) # PHP generated
    k = float(55) # PHP generated
    ...
    print(json.dumps({
        "script_id":36, "input_value":input_value, "op_type":op_name, 
