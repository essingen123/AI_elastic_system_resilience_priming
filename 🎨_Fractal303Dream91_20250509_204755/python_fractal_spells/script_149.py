...
# Script ID 149: Op 'coupled_logistic_x', Modifiers: rx=3.539, cxy=0.03
...
if __name__ == "__main__":
    ...
    rx = float(3.539) # PHP generated
    cxy = float(0.03) # PHP generated
    ...
    print(json.dumps({
        "script_id":149, "input_value":input_value, "op_type":op_name, 
