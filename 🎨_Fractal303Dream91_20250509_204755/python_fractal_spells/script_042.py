...
# Script ID 42: Op 'sine_power_mix', Modifiers: freq1=1.5, pow1=2, amp1=2.6, freq2=1.35, pow2=2, amp2=4.1
...
if __name__ == "__main__":
    ...
    freq1 = float(1.5) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(2.6) # PHP generated
    freq2 = float(1.35) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(4.1) # PHP generated
    ...
    print(json.dumps({
        "script_id":42, "input_value":input_value, "op_type":op_name, 
