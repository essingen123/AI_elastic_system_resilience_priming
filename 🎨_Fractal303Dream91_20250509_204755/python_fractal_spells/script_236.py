...
# Script ID 236: Op 'lyapunov_exponent_approx', Modifiers: r=3.885
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":236, "input_value":input_value, "op_type":op_name, 
