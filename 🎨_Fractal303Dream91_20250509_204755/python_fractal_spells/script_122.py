...
# Script ID 122: Op 'coupled_logistic_x', Modifiers: rx=3.829, cxy=0.058
...
if __name__ == "__main__":
    ...
    rx = float(3.829) # PHP generated
    cxy = float(0.058) # PHP generated
    ...
    print(json.dumps({
        "script_id":122, "input_value":input_value, "op_type":op_name, 
