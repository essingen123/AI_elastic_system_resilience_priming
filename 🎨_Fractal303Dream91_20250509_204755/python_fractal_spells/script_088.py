...
# Script ID 88: Op 'de_jong_attractor_x', Modifiers: a=-1.48, b=-0.27
...
if __name__ == "__main__":
    ...
    a = float(-1.48) # PHP generated
    b = float(-0.27) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "b": b}
    output_value = perform_operation(input_value, current_depth, 88, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":88, "input_value":input_value, "op_type":op_name, 
