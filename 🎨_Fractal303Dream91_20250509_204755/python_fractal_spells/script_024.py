...
# Script ID 24: Op 'coupled_logistic_x', Modifiers: rx=3.549, cxy=0.114
...
if __name__ == "__main__":
    ...
    rx = float(3.549) # PHP generated
    cxy = float(0.114) # PHP generated
    ...
    print(json.dumps({
        "script_id":24, "input_value":input_value, "op_type":op_name, 
