...
# Script ID 276: Op 'sine_power_mix', Modifiers: freq1=1.53, pow1=3, amp1=1.4, freq2=0.83, pow2=1, amp2=0.9
...
if __name__ == "__main__":
    ...
    freq1 = float(1.53) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(1.4) # PHP generated
    freq2 = float(0.83) # PHP generated
    ...
    print(json.dumps({
        "script_id":276, "input_value":input_value, "op_type":op_name, 
