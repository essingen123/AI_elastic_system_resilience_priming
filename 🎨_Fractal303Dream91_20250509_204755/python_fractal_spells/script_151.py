...
# Script ID 151: Op 'clifford_attractor_y', Modifiers: b=1.01, d=0.26
...
if __name__ == "__main__":
    ...
    b = float(1.01) # PHP generated
    d = float(0.26) # PHP generated
    ...
    print(json.dumps({
        "script_id":151, "input_value":input_value, "op_type":op_name, 
