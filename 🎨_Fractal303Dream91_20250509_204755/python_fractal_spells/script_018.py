...
# Script ID 18: Op 'sine_power_mix', Modifiers: freq1=0.4, pow1=3, amp1=3.5, freq2=1.65, pow2=2, amp2=4.3
...
if __name__ == "__main__":
    ...
    freq2 = float(1.65) # PHP generated
    ...
    print(json.dumps({
        "script_id":18, "input_value":input_value, "op_type":op_name, 
