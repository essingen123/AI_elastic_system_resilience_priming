...
# Script ID 270: Op 'sine_power_mix', Modifiers: freq1=2.03, pow1=2, amp1=3.8, freq2=2.9, pow2=1, amp2=2.3
...
if __name__ == "__main__":
    ...
    print(json.dumps({
        "script_id":270, "input_value":input_value, "op_type":op_name, 
