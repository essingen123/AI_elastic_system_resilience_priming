...
# Script ID 242: Op 'sine_power_mix', Modifiers: freq1=0.2, pow1=3, amp1=3.3, freq2=2.57, pow2=3, amp2=2.2
...
if __name__ == "__main__":
    ...
    freq1 = float(0.2) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(3.3) # PHP generated
    freq2 = float(2.57) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(2.2) # PHP generated
    ...
    print(json.dumps({
        "script_id":242, "input_value":input_value, "op_type":op_name, 
