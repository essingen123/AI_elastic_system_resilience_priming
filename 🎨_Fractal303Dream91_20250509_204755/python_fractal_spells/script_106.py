...
# Script ID 106: Op 'logistic_growth', Modifiers: r=3.296, k=10
...
if __name__ == "__main__":
    ...
    r = float(3.296) # PHP generated
    k = float(10) # PHP generated
    ...
    print(json.dumps({
        "script_id":106, "input_value":input_value, "op_type":op_name, 
