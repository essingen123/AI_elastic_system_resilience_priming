...
# Script ID 143: Op 'logistic_growth', Modifiers: r=3.852, k=15
...
def perform_operation(val, current_depth, script_id, prev_val_placeholder, **modifiers):
    ...
    try:
        result = modifiers.get("modifier_r", 3.0) * val * (1.0 - val / (modifiers.get("modifier_k", 1.0) if modifiers.get("modifier_k", 1.0) != 0.0 else 1.0))
        return result
...
if __name__ == "__main__":
    ...
    r = float(3.852) # PHP generated
    k = float(15) # PHP generated
    ...
    print(json.dumps({
        "script_id":143, "input_value":input_value, "op_type":op_name, 
