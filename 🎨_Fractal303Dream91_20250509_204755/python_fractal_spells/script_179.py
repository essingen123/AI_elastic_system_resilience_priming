...
# Script ID 179: Op 'sine_power_mix', Modifiers: freq1=2.59, pow1=2, amp1=4.6, freq2=1.97, pow2=3, amp2=1.3
...
if __name__ == "__main__":
    ...
    freq1 = float(2.59) # PHP generated
    ...
    print(json.dumps({
        "script_id":179, "input_value":input_value, "op_type":op_name, 
