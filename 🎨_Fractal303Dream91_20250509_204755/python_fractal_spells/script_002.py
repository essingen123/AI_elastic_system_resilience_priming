...
# Script ID 2: Op 'logistic_growth', Modifiers: r=2.937, k=77
...
if __name__ == "__main__":
    ...
    r = float(2.937) # PHP generated
    k = float(77) # PHP generated
    ...
    print(json.dumps({
        "script_id":2, "input_value":input_value, "op_type":op_name, 
