...
# Script ID 64: Op 'coupled_logistic_x', Modifiers: rx=3.986, cxy=0.023
...
if __name__ == "__main__":
    ...
    rx = float(3.986) # PHP generated
    cxy = float(0.023) # PHP generated
    ...
    print(json.dumps({
        "script_id":64, "input_value":input_value, "op_type":op_name, 
