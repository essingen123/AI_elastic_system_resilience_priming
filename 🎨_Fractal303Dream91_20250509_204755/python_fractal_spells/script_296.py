...
# Script ID 296: Op 'logistic_growth', Modifiers: r=2.853, k=49
...
if __name__ == "__main__":
    ...
    r = float(2.853) # PHP generated
    k = float(49) # PHP generated
    ...
    print(json.dumps({
        "script_id":296, "input_value":input_value, "op_type":op_name, 
