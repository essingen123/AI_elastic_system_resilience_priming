...
# Script ID 100: Op 'coupled_logistic_x', Modifiers: rx=3.806, cxy=0.091
...
if __name__ == "__main__":
    ...
    rx = float(3.806) # PHP generated
    cxy = float(0.091) # PHP generated
    ...
    print(json.dumps({
        "script_id":100, "input_value":input_value, "op_type":op_name, 
