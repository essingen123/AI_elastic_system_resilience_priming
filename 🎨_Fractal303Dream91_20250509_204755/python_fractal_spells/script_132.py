...
# Script ID 132: Op 'logistic_growth', Modifiers: r=3.618, k=92
...
if __name__ == "__main__":
    ...
    r = float(3.618) # PHP generated
    k = float(92) # PHP generated
    ...
    print(json.dumps({
        "script_id":132, "input_value":input_value, "op_type":op_name, 
