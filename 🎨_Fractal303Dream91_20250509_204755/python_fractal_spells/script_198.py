...
# Script ID 198: Op 'sine_power_mix', Modifiers: freq1=0.61, pow1=2, amp1=3.1, freq2=1.98, pow2=3, amp2=3.4
...
if __name__ == "__main__":
    ...
    freq1 = float(0.61) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(3.1) # PHP generated
    freq2 = float(1.98) # PHP generated
    ...
    print(json.dumps({
        "script_id":198, "input_value":input_value, "op_type":op_name, 
