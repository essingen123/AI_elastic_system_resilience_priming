...
# Script ID 119: Op 'clifford_attractor_x', Modifiers: a=0.29, c=0.59
...
if __name__ == "__main__":
    ...
    a = float(0.29) # PHP generated
    c = float(0.59) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "c": c}
    output_value = perform_operation(input_value, current_depth, 119, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":119, "input_value":input_value, "op_type":op_name, 
