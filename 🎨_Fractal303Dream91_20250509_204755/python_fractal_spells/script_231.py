...
# Script ID 231: Op 'sine_power_mix', Modifiers: freq1=0.15, pow1=3, amp1=2.8, freq2=2.54, pow2=3, amp2=2.8
...
if __name__ == "__main__":
    ...
    freq1 = float(0.15) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(2.8) # PHP generated
    freq2 = float(2.54) # PHP generated
    ...
    print(json.dumps({
        "script_id":231, "input_value":input_value, "op_type":op_name, 
