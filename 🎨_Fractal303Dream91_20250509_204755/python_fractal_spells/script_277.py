...
# Script ID 277: Op 'coupled_logistic_x', Modifiers: rx=3.919, cxy=0.143
...
if __name__ == "__main__":
    ...
    rx = float(3.919) # PHP generated
    cxy = float(0.143) # PHP generated
    ...
    print(json.dumps({
        "script_id":277, "input_value":input_value, "op_type":op_name, 
