...
# Script ID 35: Op 'coupled_logistic_x', Modifiers: rx=3.711, cxy=0.16
...
if __name__ == "__main__":
    ...
    rx = float(3.711) # PHP generated
    cxy = float(0.16) # PHP generated
    ...
    print(json.dumps({
        "script_id":35, "input_value":input_value, "op_type":op_name, 
