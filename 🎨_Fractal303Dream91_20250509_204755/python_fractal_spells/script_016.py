...
# Script ID 16: Op 'sine_power_mix', Modifiers: freq1=0.55, pow1=1, amp1=3.5, freq2=1.47, pow2=1, amp2=3.2
...
if __name__ == "__main__":
    ...
    freq1 = float(0.55) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(3.5) # PHP generated
    freq2 = float(1.47) # PHP generated
    pow2 = float(1) # PHP generated
    amp2 = float(3.2) # PHP generated
    ...
    print(json.dumps({
        "script_id":16, "input_value":input_value, "op_type":op_name, 
