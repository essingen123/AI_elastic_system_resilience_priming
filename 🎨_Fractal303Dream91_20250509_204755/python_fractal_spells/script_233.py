...
# Script ID 233: Op 'coupled_logistic_x', Modifiers: rx=3.952, cxy=0.112
...
if __name__ == "__main__":
    ...
    rx = float(3.952) # PHP generated
    cxy = float(0.112) # PHP generated
    ...
    print(json.dumps({
        "script_id":233, "input_value":input_value, "op_type":op_name, 
