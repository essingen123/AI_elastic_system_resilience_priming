...
# Script ID 65: Op 'clifford_attractor_x', Modifiers: a=-0.15, c=0.92
...
if __name__ == "__main__":
    ...
    a = float(-0.15) # PHP generated
    c = float(0.92) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "c": c}
    output_value = perform_operation(input_value, current_depth, 65, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":65, "input_value":input_value, "op_type":op_name, 
