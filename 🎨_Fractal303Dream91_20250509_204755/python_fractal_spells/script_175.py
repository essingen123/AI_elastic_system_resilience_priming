...
# Script ID 175: Op 'logistic_growth', Modifiers: r=3.563, k=45
...
if __name__ == "__main__":
    ...
    r = float(3.563) # PHP generated
    k = float(45) # PHP generated
    ...
    print(json.dumps({
        "script_id":175, "input_value":input_value, "op_type":op_name, 
