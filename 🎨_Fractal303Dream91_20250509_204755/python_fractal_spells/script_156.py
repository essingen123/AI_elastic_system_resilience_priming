...
# Script ID 156: Op 'de_jong_attractor_y', Modifiers: c=-2.81, d=1.41
...
if __name__ == "__main__":
    ...
    c = float(-2.81) # PHP generated
    d = float(1.41) # PHP generated
    ...
    print(json.dumps({
        "script_id":156, "input_value":input_value, "op_type":op_name, 
