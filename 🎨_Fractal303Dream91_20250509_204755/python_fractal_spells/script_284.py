...
# Script ID 284: Op 'clifford_attractor_x', Modifiers: a=1.41, c=0.9
...
if __name__ == "__main__":
    ...
    a = float(1.41) # PHP generated
    c = float(0.9) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "c": c}
    output_value = perform_operation(input_value, current_depth, 284, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":284, "input_value":input_value, "op_type":op_name, 
