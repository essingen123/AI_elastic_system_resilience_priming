...
# Script ID 195: Op 'coupled_logistic_x', Modifiers: rx=3.968, cxy=0.054
...
if __name__ == "__main__":
    ...
    rx = float(3.968) # PHP generated
    cxy = float(0.054) # PHP generated
    ...
    print(json.dumps({
        "script_id":195, "input_value":input_value, "op_type":op_name, 
