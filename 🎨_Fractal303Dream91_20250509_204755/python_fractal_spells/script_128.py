...
# Script ID 128: Op 'logistic_growth', Modifiers: r=2.907, k=43
...
if __name__ == "__main__":
    ...
    r = float(2.907) # PHP generated
    k = float(43) # PHP generated
    ...
    print(json.dumps({
        "script_id":128, "input_value":input_value, "op_type":op_name, 
