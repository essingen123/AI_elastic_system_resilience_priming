...
# Script ID 51: Op 'de_jong_attractor_x', Modifiers: a=-2.44, b=2.52
...
if __name__ == "__main__":
    ...
    a = float(-2.44) # PHP generated
    b = float(2.52) # PHP generated

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) 
    python_modifiers_dict = {"a": a, "b": b}
    output_value = perform_operation(input_value, current_depth, 51, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":51, "input_value":input_value, "op_type":op_name, 
