...
# Script ID 99: Op 'sine_power_mix', Modifiers: freq1=0.94, pow1=1, amp1=4.4, freq2=2.16, pow2=2, amp2=0.5
...
if __name__ == "__main__":
    ...
    freq2 = float(2.16) # PHP generated
    pow2 = float(2) # PHP generated
    amp2 = float(0.5) # PHP generated
    ...
    print(json.dumps({
        "script_id":99, "input_value":input_value, "op_type":op_name, 
