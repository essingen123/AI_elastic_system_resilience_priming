...
# Script ID 208: Op 'coupled_logistic_x', Modifiers: rx=3.871, cxy=0.086
...
if __name__ == "__main__":
    ...
    rx = float(3.871) # PHP generated
    cxy = float(0.086) # PHP generated
    ...
    print(json.dumps({
        "script_id":208, "input_value":input_value, "op_type":op_name, 
