...
# Script ID 248: Op 'logistic_growth', Modifiers: r=3.787, k=35
...
if __name__ == "__main__":
    ...
    r = float(3.787) # PHP generated
    k = float(35) # PHP generated
    ...
    print(json.dumps({
        "script_id":248, "input_value":input_value, "op_type":op_name, 
