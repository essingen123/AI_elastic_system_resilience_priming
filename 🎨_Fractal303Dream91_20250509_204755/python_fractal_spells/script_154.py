...
# Script ID 154: Op 'de_jong_attractor_y', Modifiers: c=-0.69, d=2.17
...
if __name__ == "__main__":
    ...
    c = float(-0.69) # PHP generated
    d = float(2.17) # PHP generated
    ...
    print(json.dumps({
        "script_id":154, "input_value":input_value, "op_type":op_name, 
