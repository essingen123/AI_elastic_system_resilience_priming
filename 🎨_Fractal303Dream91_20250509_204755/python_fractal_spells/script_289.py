...
# Script ID 289: Op 'sine_power_mix', Modifiers: freq1=2.98, pow1=3, amp1=1.1, freq2=1.5, pow2=2, amp2=1
...
if __name__ == "__main__":
    ...
    freq1 = float(2.98) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 289, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":289, "input_value":input_value, "op_type":op_name, 
