...
# Script ID 260: Op 'clifford_attractor_y', Modifiers: b=-1.81, d=1.59
...
if __name__ == "__main__":
    ...
    b = float(-1.81) # PHP generated
    d = float(1.59) # PHP generated
    ...
    print(json.dumps({
        "script_id":260, "input_value":input_value, "op_type":op_name, 
