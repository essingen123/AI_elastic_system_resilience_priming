...
# Script ID 66: Op 'sine_power_mix', Modifiers: freq1=1.39, pow1=2, amp1=1.6, freq2=0.82, pow2=1, amp2=2
...
if __name__ == "__main__":
    ...
    freq1 = float(1.39) # PHP generated
    pow1 = float(2) # PHP generated
    amp1 = float(1.6) # PHP generated
    freq2 = float(0.82) # PHP generated
    ...
    print(json.dumps({
        "script_id":66, "input_value":input_value, "op_type":op_name, 
