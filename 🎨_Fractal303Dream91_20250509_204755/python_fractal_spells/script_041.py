...
# Script ID 41: Op 'sine_power_mix', Modifiers: freq1=1.42, pow1=3, amp1=0.5, freq2=2.49, pow2=1, amp2=4.7
...
if __name__ == "__main__":
    ...
    freq1 = float(1.42) # PHP generated
    pow1 = float(3) # PHP generated
    amp1 = float(0.5) # PHP generated
    freq2 = float(2.49) # PHP generated
    ...
    print(json.dumps({
        "script_id":41, "input_value":input_value, "op_type":op_name, 
