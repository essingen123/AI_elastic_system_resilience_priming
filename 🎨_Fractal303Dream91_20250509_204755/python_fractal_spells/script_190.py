...
# Script ID 190: Op 'coupled_logistic_x', Modifiers: rx=3.581, cxy=0.18
...
if __name__ == "__main__":
    ...
    rx = float(3.581) # PHP generated
    cxy = float(0.18) # PHP generated
    ...
    print(json.dumps({
        "script_id":190, "input_value":input_value, "op_type":op_name, 
