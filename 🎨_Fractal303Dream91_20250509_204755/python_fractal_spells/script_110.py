...
# Script ID 110: Op 'sine_power_mix', Modifiers: freq1=0.94, pow1=1, amp1=1, freq2=2.17, pow2=3, amp2=2.1
...
if __name__ == "__main__":
    ...
    freq1 = float(0.94) # PHP generated
    pow1 = float(1) # PHP generated
    amp1 = float(1) # PHP generated
    freq2 = float(2.17) # PHP generated
    pow2 = float(3) # PHP generated
    amp2 = float(2.1) # PHP generated
    ...
    output_value = perform_operation(input_value, current_depth, 110, prev_val_placeholder_py, **python_modifiers_dict)
    ...
    print(json.dumps({
        "script_id":110, "input_value":input_value, "op_type":op_name, 
