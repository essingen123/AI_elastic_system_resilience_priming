...
# Script ID 208: Op 'sine_power_mix', Modifiers: freq1=2.49, pow1=2, amp1=0.9, freq2=1.49, pow2=2, amp2=3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.49)
    modifier_pow1 = float(2)
    modifier_amp1 = float(0.9)
    modifier_freq2 = float(1.49)
    modifier_pow2 = float(2)
    modifier_amp2 = float(3)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 208, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":208, "input_value":input_value, "op_type":"sine_power_mix", 
