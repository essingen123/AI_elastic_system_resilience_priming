...
# Script ID 220: Op 'lyapunov_exponent_approx', Modifiers: r=3.84
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 220, prev_val_placeholder_py, **({"modifier_r": modifier_r}))
    ...
    print(json.dumps({
        "script_id":220, "input_value":input_value, "op_type":"lyapunov_exponent_approx", 
