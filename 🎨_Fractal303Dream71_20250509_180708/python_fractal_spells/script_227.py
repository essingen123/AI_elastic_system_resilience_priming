...
# Script ID 227: Op 'logistic_growth', Modifiers: r=3.56, k=84
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 227, prev_val_placeholder_py, **({"modifier_r": modifier_r, "modifier_k": modifier_k}))
    ...
    print(json.dumps({
        "script_id":227, "input_value":input_value, "op_type":"logistic_growth", 
