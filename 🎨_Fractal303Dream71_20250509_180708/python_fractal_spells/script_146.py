...
# Script ID 146: Op 'de_jong_attractor_x', Modifiers: a=-1.88, b=-0.32
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 146, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":146, "input_value":input_value, "op_type":"de_jong_attractor_x", 
