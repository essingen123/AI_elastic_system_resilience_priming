...
# Script ID 147: Op 'de_jong_attractor_y', Modifiers: c=-2.79, d=-0.73
...
if __name__ == "__main__":
    ...
    modifier_c = float(-2.79)
    modifier_d = float(-0.73)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 147, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":147, "input_value":input_value, "op_type":"de_jong_attractor_y", 
