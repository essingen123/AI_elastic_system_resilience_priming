...
# Script ID 74: Op 'sine_power_mix', Modifiers: freq1=2.2, pow1=3, amp1=0.8, freq2=2.78, pow2=3, amp2=2.9
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 74, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":74, "input_value":input_value, "op_type":"sine_power_mix", 
