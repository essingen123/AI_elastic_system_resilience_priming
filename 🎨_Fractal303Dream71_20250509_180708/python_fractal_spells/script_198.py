...
# Script ID 198: Op 'de_jong_attractor_x', Modifiers: a=2.29, b=0.3
...
if __name__ == "__main__":
    ...
    modifier_a = float(2.29)
    modifier_b = float(0.3)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 198, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_b": modifier_b}))
    ...
    print(json.dumps({
        "script_id":198, "input_value":input_value, "op_type":"de_jong_attractor_x", 
