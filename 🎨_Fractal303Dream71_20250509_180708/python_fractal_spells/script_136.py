...
# Script ID 136: Op 'sine_power_mix', Modifiers: freq1=2.43, pow1=2, amp1=4.6, freq2=1.57, pow2=2, amp2=0.6
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(2.43)
    modifier_pow1 = float(2)
    modifier_amp1 = float(4.6)
    modifier_freq2 = float(1.57)
    ...
    output_value = perform_operation(input_value, current_depth, 136, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":136, "input_value":input_value, "op_type":"sine_power_mix", 
