...
# Script ID 38: Op 'sine_power_mix', Modifiers: freq1=2.74, pow1=1, amp1=0.6, freq2=2.19, pow2=3, amp2=1.3
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 38, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":38, "input_value":input_value, "op_type":"sine_power_mix", 
