...
# Script ID 244: Op 'clifford_attractor_x', Modifiers: a=0.78, c=-0.72
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 244, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":244, "input_value":input_value, "op_type":"clifford_attractor_x", 
