...
# Script ID 88: Op 'sine_power_mix', Modifiers: freq1=1.02, pow1=2, amp1=0.9, freq2=0.99, pow2=1, amp2=3.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 88, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":88, "input_value":input_value, "op_type":"sine_power_mix", 
