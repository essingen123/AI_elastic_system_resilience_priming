...
# Script ID 132: Op 'sine_power_mix', Modifiers: freq1=1.61, pow1=2, amp1=1.6, freq2=1.87, pow2=2, amp2=3.1
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 132, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":132, "input_value":input_value, "op_type":"sine_power_mix", 
