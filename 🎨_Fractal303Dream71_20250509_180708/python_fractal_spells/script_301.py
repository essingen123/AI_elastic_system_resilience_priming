...
# Script ID 301: Op 'de_jong_attractor_y', Modifiers: c=-2.38, d=0.61
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 301, prev_val_placeholder_py, **({"modifier_c": modifier_c, "modifier_d": modifier_d}))
    ...
    print(json.dumps({
        "script_id":301, "input_value":input_value, "op_type":"de_jong_attractor_y", 
