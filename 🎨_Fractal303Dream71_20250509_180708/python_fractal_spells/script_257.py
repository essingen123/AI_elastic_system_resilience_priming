...
# Script ID 257: Op 'sine_power_mix', Modifiers: freq1=1.93, pow1=1, amp1=2.3, freq2=2.52, pow2=3, amp2=3.3
...
if __name__ == "__main__":
    ...
    modifier_freq1 = float(1.93)
    modifier_pow1 = float(1)
    modifier_amp1 = float(2.3)
    modifier_freq2 = float(2.52)
    ...
    output_value = perform_operation(input_value, current_depth, 257, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":257, "input_value":input_value, "op_type":"sine_power_mix", 
