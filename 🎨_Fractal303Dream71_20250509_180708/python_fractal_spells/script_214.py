...
# Script ID 214: Op 'clifford_attractor_x', Modifiers: a=0.07, c=0.12
...
if __name__ == "__main__":
    ...
    modifier_c = float(0.12)

    prev_val_placeholder_py = random.uniform(-0.5, 0.5) # General small random influence 
    output_value = perform_operation(input_value, current_depth, 214, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":214, "input_value":input_value, "op_type":"clifford_attractor_x", 
