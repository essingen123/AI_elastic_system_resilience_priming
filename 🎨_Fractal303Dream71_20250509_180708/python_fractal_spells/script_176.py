...
# Script ID 176: Op 'sine_power_mix', Modifiers: freq1=1.77, pow1=1, amp1=5, freq2=0.52, pow2=2, amp2=1.4
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 176, prev_val_placeholder_py, **({"modifier_freq1": modifier_freq1, "modifier_pow1": modifier_pow1, "modifier_amp1": modifier_amp1, "modifier_freq2": modifier_freq2, "modifier_pow2": modifier_pow2, "modifier_amp2": modifier_amp2}))
    ...
    print(json.dumps({
        "script_id":176, "input_value":input_value, "op_type":"sine_power_mix", 
