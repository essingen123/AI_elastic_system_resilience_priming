...
# Script ID 44: Op 'clifford_attractor_x', Modifiers: a=1.75, c=-1.88
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 44, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":44, "input_value":input_value, "op_type":"clifford_attractor_x", 
