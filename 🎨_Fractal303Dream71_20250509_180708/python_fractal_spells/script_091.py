...
# Script ID 91: Op 'clifford_attractor_x', Modifiers: a=-1.94, c=0.98
...
if __name__ == "__main__":
    ...
    output_value = perform_operation(input_value, current_depth, 91, prev_val_placeholder_py, **({"modifier_a": modifier_a, "modifier_c": modifier_c}))
    ...
    print(json.dumps({
        "script_id":91, "input_value":input_value, "op_type":"clifford_attractor_x", 
